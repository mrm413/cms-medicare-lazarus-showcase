...
std::string VAR_1313; // Auto-declared by LAZARUS healer

std::string c_21; // Auto-declared by LAZARUS healer

std::string VAR_1307; // Auto-declared by LAZARUS healer

std::string VAR_1131; // Auto-declared by LAZARUS healer

std::string VAR_1210; // Auto-declared by LAZARUS healer

std::string VAR_1199; // Auto-declared by LAZARUS healer

std::string VAR_1198; // Auto-declared by LAZARUS healer

std::string VAR_1158; // Auto-declared by LAZARUS healer
...
void p_0000_mainline_control() {
    ...
    if (VAR_1158.substr(0, 2) >= "50" && VAR_1158.at(0) == 'D') {
...
void p_0100_initial_routine() {
    VAR_1158 = std::string(2, '0');
    VAR_1158.replace(11, 4, std::string(4, ' '));
    VAR_1158.replace(15, 80, std::string(80, '0'));
    VAR_1158.replace(95, 8, std::string(8, ' '));
    VAR_1158.replace(103, 11, std::string(11, '0'));
    VAR_1158.replace(118, 27, std::string(27, '0'));
    VAR_1198 = std::string(5, ' ');
    VAR_1199 = std::string(36, '0');
    h_site_neutral_ipps_adj = std::string(194, '0');
    h_site_neutral_ipps_adj.replace(194, 2, std::string(2, ' '));
    h_site_neutral_ipps_adj.replace(196, 264, std::string(264, '0'));
    h_site_neutral_ipps_adj.replace(460, 4, std::string(4, ' '));
    ...
    VAR_1198 = VAR_1210.substr(139, 5);
    // MOVE "660" to computed field
    // MOVE "340" to computed field
    if (VAR_1210.at(138) == '1') {
        VAR_1158.replace(130, 7, "4155868");
    } else {
        VAR_1158.replace(130, 7, "4073857");
    }
    h_site_neutral_ipps_adj.replace(64, 9, "002712100");
    h_site_neutral_ipps_adj.replace(73, 9, "002574300");
    VAR_1158.replace(137, 4, "1000");
    h_site_neutral_ipps_adj.replace(349, 5, "45941");
    // MOVE to computed field
    if (to_int(h_ipps_wage_index) > 1) {
        h_site_neutral_ipps_adj.replace(306, 7, "0385627");
        h_site_neutral_ipps_adj.replace(313, 7, "0178981");
    } else {
        h_site_neutral_ipps_adj.replace(306, 7, "0350057");
        h_site_neutral_ipps_adj.replace(313, 7, "0214551");
    }
    h_site_neutral_ipps_adj.replace(379, 4, "7563");
}
...
void p_1000_edit_input_data() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1138, VAR_1131 + 21)) */ && to_int(VAR_1131) > 0) {
        h_site_neutral_ipps_adj = VAR_1131.substr(21, 3);
    } else {
        VAR_1158 = "56";
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1267, VAR_1210 + 87)) */) {
            VAR_1158 = "50";
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
    ...
    if (VAR_1158.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1137, VAR_1131 + 18)) */) {
            VAR_1158 = "54";
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (VAR_1131.substr(32, 8) < VAR_1210.substr(16, 8) || VAR_1131.substr(32, 8) < VAR_1307.substr(5, 8)) {
            VAR_1158 = std::string(2, static_cast<char>(53));
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (VAR_1210.substr(40, 8) > "00000000") {
            if (VAR_1131.substr(32, 8) >= VAR_1210.substr(40, 8)) {
                VAR_1158 = "51";
            }
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1147, VAR_1131 + 40)) */) {
            VAR_1158 = "58";
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1140, VAR_1131 + 27)) */ || to_int(VAR_1131) > 60) {
            VAR_1158 = "61";
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1139, VAR_1131 + 24)) */ || to_int(VAR_1131) == 0 && to_int(h_site_neutral_ipps_adj) > 0) {
            VAR_1158 = "62";
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (false /* TODO: cob_cmp_numdisp (VAR_1131 + 27, 2, cob_get_llint (COB_SET_DATA (f_1139, VAR_1131 + 24)), 0) > 0 */) {
            VAR_1158 = "62";
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (to_int(VAR_1131) < 0 || to_int(VAR_1131) > 8 || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1149, VAR_1131 + 50)) */) {
            VAR_1158 = "72";
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
    ...
    if (VAR_1158.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1270, VAR_1210 + 101)) */) {
            VAR_1158 = "65";
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1303, VAR_1210 + 207)) */) {
            h_site_neutral_ipps_adj.replace(162, 5, VAR_1210.substr(207, 5));
        } else {
            h_site_neutral_ipps_adj.replace(162, 5, std::string(5, '0'));
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1268, VAR_1210 + 91)) */) {
            h_site_neutral_ipps_adj.replace(157, 5, VAR_1210.substr(91, 5));
        } else {
            h_site_neutral_ipps_adj.replace(157, 5, std::string(5, '0'));
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1269, VAR_1210 + 96)) */) {
            h_site_neutral_ipps_adj.replace(167, 5, VAR_1210.substr(96, 5));
        } else {
            h_site_neutral_ipps_adj.replace(167, 5, std::string(5, '0'));
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1272, VAR_1210 + 110)) */) {
            h_site_neutral_ipps_adj.replace(176, 4, VAR_1210.substr(110, 4));
        } else {
            h_site_neutral_ipps_adj.replace(176, 4, std::string(4, '0'));
        }
    }
    if (VAR_1158.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1273, VAR_1210 + 114)) */) {
            h_site_neutral_ipps_adj.replace(180, 4, VAR_1210.substr(114, 4));
        } else {
            h_site_neutral_ipps_adj.replace(180, 4, std::string(4, '0'));
        }
    }
}
...
void p_1200_days_used() {
    if (to_int(VAR_1131) > 0 && to_int(h_site_neutral_ipps_adj) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_1131 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_1158.replace(106, 3, h_site_neutral_ipps_adj.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_site_neutral_ipps_adj) > 0 && to_int(VAR_1131) == 0) {
            if (h_site_neutral_ipps_adj.substr(3, 3) > h_site_neutral_ipps_adj.substr(0, 3)) {
                VAR_1158.replace(103, 3, h_site_neutral_ipps_adj.substr(0, 3));
            } else {
                VAR_1158.replace(103, 3, h_site_neutral_ipps_adj.substr(3, 3));
            }
        } else {
            if (to_int(h_site_neutral_ipps_adj) > 0 && to_int(VAR_1131) > 0) {
                if (h_site_neutral_ipps_adj.substr(3, 3) > h_site_neutral_ipps_adj.substr(0, 3)) {
                    VAR_1158.replace(103, 3, h_site_neutral_ipps_adj.substr(0, 3));
                    VAR_1158.replace(106, 3, std::string(3, '0'));
                } else {
                    if (false /* TODO: cob_cmp_numdisp (h_site_neutral_ipps_adj + 6, 5, cob_get_llint (h_los), 0) > 0 */) {
                        VAR_1158.replace(103, 3, h_site_neutral_ipps_adj.substr(3, 3));
                    } else {
                        if (false /* TODO: cob_cmp_numdisp (h_site_neutral_ipps_adj + 6, 5, cob_get_llint (h_los), 0) <= 0 */) {
                            VAR_1158.replace(103, 3, h_site_neutral_ipps_adj.substr(3, 3));
...
void p_1700_edit_drg_code() {
    VAR_1158.replace(95, 3, VAR_1131.substr(18, 3));
    if (VAR_1158.substr(0, 2) == "00") {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_37 + 11LL * ((cob_s64_t)(wwm_indx) - 1), VAR_1158 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_228;
...
void p_1800_edit_ipps_drg_code() {
    if (VAR_1131.substr(32, 8) >= wk_drgx_eff_date.substr(0, 8)) {
        drg_idx = to_string(1);
    ...
    h_site_neutral_ipps_adj.replace(334, 6, hlddrg_data.substr(4, 6));
    wk_hlddrg_data2.replace(11, 3, hlddrg_data.substr(11, 3));
    h_site_neutral_ipps_adj.replace(340, 3, hlddrg_data.substr(11, 3));
    wk_hlddrg_data2.at(19) = hlddrg_data.at(19);
    wk_hlddrg_data2.replace(21, 3, hlddrg_data.substr(21, 3));
    h_site_neutral_ipps_adj.replace(346, 3, hlddrg_data.substr(21, 3));
    ...
    h_site_neutral_ipps_adj.replace(343, 3, std::string(3, '0'));
}
...
void p_2000_assemble_pps_variables() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1312, VAR_1307 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1312, VAR_1307 + 25), 0LL) > 0 */) {
        // MOVE to computed field
    } else {
        VAR_1158 = "52";
    }
    // MOVE to computed field
    if (to_int(VAR_1131) == 0 && to_int(VAR_1158) != 5) {
        VAR_1158.at(109) = static_cast<char>(53);
    }
    if (to_int(VAR_1131) >= 1 && to_int(VAR_1131) <= 8 && to_int(VAR_1158) < 6 || to_int(VAR_1158) > 8) {
        VAR_1158 = "72";
    }
    h_blend_snt = "0";
    h_blend_std = "1";
    h_site_neutral_ipps_adj.replace(14, 2, std::string(2, '0'));
    if (to_int(VAR_1210) == 2 || to_int(VAR_1210) == 12) {
        VAR_1158.replace(110, 4, VAR_1210.substr(87, 4));
    } else {
        VAR_1158.replace(110, 4, "1000");
    }
}
...
void p_3100_determine_payment_type() {
    if (to_int(VAR_1131) == 0) {
        program_flags.at(0) = '1';
    }
    if (to_int(VAR_1131) == 1 && VAR_1158.substr(95, 3) == "876" || to_int(VAR_1131) == 4 || to_int(VAR_1131) == 5) {
        program_flags.at(0) = static_cast<char>(50);
    }
    if (to_int(VAR_1131) == 1 && VAR_1158.substr(95, 3) == "876" || VAR_1158.substr(95, 3) == "880" || VAR_1158.substr(95, 3) == "881" || VAR_1158.substr(95, 3) == "882" || VAR_1158.substr(95, 3) == "883" || VAR_1158.substr(95, 3) == "884" || VAR_1158.substr(95, 3) == "885" || VAR_1158.substr(95, 3) == "887" || VAR_1158.substr(95, 3) == "886" || VAR_1158.substr(95, 3) == "894" || VAR_1158.substr(95, 3) == "895" || VAR_1158.substr(95, 3) == "896" || VAR_1158.substr(95, 3) == "897" || VAR_1158.substr(95, 3) == "945" || VAR_1158.substr(95, 3) == "946" || to_int(VAR_1131) == 2 || to_int(VAR_1131) == 3 || to_int(VAR_1131) == 6 || to_int(VAR_1131) == 7 || to_int(VAR_1131) == 8) {
        h_bdgt_neut_factor = "0949";
        h_site_neutral_ipps_adj = "0954";
        if (to_int(VAR_1158) == 8) {
            program_flags.at(0) = static_cast<char>(51);
        } else {
            if (to_int(VAR_1158) == 6 || to_int(VAR_1158) == 7) {
                program_flags.at(0) = static_cast<char>(52);
                h_site_neutral_ipps_adj.replace(18, 2, "05");
                h_site_neutral_ipps_adj.replace(16, 2, "05");
            }
        }
    }
...
void p_3200_calc_standard_pmt() {
    ...
    h_site_neutral_ipps_adj.replace(451, 9, VAR_1158.substr(41, 9));
    ...
    if (to_int(h_los) <= to_int(h_ssot)) {
        ...
        if (program_flags.at(0) == '2' || program_flags.at(0) == '4') {
            ...
            VAR_1199.replace(27, 9, VAR_1158.substr(41, 9));
        }
    } else {
        if (program_flags.at(0) == '2' || program_flags.at(0) == '4') {
            program_flags.at(2) = '1';
            VAR_1199.replace(18, 9, VAR_1158.substr(41, 9));
        }
    }
}
...
void p_3300_calc_site_neutral_pmt() {
    ...
    VAR_1199.replace(9, 9, h_site_neutral_ipps_adj.substr(271, 9));
    p_6000_calc_high_cost_outlier();
    h_site_neutral_ipps_adj.replace(417, 9, VAR_1158.substr(29, 9));
    VAR_1158.replace(29, 9, std::string(9, '0'));
    program_flags.at(1) = ' ';
    VAR_1199.replace(9, 9, std::string(9, '0'));
    h_site_neutral_ipps_adj.replace(426, 9, VAR_1158.substr(68, 9));
    h_sn_ipps_4comparison = to_string(to_num(0) * to_num(1));
    if (h_site_neutral_ipps_adj.substr(426, 9) < h_site_neutral_ipps_adj.substr(435, 9)) {
        program_flags.at(1) = '1';
        VAR_1199 = VAR_1158.substr(68, 9);
    } else {
        program_flags.at(1) = static_cast<char>(50);
        VAR_1199.replace(9, 9, h_site_neutral_ipps_adj.substr(271, 9));
    }
...
void p_3400_short_stay() {
    ...
    VAR_1158.replace(41, 9, h_site_neutral_ipps_adj.substr(289, 9));
    if (program_flags.at(0) == '1') {
        VAR_1158 = std::string(2, static_cast<char>(50));
    }
    h_site_neutral_ipps_adj.at(462) = 'Y';
    h_site_neutral_ipps_adj.at(460) = 'N';
    h_site_neutral_ipps_adj.at(461) = 'N';
    h_site_neutral_ipps_adj.at(463) = 'N';
}
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(h_capi_ime_ratio) > to_int(c_21)) {
        h_site_neutral_ipps_adj.replace(162, 5, "15000");
    }
    h_capi_ime_teach = to_string(to_num(0) - to_num(1));
    if (VAR_1313.at(5) == 'R') {
        h_site_neutral_ipps_adj.at(195) = '0';
    } else {
        h_site_neutral_ipps_adj.at(195) = '1';
    }
    h_oper_dsh_pct = to_string(to_num(0) + to_num(1));
    if (h_site_neutral_ipps_adj.at(195) == '1' && to_int(h_site_neutral_ipps_adj) < 100 && to_int(h_oper_dsh_pct) >= to_int(c_7)) {
        h_site_neutral_ipps_adj.at(194) = static_cast<char>(51);
    } else {
        if (h_site_neutral_ipps_adj.at(195) == '1' && to_int(h_site_neutral_ipps_adj) >= 100 && to_int(h_oper_dsh_pct) >= to_int(c_7)) {
            h_site_neutral_ipps_adj.at(194) = static_cast<char>(50);
        } else {
            if (h_site_neutral_ipps_adj.at(195) == '0' && to_int(h_site_neutral_ipps_adj) >= 500 && to_int(h_oper_dsh_pct) >= to_int(c_7)) {
                h_site_neutral_ipps_adj.at(194) = static_cast<char>(50);
            } else {
                if (h_site_neutral_ipps_adj.at(195) == '0' && to_int(h_site_neutral_ipps_adj) < 500 && to_int(h_oper_dsh_pct) >= to_int(c_7)) {
                    h_site_neutral_ipps_adj.at(194) = static_cast<char>(51);
                } else {
                    h_site_neutral_ipps_adj.at(194) = static_cast<char>(52);
                }
            }
        }
    }
    if (h_site_neutral_ipps_adj.at(194) == '2') {
        if (to_int(h_oper_dsh_pct) >= to_int(c_7) && to_int(h_oper_dsh_pct) <= to_int(c_10)) {
            ...
            if (to_int(h_oper_dsh_pct) > to_int(c_10)) {
                ...
                h_site_neutral_ipps_adj.replace(184, 5, std::string(5, '0'));
            }
        }
    } else if (h_site_neutral_ipps_adj.at(194) == '3') {
        if (to_int(h_oper_dsh_pct) >= to_int(c_7) && to_int(h_oper_dsh_pct) <= to_int(c_10)) {
            h_oper_dsh = to_string(to_num(0) + to_num(1));
    ...
    } else if (h_site_neutral_ipps_adj.at(194) == '4') {
        h_site_neutral_ipps_adj.replace(184, 5, std::string(5, '0'));
    }
    h_oper_dsh = to_string(to_num(0) * to_num(1));
    if (h_site_neutral_ipps_adj.at(195) == '1' && to_int(h_site_neutral_ipps_adj) >= 100) {
        h_capi_dsh = to_string(to_num(0) - to_num(1));
    } else {
        h_site_neutral_ipps_adj.replace(189, 5, std::string(5, '0'));
    }
    if (to_int(VAR_1210) == 2 || to_int(VAR_1210) == 12) {
        h_site_neutral_ipps_adj.replace(298, 4, VAR_1210.substr(87, 4));
    } else {
        h_site_neutral_ipps_adj.replace(298, 4, "1000");
    }
    h_stand_amt_oper_pmt = to_string(to_num(0) * to_num(1));
    h_capi_cola = to_string(to_num(0) + to_num(1));
    if (VAR_1313.at(5) == 'L') {
        h_site_neutral_ipps_adj.replace(250, 3, "100");
    } else {
        h_site_neutral_ipps_adj.replace(250, 3, "100");
    }
    ...
    if (h_site_neutral_ipps_adj.substr(271, 9) > h_site_neutral_ipps_adj.substr(253, 9)) {
        h_site_neutral_ipps_adj.replace(271, 9, h_site_neutral_ipps_adj.substr(253, 9));
    }
}
...
void p_6000_calc_high_cost_outlier() {
    ...
    if (program_flags.at(0) == '4' && program_flags.at(1) == '1') {
        if (VAR_1158.substr(68, 9) > VAR_1158.substr(86, 9)) {
        }
    }
    if (program_flags.at(0) == '4') {
        if (program_flags.at(2) == '1') {
        ...
        if (VAR_1158.substr(68, 9) > h_site_neutral_ipps_adj.substr(383, 9)) {
            h_outlier_pay_amt_std = to_string(to_num(0) * to_num(1));
        }
        if (program_flags.at(1) == '2' && VAR_1158.substr(68, 9) > VAR_1158.substr(86, 9)) {
...
void p_6100_calc_charge_threshold() {
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) > 0 */ && program_flags.at(0) == '4' || VAR_1158.at(161) == 'Y') {
        if (VAR_1131.substr(24, 3) < h_site_neutral_ipps_adj.substr(0, 3) || VAR_1158.at(161) == 'Y' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1270, VAR_1210 + 101), 0LL) != 0 */) {
            if (VAR_1158.substr(162, 2) == "PC") {
                VAR_1158 = "67";
            }
        } else {
        }
...
void p_7100_set_old_return_codes() {
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) > 0 */ && VAR_1158.substr(0, 2) == "21") {
        VAR_1158 = "24";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) > 0 */ && VAR_1158.substr(0, 2) == "22") {
        VAR_1158 = "25";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) > 0 */ && VAR_1158.substr(0, 2) == "26") {
        VAR_1158 = "27";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) > 0 */ && VAR_1158.substr(0, 2) == "00") {
        VAR_1158 = "01";
    }
    if (VAR_1158.substr(0, 2) == "00" || VAR_1158.substr(0, 2) == "20" || VAR_1158.substr(0, 2) == "21" || VAR_1158.substr(0, 2) == "22" || VAR_1158.substr(0, 2) == "26") {
        if (false /* cob_cmp > 0 */) {
            VAR_1158.replace(106, 3, std::string(3, '0'));
        } else {
        }
...
void p_7200_set_new_return_codes() {
    VAR_1158 = std::string(2, ' ');
    VAR_1158.at(0) = static_cast<char>(67);
    p_7250_search_for_vent_proc();
    if (program_flags.at(3) == 'Y') {
        VAR_1158.at(0) = static_cast<char>(66);
    }
    if (VAR_1158.substr(95, 3) == "876" || VAR_1158.substr(95, 3) == "880" || VAR_1158.substr(95, 3) == "881" || VAR_1158.substr(95, 3) == "882" || VAR_1158.substr(95, 3) == "883" || VAR_1158.substr(95, 3) == "884" || VAR_1158.substr(95, 3) == "885" || VAR_1158.substr(95, 3) == "887" || VAR_1158.substr(95, 3) == "886" || VAR_1158.substr(95, 3) == "894" || VAR_1158.substr(95, 3) == "895" || VAR_1158.substr(95, 3) == "896" || VAR_1158.substr(95, 3) == "897" || VAR_1158.substr(95, 3) == "945" || VAR_1158.substr(95, 3) == "946" && program_flags.at(0) == '3' || program_flags.at(0) == '4') {
        VAR_1158.at(0) = 'A';
    }
    if (program_flags.at(0) == '4' && program_flags.at(1) == '1') {
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) == 0 */ && program_flags.at(2) == '1') {
            VAR_1158.at(1) = '0';
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) > 0 */ && program_flags.at(2) == '1') {
            VAR_1158.at(1) = '1';
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) == 0 */ && program_flags.at(2) == '2') {
            VAR_1158.at(1) = static_cast<char>(50);
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) > 0 */ && program_flags.at(2) == '2') {
            VAR_1158.at(1) = static_cast<char>(51);
        }
    }
    if (program_flags.at(0) == '4' && program_flags.at(1) == '2') {
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) == 0 */ && program_flags.at(2) == '1') {
            VAR_1158.at(1) = static_cast<char>(52);
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) > 0 */ && program_flags.at(2) == '1') {
            VAR_1158.at(1) = static_cast<char>(53);
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) == 0 */ && program_flags.at(2) == '2') {
            VAR_1158.at(1) = static_cast<char>(54);
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) > 0 */ && program_flags.at(2) == '2') {
            VAR_1158.at(1) = static_cast<char>(55);
        }
    }
    if (program_flags.at(0) == '3') {
        ...
        if (program_flags.at(1) == '2') {
            if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) == 0 */) {
                VAR_1158.at(1) = static_cast<char>(66);
            } else {
                VAR_1158.at(1) = static_cast<char>(67);
            }
        }
    }
    if (program_flags.at(0) == '2') {
        if (program_flags.at(2) == '2' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) == 0 */) {
            VAR_1158.at(1) = static_cast<char>(68);
        }
        if (program_flags.at(2) == '2' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) > 0 */) {
            VAR_1158.at(1) = static_cast<char>(69);
        }
        if (program_flags.at(2) == '1' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) == 0 */) {
            VAR_1158.at(1) = static_cast<char>(70);
        }
        if (program_flags.at(2) == '1' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1170, VAR_1158 + 29), 0LL) > 0 */) {
            VAR_1158.at(1) = static_cast<char>(71);
        }
    }
}
...
void p_7250_search_for_vent_proc() {
    ...
    while (true) {
        ...
        if (false /* TODO: memcmp (fed_fy_begin_03 + 8, VAR_1131 + 227 + 7LL * ((cob_s64_t)(idx_proc) - 1), 7) == 0 */) {
...
void p_9000_move_results() {
    if (VAR_1158.substr(0, 2) >= "50" && VAR_1158.at(0) == 'D') {
        VAR_1158.replace(38, 3, h_site_neutral_ipps_adj.substr(0, 3));
        VAR_1158.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_1158.replace(11, 4, std::string(4, ' '));
        VAR_1158.replace(15, 80, std::string(80, '0'));
        VAR_1158.replace(95, 8, std::string(8, ' '));
