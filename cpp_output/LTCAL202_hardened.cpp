...
std::string c_8; // Auto-declared by LAZARUS healer

std::string VAR_1325; // Auto-declared by LAZARUS healer

std::string c_21; // Auto-declared by LAZARUS healer

std::string VAR_1319; // Auto-declared by LAZARUS healer

std::string VAR_1139; // Auto-declared by LAZARUS healer

std::string VAR_1221; // Auto-declared by LAZARUS healer

std::string VAR_1210; // Auto-declared by LAZARUS healer

std::string VAR_1209; // Auto-declared by LAZARUS healer

std::string VAR_1168; // Auto-declared by LAZARUS healer
...
FixedString<10> b_discharge_date;
...
FixedString<10> h_admission_date;
FixedString<10> h_admiss_date_int;
...
FixedString<10> h_discharge_date;
...
FixedString<50> h_ipps_like_amt;
FixedString<50> h_ipps_like_amt_outlier;
...
FixedString<50> h_outlier_ipps_comparable;
FixedString<50> h_outlier_pay_amt_snt;
FixedString<50> h_outlier_pay_amt_std;
FixedString<50> h_outlier_threshold_std;
FixedString<50> h_pre_dpp_pay;
FixedString<50> h_reg_days;
FixedString<50> h_site_neutral_ipps_adj;
FixedString<50> h_sn_ipps_4comparison;
...
FixedString<50> pps_ltch_dpp_adj_amt;
...
FixedString<50> psych_rehab_drg_present;
...
void p_3500_calc_ipps_like_amt();
void p_3500_exit();
...
void p_0000_mainline_control() {
    ...
    if (VAR_1168.substr(0, 2) >= "50" && VAR_1168.at(0) == 'D') {
...
void p_0100_initial_routine() {
    VAR_1168 = std::string(2, '0');
    VAR_1168.replace(11, 4, std::string(4, ' '));
    VAR_1168.replace(15, 80, std::string(80, '0'));
    VAR_1168.replace(95, 8, std::string(8, ' '));
    VAR_1168.replace(103, 11, std::string(11, '0'));
    VAR_1168.replace(118, 38, std::string(38, '0'));
    VAR_1209 = std::string(5, ' ');
    VAR_1210 = std::string(36, '0');
    h_pre_dpp_pay = std::string(217, '0');
    h_pre_dpp_pay.replace(217, 2, std::string(2, ' '));
    h_pre_dpp_pay.replace(219, 291, std::string(291, '0'));
    h_pre_dpp_pay.replace(510, 4, std::string(4, ' '));
    ...
    VAR_1209 = VAR_1221.substr(139, 5);
    // MOVE "663" to computed field
    // MOVE "337" to computed field
    if (VAR_1221.at(138) == '1') {
        VAR_1168.replace(130, 7, "4267764");
    } else {
        VAR_1168.replace(130, 7, "4184490");
    }
    h_pre_dpp_pay.replace(64, 9, "002677800");
    h_pre_dpp_pay.replace(73, 9, "002655200");
    VAR_1168.replace(137, 4, "1000");
    h_pre_dpp_pay.replace(372, 5, "46233");
    // MOVE to computed field
    if (to_int(h_ipps_wage_index) > 1) {
        h_pre_dpp_pay.replace(329, 7, "0395910");
        h_pre_dpp_pay.replace(336, 7, "0183753");
    } else {
        h_pre_dpp_pay.replace(329, 7, "0359391");
        h_pre_dpp_pay.replace(336, 7, "0220272");
    }
    h_pre_dpp_pay.replace(402, 4, "7536");
}
...
void p_1000_edit_input_data() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1146, VAR_1139 + 21)) */ && to_int(VAR_1139) > 0) {
        h_pre_dpp_pay = VAR_1139.substr(21, 3);
    } else {
        VAR_1168 = "56";
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1279, VAR_1221 + 87)) */) {
            VAR_1168 = "50";
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
    ...
    if (VAR_1168.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1145, VAR_1139 + 18)) */) {
            VAR_1168 = "54";
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (VAR_1139.substr(32, 8) < VAR_1221.substr(16, 8) || VAR_1139.substr(32, 8) < VAR_1319.substr(5, 8)) {
            VAR_1168 = std::string(2, static_cast<char>(53));
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (VAR_1221.substr(40, 8) > "00000000") {
            if (VAR_1139.substr(32, 8) >= VAR_1221.substr(40, 8)) {
                VAR_1168 = "51";
            }
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1155, VAR_1139 + 40)) */) {
            VAR_1168 = "58";
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1148, VAR_1139 + 27)) */ || to_int(VAR_1139) > 60) {
            VAR_1168 = "61";
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1147, VAR_1139 + 24)) */ || to_int(VAR_1139) == 0 && to_int(h_pre_dpp_pay) > 0) {
            VAR_1168 = "62";
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (false /* TODO: cob_cmp_numdisp (VAR_1139 + 27, 2, cob_get_llint (COB_SET_DATA (f_1147, VAR_1139 + 24)), 0) > 0 */) {
            VAR_1168 = "62";
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (to_int(VAR_1139) < 0 || to_int(VAR_1139) > 8 || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1157, VAR_1139 + 50)) */) {
            VAR_1168 = "72";
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
    ...
    if (VAR_1168.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1282, VAR_1221 + 101)) */) {
            VAR_1168 = "65";
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1315, VAR_1221 + 207)) */) {
            h_pre_dpp_pay.replace(185, 5, VAR_1221.substr(207, 5));
        } else {
            h_pre_dpp_pay.replace(185, 5, std::string(5, '0'));
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1280, VAR_1221 + 91)) */) {
            h_pre_dpp_pay.replace(180, 5, VAR_1221.substr(91, 5));
        } else {
            h_pre_dpp_pay.replace(180, 5, std::string(5, '0'));
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1281, VAR_1221 + 96)) */) {
            h_pre_dpp_pay.replace(190, 5, VAR_1221.substr(96, 5));
        } else {
            h_pre_dpp_pay.replace(190, 5, std::string(5, '0'));
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1284, VAR_1221 + 110)) */) {
            h_pre_dpp_pay.replace(199, 4, VAR_1221.substr(110, 4));
        } else {
            h_pre_dpp_pay.replace(199, 4, std::string(4, '0'));
        }
    }
    if (VAR_1168.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1285, VAR_1221 + 114)) */) {
            h_pre_dpp_pay.replace(203, 4, VAR_1221.substr(114, 4));
        } else {
            h_pre_dpp_pay.replace(203, 4, std::string(4, '0'));
        }
    }
}
...
void p_1200_days_used() {
    if (to_int(VAR_1139) > 0 && to_int(h_pre_dpp_pay) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_1139 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_1168.replace(106, 3, h_pre_dpp_pay.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_pre_dpp_pay) > 0 && to_int(VAR_1139) == 0) {
            if (h_pre_dpp_pay.substr(3, 3) > h_pre_dpp_pay.substr(0, 3)) {
                VAR_1168.replace(103, 3, h_pre_dpp_pay.substr(0, 3));
            } else {
                VAR_1168.replace(103, 3, h_pre_dpp_pay.substr(3, 3));
            }
        } else {
            if (to_int(h_pre_dpp_pay) > 0 && to_int(VAR_1139) > 0) {
                if (h_pre_dpp_pay.substr(3, 3) > h_pre_dpp_pay.substr(0, 3)) {
                    VAR_1168.replace(103, 3, h_pre_dpp_pay.substr(0, 3));
                    VAR_1168.replace(106, 3, std::string(3, '0'));
                } else {
                    if (false /* TODO: cob_cmp_numdisp (h_pre_dpp_pay + 6, 5, cob_get_llint (h_los), 0) > 0 */) {
                        VAR_1168.replace(103, 3, h_pre_dpp_pay.substr(3, 3));
                    } else {
                        if (false /* TODO: cob_cmp_numdisp (h_pre_dpp_pay + 6, 5, cob_get_llint (h_los), 0) <= 0 */) {
                            VAR_1168.replace(103, 3, h_pre_dpp_pay.substr(3, 3));
...
void p_1700_edit_drg_code() {
    VAR_1168.replace(95, 3, VAR_1139.substr(18, 3));
    if (VAR_1168.substr(0, 2) == "00") {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_37 + 11LL * ((cob_s64_t)(wwm_indx) - 1), VAR_1168 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_228;
...
void p_1800_edit_ipps_drg_code() {
    if (VAR_1139.substr(32, 8) >= wk_drgx_eff_date.substr(0, 8)) {
        drg_idx = to_string(1);
        // UNHANDLED: const int max = 761;
        while (true) {
    ...
    h_pre_dpp_pay.replace(357, 6, hlddrg_data.substr(4, 6));
    wk_hlddrg_data2.replace(11, 3, hlddrg_data.substr(11, 3));
    h_pre_dpp_pay.replace(363, 3, hlddrg_data.substr(11, 3));
    wk_hlddrg_data2.at(19) = hlddrg_data.at(19);
    wk_hlddrg_data2.replace(21, 3, hlddrg_data.substr(21, 3));
    h_pre_dpp_pay.replace(369, 3, hlddrg_data.substr(21, 3));
    ...
    h_pre_dpp_pay.replace(366, 3, std::string(3, '0'));
}
...
void p_2000_assemble_pps_variables() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1324, VAR_1319 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1324, VAR_1319 + 25), 0LL) > 0 */) {
        // MOVE to computed field
    } else {
        VAR_1168 = "52";
    }
    // MOVE to computed field
    if (to_int(VAR_1139) == 0 && to_int(VAR_1168) != 5) {
        VAR_1168.at(109) = static_cast<char>(53);
    }
    if (to_int(VAR_1139) >= 1 && to_int(VAR_1139) <= 8 && to_int(VAR_1168) < 6 || to_int(VAR_1168) > 8) {
        VAR_1168 = "72";
    }
    h_blend_snt = "0";
    h_blend_std = "1";
    h_pre_dpp_pay.replace(14, 2, std::string(2, '0'));
    if (to_int(VAR_1221) == 2 || to_int(VAR_1221) == 12) {
        VAR_1168.replace(110, 4, VAR_1221.substr(87, 4));
    } else {
        VAR_1168.replace(110, 4, "1000");
    }
}
...
void p_3100_determine_payment_type() {
    if (to_int(VAR_1139) == 0) {
        program_flags.at(0) = '1';
    }
    if (to_int(VAR_1139) == 1 && VAR_1168.substr(95, 3) == "876" || to_int(VAR_1139) == 4 || to_int(VAR_1139) == 5) {
        program_flags.at(0) = static_cast<char>(50);
    }
    if (to_int(VAR_1139) == 1 && VAR_1168.substr(95, 3) == "876" || VAR_1168.substr(95, 3) == "880" || VAR_1168.substr(95, 3) == "881" || VAR_1168.substr(95, 3) == "882" || VAR_1168.substr(95, 3) == "883" || VAR_1168.substr(95, 3) == "884" || VAR_1168.substr(95, 3) == "885" || VAR_1168.substr(95, 3) == "887" || VAR_1168.substr(95, 3) == "886" || VAR_1168.substr(95, 3) == "894" || VAR_1168.substr(95, 3) == "895" || VAR_1168.substr(95, 3) == "896" || VAR_1168.substr(95, 3) == "897" || VAR_1168.substr(95, 3) == "945" || VAR_1168.substr(95, 3) == "946" || to_int(VAR_1139) == 2 || to_int(VAR_1139) == 3 || to_int(VAR_1139) == 6 || to_int(VAR_1139) == 7 || to_int(VAR_1139) == 8) {
        // MOVE to computed field
        h_admiss_date_int = to_string(to_num(0) - to_num(1));
        h_admission_date = to_string(to_num(0) + to_num(1));
        if (to_int(h_pre_dpp_pay) > 20200126) {
            program_flags.at(0) = static_cast<char>(50);
        } else {
            h_bdgt_neut_factor = "0949";
            h_site_neutral_ipps_adj = "0954";
            if (to_int(VAR_1168) == 8) {
                program_flags.at(0) = static_cast<char>(51);
            } else {
                if (to_int(VAR_1168) == 6 || to_int(VAR_1168) == 7) {
                    program_flags.at(0) = static_cast<char>(52);
                    h_pre_dpp_pay.replace(18, 2, "05");
                    h_pre_dpp_pay.replace(16, 2, "05");
                }
            }
        }
    }
...
void p_3200_calc_standard_pmt() {
    ...
    h_pre_dpp_pay.replace(501, 9, VAR_1168.substr(41, 9));
    ...
    if (to_int(h_los) <= to_int(h_ssot)) {
        ...
        if (program_flags.at(0) == '2' || program_flags.at(0) == '4') {
            ...
            VAR_1210.replace(27, 9, VAR_1168.substr(41, 9));
        }
    } else {
        if (program_flags.at(0) == '2' || program_flags.at(0) == '4') {
            program_flags.at(2) = '1';
            VAR_1210.replace(18, 9, VAR_1168.substr(41, 9));
        }
    }
}
...
void p_3300_calc_site_neutral_pmt() {
    ...
    VAR_1210.replace(9, 9, h_pre_dpp_pay.substr(294, 9));
    p_6000_calc_high_cost_outlier();
    h_pre_dpp_pay.replace(440, 9, VAR_1168.substr(29, 9));
    VAR_1168.replace(29, 9, std::string(9, '0'));
    program_flags.at(1) = ' ';
    VAR_1210.replace(9, 9, std::string(9, '0'));
    h_pre_dpp_pay.replace(449, 9, VAR_1168.substr(68, 9));
    h_sn_ipps_4comparison = to_string(to_num(0) * to_num(1));
    if (h_pre_dpp_pay.substr(449, 9) < h_pre_dpp_pay.substr(458, 9)) {
        program_flags.at(1) = '1';
        VAR_1210 = VAR_1168.substr(68, 9);
    } else {
        program_flags.at(1) = static_cast<char>(50);
        VAR_1210.replace(9, 9, h_pre_dpp_pay.substr(294, 9));
    }
...
void p_3400_short_stay() {
    ...
    VAR_1168.replace(41, 9, h_pre_dpp_pay.substr(312, 9));
    if (program_flags.at(0) == '1') {
        VAR_1168 = std::string(2, static_cast<char>(50));
    }
    h_pre_dpp_pay.at(512) = 'Y';
    h_pre_dpp_pay.at(510) = 'N';
    h_pre_dpp_pay.at(511) = 'N';
    h_pre_dpp_pay.at(513) = 'N';
}
...
void p_3500_calc_ipps_like_amt() {
    p_3650_ss_ipps_comp_pmt();
    if (VAR_1168.substr(68, 9) > VAR_1168.substr(86, 9)) {
        h_ipps_like_amt_outlier = to_string(to_num(0) * to_num(1));
    }
    h_ipps_like_amt = to_string(to_num(0) + to_num(1));
}
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(h_capi_ime_ratio) > to_int(c_21)) {
        h_pre_dpp_pay.replace(185, 5, "15000");
    }
    h_capi_ime_teach = to_string(to_num(0) - to_num(1));
    if (VAR_1325.at(5) == 'R') {
        h_pre_dpp_pay.at(218) = '0';
    } else {
        h_pre_dpp_pay.at(218) = '1';
    }
    h_oper_dsh_pct = to_string(to_num(0) + to_num(1));
    if (h_pre_dpp_pay.at(218) == '1' && to_int(h_pre_dpp_pay) < 100 && to_int(h_oper_dsh_pct) >= to_int(c_8)) {
        h_pre_dpp_pay.at(217) = static_cast<char>(51);
    } else {
        if (h_pre_dpp_pay.at(218) == '1' && to_int(h_pre_dpp_pay) >= 100 && to_int(h_oper_dsh_pct) >= to_int(c_8)) {
            h_pre_dpp_pay.at(217) = static_cast<char>(50);
        } else {
            if (h_pre_dpp_pay.at(218) == '0' && to_int(h_pre_dpp_pay) >= 500 && to_int(h_oper_dsh_pct) >= to_int(c_8)) {
                h_pre_dpp_pay.at(217) = static_cast<char>(50);
            } else {
                if (h_pre_dpp_pay.at(218) == '0' && to_int(h_pre_dpp_pay) < 500 && to_int(h_oper_dsh_pct) >= to_int(c_8)) {
                    h_pre_dpp_pay.at(217) = static_cast<char>(51);
                } else {
                    h_pre_dpp_pay.at(217) = static_cast<char>(52);
                }
            }
        }
    }
    if (h_pre_dpp_pay.at(217) == '2') {
        if (to_int(h_oper_dsh_pct) >= to_int(c_8) && to_int(h_oper_dsh_pct) <= to_int(c_11)) {
            h_oper_dsh = to_string(to_num(0) + to_num(1));
        } else {
            if (to_int(h_oper_dsh_pct) > to_int(c_11)) {
                h_oper_dsh = to_string(to_num(0) + to_num(1));
            } else {
                h_pre_dpp_pay.replace(207, 5, std::string(5, '0'));
            }
        }
    } else if (h_pre_dpp_pay.at(217) == '3') {
        if (to_int(h_oper_dsh_pct) >= to_int(c_8) && to_int(h_oper_dsh_pct) <= to_int(c_11)) {
            h_oper_dsh = to_string(to_num(0) + to_num(1));
            if (to_int(h_oper_dsh) > to_int(c_24)) {
                h_oper_dsh = "12";
            }
        } else {
            if (to_int(h_oper_dsh_pct) > to_int(c_11)) {
    ...
    } else if (h_pre_dpp_pay.at(217) == '4') {
        h_pre_dpp_pay.replace(207, 5, std::string(5, '0'));
    }
    h_oper_dsh = to_string(to_num(0) * to_num(1));
    if (h_pre_dpp_pay.at(218) == '1' && to_int(h_pre_dpp_pay) >= 100) {
        h_capi_dsh = to_string(to_num(0) - to_num(1));
    } else {
        h_pre_dpp_pay.replace(212, 5, std::string(5, '0'));
    }
    if (to_int(VAR_1221) == 2 || to_int(VAR_1221) == 12) {
        h_pre_dpp_pay.replace(321, 4, VAR_1221.substr(87, 4));
    } else {
        h_pre_dpp_pay.replace(321, 4, "1000");
    }
    h_stand_amt_oper_pmt = to_string(to_num(0) * to_num(1));
    h_capi_cola = to_string(to_num(0) + to_num(1));
    if (VAR_1325.at(5) == 'L') {
        h_pre_dpp_pay.replace(273, 3, "100");
    } else {
        h_pre_dpp_pay.replace(273, 3, "100");
    }
    ...
    if (h_pre_dpp_pay.substr(294, 9) > h_pre_dpp_pay.substr(276, 9)) {
        h_pre_dpp_pay.replace(294, 9, h_pre_dpp_pay.substr(276, 9));
    }
}
...
void p_6000_calc_high_cost_outlier() {
    ...
    if (program_flags.at(0) == '4') {
        ...
        if (VAR_1168.substr(68, 9) > h_pre_dpp_pay.substr(406, 9)) {
            h_outlier_pay_amt_std = to_string(to_num(0) * to_num(1));
        }
        if (program_flags.at(1) == '2' && VAR_1168.substr(68, 9) > VAR_1168.substr(86, 9)) {
...
void p_6100_calc_charge_threshold() {
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) > 0 */ && program_flags.at(0) == '4' || VAR_1168.at(161) == 'Y') {
        if (VAR_1139.substr(24, 3) < h_pre_dpp_pay.substr(0, 3) || VAR_1168.at(161) == 'Y' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1282, VAR_1221 + 101), 0LL) != 0 */) {
            if (VAR_1168.substr(162, 2) == "PC") {
                VAR_1168 = "67";
            }
        } else {
        }
...
void p_7100_set_old_return_codes() {
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) > 0 */ && VAR_1168.substr(0, 2) == "21") {
        VAR_1168 = "24";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) > 0 */ && VAR_1168.substr(0, 2) == "22") {
        VAR_1168 = "25";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) > 0 */ && VAR_1168.substr(0, 2) == "26") {
        VAR_1168 = "27";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) > 0 */ && VAR_1168.substr(0, 2) == "00") {
        VAR_1168 = "01";
    }
    if (VAR_1168.substr(0, 2) == "00" || VAR_1168.substr(0, 2) == "20" || VAR_1168.substr(0, 2) == "21" || VAR_1168.substr(0, 2) == "22" || VAR_1168.substr(0, 2) == "26") {
        if (false /* cob_cmp > 0 */) {
            VAR_1168.replace(106, 3, std::string(3, '0'));
        } else {
        }
...
void p_7200_set_new_return_codes() {
    VAR_1168 = std::string(2, ' ');
    VAR_1168.at(0) = static_cast<char>(67);
    p_7250_search_for_vent_proc();
    if (program_flags.at(3) == 'Y') {
        VAR_1168.at(0) = static_cast<char>(66);
    }
    if (VAR_1168.substr(95, 3) == "876" || VAR_1168.substr(95, 3) == "880" || VAR_1168.substr(95, 3) == "881" || VAR_1168.substr(95, 3) == "882" || VAR_1168.substr(95, 3) == "883" || VAR_1168.substr(95, 3) == "884" || VAR_1168.substr(95, 3) == "885" || VAR_1168.substr(95, 3) == "887" || VAR_1168.substr(95, 3) == "886" || VAR_1168.substr(95, 3) == "894" || VAR_1168.substr(95, 3) == "895" || VAR_1168.substr(95, 3) == "896" || VAR_1168.substr(95, 3) == "897" || VAR_1168.substr(95, 3) == "945" || VAR_1168.substr(95, 3) == "946" && program_flags.at(0) == '3' || program_flags.at(0) == '4') {
        VAR_1168.at(0) = 'A';
    }
    if (program_flags.at(0) == '4' && program_flags.at(1) == '1') {
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) == 0 */ && program_flags.at(2) == '1') {
            VAR_1168.at(1) = '0';
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) > 0 */ && program_flags.at(2) == '1') {
            VAR_1168.at(1) = '1';
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) == 0 */ && program_flags.at(2) == '2') {
            VAR_1168.at(1) = static_cast<char>(50);
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) > 0 */ && program_flags.at(2) == '2') {
            VAR_1168.at(1) = static_cast<char>(51);
        }
    }
    if (program_flags.at(0) == '4' && program_flags.at(1) == '2') {
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) == 0 */ && program_flags.at(2) == '1') {
            VAR_1168.at(1) = static_cast<char>(52);
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) > 0 */ && program_flags.at(2) == '1') {
            VAR_1168.at(1) = static_cast<char>(53);
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) == 0 */ && program_flags.at(2) == '2') {
            VAR_1168.at(1) = static_cast<char>(54);
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) > 0 */ && program_flags.at(2) == '2') {
            VAR_1168.at(1) = static_cast<char>(55);
        }
    }
    if (program_flags.at(0) == '3') {
        ...
        if (program_flags.at(1) == '2') {
            if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) == 0 */) {
                VAR_1168.at(1) = static_cast<char>(66);
            } else {
                VAR_1168.at(1) = static_cast<char>(67);
            }
        }
    }
    if (program_flags.at(0) == '2') {
        if (program_flags.at(2) == '2' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) == 0 */) {
            VAR_1168.at(1) = static_cast<char>(68);
        }
        if (program_flags.at(2) == '2' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) > 0 */) {
            VAR_1168.at(1) = static_cast<char>(69);
        }
        if (program_flags.at(2) == '1' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) == 0 */) {
            VAR_1168.at(1) = static_cast<char>(70);
        }
        if (program_flags.at(2) == '1' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1180, VAR_1168 + 29), 0LL) > 0 */) {
            VAR_1168.at(1) = static_cast<char>(71);
        }
    }
}
...
void p_7250_search_for_vent_proc() {
    ...
    while (true) {
        ...
        if (false /* TODO: memcmp (fed_fy_begin_03 + 8, VAR_1139 + 227 + 7LL * ((cob_s64_t)(idx_proc) - 1), 7) == 0 */) {
...
void p_8000_calc_final_pmt() {
    ...
    if (program_flags.at(0) == '1') {
        ...
        h_pre_dpp_pay.replace(492, 9, VAR_1168.substr(59, 9));
        if (VAR_1139.at(402) == 'Y') {
            p_3500_calc_ipps_like_amt();
        }
    }
}
...
void p_9000_move_results() {
    if (VAR_1168.substr(0, 2) >= "50" && VAR_1168.at(0) == 'D') {
        VAR_1168.replace(38, 3, h_pre_dpp_pay.substr(0, 3));
        VAR_1168.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_1168.replace(11, 4, std::string(4, ' '));
        VAR_1168.replace(15, 80, std::string(80, '0'));
        VAR_1168.replace(95, 8, std::string(8, ' '));
