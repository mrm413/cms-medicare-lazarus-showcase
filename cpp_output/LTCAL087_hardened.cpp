...
std::string VAR_765; // Auto-declared by LAZARUS healer

std::string c_23; // Auto-declared by LAZARUS healer

std::string VAR_759; // Auto-declared by LAZARUS healer

std::string VAR_606; // Auto-declared by LAZARUS healer

std::string VAR_666; // Auto-declared by LAZARUS healer

std::string VAR_659; // Auto-declared by LAZARUS healer

std::string VAR_624; // Auto-declared by LAZARUS healer
...
FixedString<50> fed_fy_begin_06;
FixedString<50> fed_fy_begin_07;
...
void p_0100_initial_routine() {
    VAR_624 = std::string(2, '0');
    VAR_624.replace(11, 4, std::string(4, ' '));
    VAR_624.replace(15, 80, std::string(80, '0'));
    VAR_624.replace(95, 8, std::string(8, ' '));
    VAR_624.replace(103, 11, std::string(11, '0'));
    VAR_624.replace(118, 27, std::string(27, '0'));
    VAR_659 = std::string(5, ' ');
    h_pr_ipps_pmt_pct = std::string(185, '0');
    h_pr_ipps_pmt_pct.replace(185, 2, std::string(2, ' '));
    h_pr_ipps_pmt_pct.replace(187, 179, std::string(179, '0'));
    h_pr_ipps_pmt_pct.replace(366, 4, std::string(4, ' '));
    VAR_659 = VAR_666.substr(139, 5);
    if (VAR_606.substr(29, 8) < "20080401") {
        VAR_624.replace(118, 6, "075788");
        VAR_624.replace(124, 6, "024212");
        VAR_624.replace(130, 7, "3835645");
        h_pr_ipps_pmt_pct.replace(64, 9, "002073800");
        VAR_624.replace(137, 4, "1000");
    } else {
        VAR_624.replace(118, 6, "075788");
        VAR_624.replace(124, 6, "024212");
        VAR_624.replace(130, 7, "3808604");
        h_pr_ipps_pmt_pct.replace(64, 9, "002070700");
        VAR_624.replace(137, 4, "1000");
    }
    h_pr_ipps_pmt_pct.replace(339, 5, "42614");
    h_pr_ipps_pmt_pct.replace(344, 5, "20289");
    h_pr_ipps_pmt_pct.replace(349, 3, "075");
    h_pr_ipps_pmt_pct.replace(352, 3, "025");
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_775, VAR_765 + 15), 1LL) > 0 */) {
        h_pr_ipps_pmt_pct.replace(297, 7, "0347845");
        h_pr_ipps_pmt_pct.replace(304, 7, "0151215");
    } else {
        h_pr_ipps_pmt_pct.replace(297, 7, "0309417");
        h_pr_ipps_pmt_pct.replace(304, 7, "0189643");
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_776, VAR_765 + 21), 1LL) > 0 */) {
        h_pr_ipps_pmt_pct.replace(311, 7, "0147110");
        h_pr_ipps_pmt_pct.replace(318, 7, "0090164");
    } else {
        h_pr_ipps_pmt_pct.replace(311, 7, "0139280");
        h_pr_ipps_pmt_pct.replace(318, 7, "0097994");
    }
}
...
void p_1000_edit_the_bill_info() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_613, VAR_606 + 21)) */ && to_int(VAR_606) > 0) {
        h_pr_ipps_pmt_pct = VAR_606.substr(21, 3);
    } else {
        VAR_624 = "56";
    }
    if (to_int(VAR_624) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_720, VAR_666 + 87)) */) {
            VAR_624 = "50";
        }
    }
    if (to_int(VAR_624) == 0) {
    ...
    if (to_int(VAR_624) == 0) {
        if (VAR_606.substr(29, 8) < VAR_666.substr(16, 8) || VAR_606.substr(29, 8) < VAR_759.substr(5, 8)) {
            VAR_624 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_624) == 0) {
        if (VAR_666.substr(40, 8) > "00000000") {
            if (VAR_606.substr(29, 8) >= VAR_666.substr(40, 8)) {
                VAR_624 = "51";
            }
        }
    }
    if (to_int(VAR_624) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_621, VAR_606 + 37)) */) {
            VAR_624 = "58";
        }
    }
    if (to_int(VAR_624) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_615, VAR_606 + 27)) */ || to_int(VAR_606) > 60) {
            VAR_624 = "61";
        }
    }
    if (to_int(VAR_624) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_614, VAR_606 + 24)) */ || to_int(VAR_606) == 0 && to_int(h_pr_ipps_pmt_pct) > 0) {
            VAR_624 = "62";
        }
    }
    if (to_int(VAR_624) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_606 + 27, 2, cob_get_llint (COB_SET_DATA (f_614, VAR_606 + 24)), 0) > 0 */) {
            VAR_624 = "62";
        }
    }
    if (to_int(VAR_624) == 0) {
    ...
    if (to_int(VAR_624) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_756, VAR_666 + 207)) */) {
            h_pr_ipps_pmt_pct.replace(153, 5, VAR_666.substr(207, 5));
        } else {
            h_pr_ipps_pmt_pct.replace(153, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_624) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_721, VAR_666 + 91)) */) {
            h_pr_ipps_pmt_pct.replace(148, 5, VAR_666.substr(91, 5));
        } else {
            h_pr_ipps_pmt_pct.replace(148, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_624) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_722, VAR_666 + 96)) */) {
            h_pr_ipps_pmt_pct.replace(158, 5, VAR_666.substr(96, 5));
        } else {
            h_pr_ipps_pmt_pct.replace(158, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_624) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_725, VAR_666 + 110)) */) {
            h_pr_ipps_pmt_pct.replace(167, 4, VAR_666.substr(110, 4));
        } else {
            h_pr_ipps_pmt_pct.replace(167, 4, std::string(4, '0'));
        }
    }
    if (to_int(VAR_624) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_726, VAR_666 + 114)) */) {
            h_pr_ipps_pmt_pct.replace(171, 4, VAR_666.substr(114, 4));
        } else {
            h_pr_ipps_pmt_pct.replace(171, 4, std::string(4, '0'));
        }
    }
}
...
void p_1200_days_used() {
    if (to_int(VAR_606) > 0 && to_int(h_pr_ipps_pmt_pct) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_606 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_624.replace(106, 3, h_pr_ipps_pmt_pct.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_pr_ipps_pmt_pct) > 0 && to_int(VAR_606) == 0) {
            if (h_pr_ipps_pmt_pct.substr(3, 3) > h_pr_ipps_pmt_pct.substr(0, 3)) {
                VAR_624.replace(103, 3, h_pr_ipps_pmt_pct.substr(0, 3));
            } else {
                VAR_624.replace(103, 3, h_pr_ipps_pmt_pct.substr(3, 3));
            }
        } else {
            if (to_int(h_pr_ipps_pmt_pct) > 0 && to_int(VAR_606) > 0) {
                if (h_pr_ipps_pmt_pct.substr(3, 3) > h_pr_ipps_pmt_pct.substr(0, 3)) {
                    VAR_624.replace(103, 3, h_pr_ipps_pmt_pct.substr(0, 3));
                    VAR_624.replace(106, 3, std::string(3, '0'));
                } else {
                    if (false /* TODO: cob_cmp_numdisp (h_pr_ipps_pmt_pct + 6, 5, cob_get_llint (h_los), 0) > 0 */) {
                        VAR_624.replace(103, 3, h_pr_ipps_pmt_pct.substr(3, 3));
                    } else {
                        if (false /* TODO: cob_cmp_numdisp (h_pr_ipps_pmt_pct + 6, 5, cob_get_llint (h_los), 0) <= 0 */) {
                            VAR_624.replace(103, 3, h_pr_ipps_pmt_pct.substr(3, 3));
...
void p_1700_edit_drg_code() {
    VAR_624.replace(95, 3, VAR_606.substr(18, 3));
    if (to_int(VAR_624) == 0) {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_25 + 15LL * ((cob_s64_t)(wwm_indx) - 1), VAR_624 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_273;
...
void p_1800_edit_ipps_drg_code() {
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_612, VAR_606 + 18)) */) {
        VAR_624 = "54";
    }
    if (false /* TODO: memcmp (VAR_606 + 29, VAR_278 + 14008LL * ((cob_s64_t)(dx5) - 1), 8) >= 0 */ && to_int(VAR_624) == 0) {
        // dx6 = cob_get_numdisp (b_606 + 18, 3);
        h_pr_ipps_pmt_pct.replace(334, 2, std::string(2, '0'));
    }
}
...
void p_2000_assemble_pps_variables() {
    if (false /* cob_cmp >= 0 */) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_764, VAR_759 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_764, VAR_759 + 25), 0LL) > 0 */) {
            // MOVE to computed field
        } else {
            VAR_624 = "52";
        }
    } else if (false /* cob_cmp < 0 */ && false /* cob_cmp >= 0 */) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_763, VAR_759 + 19)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_763, VAR_759 + 19), 0LL) > 0 */) {
            // MOVE to computed field
        } else {
            VAR_624 = "52";
        }
    } else if (false /* cob_cmp < 0 */) {
        VAR_624 = "52";
    }
    if (false /* cob_cmp < 0 */) {
        VAR_624 = "74";
    ...
    if (VAR_666.at(137) == '1') {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_742, VAR_666 + 154)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_742, VAR_666 + 154), 0LL) > 0 */) {
            VAR_624.replace(15, 6, VAR_666.substr(154, 6));
        } else {
            VAR_624 = "52";
        }
    }
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_723, VAR_666 + 101)) */) {
        VAR_624 = "65";
    }
    // MOVE to computed field
    if (to_int(VAR_624) > 0 && to_int(VAR_624) < 6) {
    } else {
        VAR_624 = "72";
    }
    h_blend_fac = "0";
    h_blend_pps = "1";
    h_pr_ipps_pmt_pct.replace(14, 2, std::string(2, '0'));
    if (to_int(VAR_624) == 1) {
        h_pr_ipps_pmt_pct.replace(16, 2, "08");
        h_pr_ipps_pmt_pct.replace(18, 2, "02");
        h_pr_ipps_pmt_pct.replace(14, 2, "04");
    } else {
        if (to_int(VAR_624) == 2) {
            h_pr_ipps_pmt_pct.replace(16, 2, "06");
            h_pr_ipps_pmt_pct.replace(18, 2, "04");
            h_pr_ipps_pmt_pct.replace(14, 2, "08");
        } else {
            if (to_int(VAR_624) == 3) {
                h_pr_ipps_pmt_pct.replace(16, 2, "04");
                h_pr_ipps_pmt_pct.replace(18, 2, "06");
                h_pr_ipps_pmt_pct.replace(14, 2, "12");
            } else {
                if (to_int(VAR_624) == 4) {
                    h_pr_ipps_pmt_pct.replace(16, 2, "02");
                    h_pr_ipps_pmt_pct.replace(18, 2, "08");
                    h_pr_ipps_pmt_pct.replace(14, 2, "16");
                }
            }
        }
    }
...
void p_3000_calc_payment() {
    if (to_int(VAR_666) == 2 || to_int(VAR_666) == 12) {
        VAR_624.replace(110, 4, VAR_666.substr(87, 4));
    } else {
        VAR_624.replace(110, 4, "1000");
    }
    h_labor_portion = to_string(to_num(0) * to_num(1));
    h_nonlabor_portion = to_string(to_num(0) * to_num(1));
    h_pr_ipps_pmt_pct.replace(357, 9, VAR_624.substr(41, 9));
...
void p_3400_short_stay() {
    if (VAR_666.substr(10, 6) == "332006") {
        p_4000_special_provider();
    } else {
        h_pr_ipps_pmt_pct.replace(29, 9, VAR_624.substr(68, 9));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_775, VAR_765 + 15)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_775, VAR_765 + 15), 0LL) > 0 */) {
            if (false /* cob_cmp > 0 */ && VAR_606.substr(29, 8) < "20071229" || VAR_606.substr(29, 8) > "20071228") {
    ...
    h_pr_ipps_pmt_pct.at(366) = 'N';
    h_pr_ipps_pmt_pct.at(367) = 'N';
    h_pr_ipps_pmt_pct.at(368) = 'N';
    h_pr_ipps_pmt_pct.at(369) = 'N';
    if (h_pr_ipps_pmt_pct.substr(29, 9) < h_pr_ipps_pmt_pct.substr(20, 9)) {
        if (h_pr_ipps_pmt_pct.substr(29, 9) < VAR_624.substr(41, 9)) {
            VAR_624.replace(41, 9, h_pr_ipps_pmt_pct.substr(29, 9));
            VAR_624 = "20";
            h_pr_ipps_pmt_pct.at(366) = 'Y';
        } else {
        }
    } else {
        if (h_pr_ipps_pmt_pct.substr(20, 9) < VAR_624.substr(41, 9)) {
            VAR_624.replace(41, 9, h_pr_ipps_pmt_pct.substr(20, 9));
            VAR_624 = "21";
            h_pr_ipps_pmt_pct.at(367) = 'Y';
        } else {
        }
    }
    if (VAR_666.substr(10, 6) != "332006") {
        if (false /* cob_cmp > 0 */ && VAR_606.substr(29, 8) < "20071229" || VAR_606.substr(29, 8) > "20071228") {
            if (h_pr_ipps_pmt_pct.substr(280, 9) < VAR_624.substr(41, 9)) {
                VAR_624.replace(41, 9, h_pr_ipps_pmt_pct.substr(280, 9));
                VAR_624 = std::string(2, static_cast<char>(50));
                h_pr_ipps_pmt_pct.at(368) = 'Y';
                h_pr_ipps_pmt_pct.at(366) = 'N';
                h_pr_ipps_pmt_pct.at(367) = 'N';
                h_pr_ipps_pmt_pct.at(369) = 'N';
            } else {
            ...
            if (h_pr_ipps_pmt_pct.substr(262, 9) < VAR_624.substr(41, 9)) {
                VAR_624.replace(41, 9, h_pr_ipps_pmt_pct.substr(262, 9));
                VAR_624 = "26";
                h_pr_ipps_pmt_pct.at(369) = 'Y';
                h_pr_ipps_pmt_pct.at(368) = 'N';
                h_pr_ipps_pmt_pct.at(366) = 'N';
                h_pr_ipps_pmt_pct.at(367) = 'N';
            } else {
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(h_capi_ime_ratio) > to_int(c_23)) {
        h_pr_ipps_pmt_pct.replace(153, 5, "15000");
    }
    h_capi_ime_teach = to_string(to_num(0) - to_num(1));
    if (VAR_765.at(5) == 'R') {
        h_pr_ipps_pmt_pct.at(186) = '0';
    } else {
        h_pr_ipps_pmt_pct.at(186) = '1';
    }
    h_oper_dsh_pct = to_string(to_num(0) + to_num(1));
    if (h_pr_ipps_pmt_pct.at(186) == '1' && to_int(h_pr_ipps_pmt_pct) < 100 && to_int(h_oper_dsh_pct) >= to_int(c_7)) {
        h_pr_ipps_pmt_pct.at(185) = static_cast<char>(51);
    } else {
        if (h_pr_ipps_pmt_pct.at(186) == '1' && to_int(h_pr_ipps_pmt_pct) >= 100 && to_int(h_oper_dsh_pct) >= to_int(c_7)) {
            h_pr_ipps_pmt_pct.at(185) = static_cast<char>(50);
        } else {
            if (h_pr_ipps_pmt_pct.at(186) == '0' && to_int(h_pr_ipps_pmt_pct) >= 500 && to_int(h_oper_dsh_pct) >= to_int(c_7)) {
                h_pr_ipps_pmt_pct.at(185) = static_cast<char>(50);
            } else {
                if (h_pr_ipps_pmt_pct.at(186) == '0' && to_int(h_pr_ipps_pmt_pct) < 500 && to_int(h_oper_dsh_pct) >= to_int(c_7)) {
                    h_pr_ipps_pmt_pct.at(185) = static_cast<char>(51);
                } else {
                    h_pr_ipps_pmt_pct.at(185) = static_cast<char>(52);
                }
            }
        }
    }
    if (h_pr_ipps_pmt_pct.at(185) == '2') {
        if (to_int(h_oper_dsh_pct) >= to_int(c_7) && to_int(h_oper_dsh_pct) <= to_int(c_10)) {
            ...
            if (to_int(h_oper_dsh_pct) > to_int(c_10)) {
                ...
                h_pr_ipps_pmt_pct.replace(175, 5, std::string(5, '0'));
            }
        }
    } else if (h_pr_ipps_pmt_pct.at(185) == '3') {
        if (to_int(h_oper_dsh_pct) >= to_int(c_7) && to_int(h_oper_dsh_pct) <= to_int(c_10)) {
            h_oper_dsh = to_string(to_num(0) + to_num(1));
    ...
    } else if (h_pr_ipps_pmt_pct.at(185) == '4') {
        h_pr_ipps_pmt_pct.replace(175, 5, std::string(5, '0'));
    } else if (h_pr_ipps_pmt_pct.at(186) == '1' && to_int(h_pr_ipps_pmt_pct) >= 100) {
        h_capi_dsh = to_string(to_num(0) - to_num(1));
    } else {
        h_pr_ipps_pmt_pct.replace(180, 5, std::string(5, '0'));
    }
    if (to_int(VAR_666) == 2 || to_int(VAR_666) == 12) {
        h_pr_ipps_pmt_pct.replace(289, 4, VAR_666.substr(87, 4));
    } else {
        h_pr_ipps_pmt_pct.replace(289, 4, "1000");
    }
    h_stand_amt_oper_pmt = to_string(to_num(0) * to_num(1));
    h_capi_cola = to_string(to_num(0) + to_num(1));
    if (VAR_765.at(5) == 'L') {
        h_pr_ipps_pmt_pct.replace(241, 3, "100");
    } else {
        h_pr_ipps_pmt_pct.replace(241, 3, "100");
    }
    ...
    if (h_pr_ipps_pmt_pct.substr(262, 9) > h_pr_ipps_pmt_pct.substr(244, 9)) {
        h_pr_ipps_pmt_pct.replace(262, 9, h_pr_ipps_pmt_pct.substr(244, 9));
    }
    if (to_int(VAR_666) == 40) {
...
void p_3675_ss_ipps_comp_pr_pmt() {
    ...
    if (h_pr_ipps_pmt_pct.substr(271, 9) > h_pr_ipps_pmt_pct.substr(253, 9)) {
        h_pr_ipps_pmt_pct.replace(271, 9, h_pr_ipps_pmt_pct.substr(253, 9));
    }
    h_ipps_per_diem = to_string(to_num(0) + to_num(1));
}
...
void p_4000_special_provider() {
    if (VAR_606.substr(29, 8) >= "20030701" && VAR_606.substr(29, 8) < "20040101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_606.substr(29, 8) >= "20040101" && VAR_606.substr(29, 8) < "20050101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_606.substr(29, 8) >= "20050101" && VAR_606.substr(29, 8) < "20060101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_606.substr(29, 8) >= "20060101" && VAR_606.substr(29, 8) < "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_606.substr(29, 8) >= "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
}
...
void p_7000_calc_outlier() {
    if (VAR_624.substr(68, 9) > VAR_624.substr(86, 9)) {
    }
    if (VAR_606.at(46) == '1') {
        // MOVE "0" to computed field
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_632, VAR_624 + 29), 0LL) > 0 */ && to_int(VAR_624) == 21) {
        VAR_624 = "24";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_632, VAR_624 + 29), 0LL) > 0 */ && to_int(VAR_624) == 22) {
        VAR_624 = "25";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_632, VAR_624 + 29), 0LL) > 0 */ && to_int(VAR_624) == 26) {
        VAR_624 = "27";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_632, VAR_624 + 29), 0LL) > 0 */ && to_int(VAR_624) == 0) {
        VAR_624 = "01";
    }
    if (to_int(VAR_624) == 0 || to_int(VAR_624) == 20 || to_int(VAR_624) == 21 || to_int(VAR_624) == 22 || to_int(VAR_624) == 26) {
        if (false /* cob_cmp > 0 */) {
            VAR_624.replace(106, 3, std::string(3, '0'));
        } else {
        }
    }
    if (to_int(VAR_624) == 1 || to_int(VAR_624) == 24 || to_int(VAR_624) == 25 || to_int(VAR_624) == 27 || VAR_624.at(161) == 'Y') {
        if (VAR_606.substr(24, 3) < h_pr_ipps_pmt_pct.substr(0, 3) || VAR_624.at(161) == 'Y' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_723, VAR_666 + 101), 0LL) != 0 */) {
            if (VAR_624.substr(162, 2) == "PC") {
                VAR_624 = "67";
            }
        } else {
        }
...
void p_8000_blend() {
    ...
    if (to_int(VAR_624) == 20 || to_int(VAR_624) == 21 || to_int(VAR_624) == 22 || to_int(VAR_624) == 26 && to_int(h_pr_ipps_pmt_pct) > 0) {
    } else {
        if (to_int(VAR_624) == 24 || to_int(VAR_624) == 25 || to_int(VAR_624) == 27 && to_int(h_pr_ipps_pmt_pct) > 0) {
        } else {
        }
    }
}
...
void p_9000_move_results() {
    if (to_int(VAR_624) < 50) {
        VAR_624.replace(38, 3, h_pr_ipps_pmt_pct.substr(0, 3));
        VAR_624.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_624.replace(11, 4, std::string(4, ' '));
        VAR_624.replace(15, 80, std::string(80, '0'));
        VAR_624.replace(95, 8, std::string(8, ' '));
...
//   - Types hardened: 103
//   - Bounds checks added: 36
//   - Names converted: 136
//   - Error handlers: 1
//   - Vulnerabilities fixed: 0
//   - Empty functions flagged: 18
//
// Security Checklist:
