...
std::string VAR_1185; // Auto-declared by LAZARUS healer

std::string VAR_1264; // Auto-declared by LAZARUS healer

std::string VAR_1253; // Auto-declared by LAZARUS healer

std::string VAR_1252; // Auto-declared by LAZARUS healer

std::string VAR_1212; // Auto-declared by LAZARUS healer
...
void p_0000_mainline_control() {
    ...
    if (VAR_1212.substr(0, 2) >= "50" && VAR_1212.at(0) == 'D') {
...
void p_0100_initial_routine() {
    VAR_1212 = std::string(2, '0');
    VAR_1212.replace(11, 4, std::string(4, ' '));
    VAR_1212.replace(15, 80, std::string(80, '0'));
    VAR_1212.replace(95, 8, std::string(8, ' '));
    VAR_1212.replace(103, 11, std::string(11, '0'));
    VAR_1212.replace(118, 27, std::string(27, '0'));
    VAR_1252 = std::string(5, ' ');
    VAR_1253 = std::string(36, '0');
    ...
    VAR_1252 = VAR_1264.substr(139, 5);
    // MOVE "665" to computed field
    // MOVE "335" to computed field
    if (VAR_1264.at(138) == '1') {
        VAR_1212.replace(130, 7, "4247641");
    } else {
        VAR_1212.replace(130, 7, "4164149");
    }
    h_outlier_pay_amt_snt.replace(64, 9, "002194300");
    h_outlier_pay_amt_snt.replace(73, 9, "002357300");
    VAR_1212.replace(137, 4, "1000");
    h_outlier_pay_amt_snt.replace(349, 5, "44679");
    // MOVE to computed field
    if (to_int(h_ipps_wage_index) > 1) {
        h_outlier_pay_amt_snt.replace(306, 7, "0383923");
        h_outlier_pay_amt_snt.replace(313, 7, "0167691");
    } else {
        h_outlier_pay_amt_snt.replace(306, 7, "0342001");
        h_outlier_pay_amt_snt.replace(313, 7, "0209613");
    }
    h_outlier_pay_amt_snt.replace(379, 4, "6652");
}
...
void p_1000_edit_input_data() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1192, VAR_1185 + 21)) */ && to_int(VAR_1185) > 0) {
        h_outlier_pay_amt_snt = VAR_1185.substr(21, 3);
    } else {
        VAR_1212 = "56";
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1321, VAR_1264 + 87)) */) {
            VAR_1212 = "50";
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
    ...
    if (VAR_1212.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1191, VAR_1185 + 18)) */) {
            VAR_1212 = "54";
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (VAR_1185.substr(32, 8) < VAR_1264.substr(16, 8) || VAR_1185.substr(32, 8) < VAR_1361.substr(5, 8)) {
            VAR_1212 = std::string(2, static_cast<char>(53));
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (VAR_1264.substr(40, 8) > "00000000") {
            if (VAR_1185.substr(32, 8) >= VAR_1264.substr(40, 8)) {
                VAR_1212 = "51";
            }
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1201, VAR_1185 + 40)) */) {
            VAR_1212 = "58";
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1194, VAR_1185 + 27)) */ || to_int(VAR_1185) > 60) {
            VAR_1212 = "61";
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1193, VAR_1185 + 24)) */ || to_int(VAR_1185) == 0 && to_int(h_outlier_pay_amt_snt) > 0) {
            VAR_1212 = "62";
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (false /* TODO: cob_cmp_numdisp (VAR_1185 + 27, 2, cob_get_llint (COB_SET_DATA (f_1193, VAR_1185 + 24)), 0) > 0 */) {
            VAR_1212 = "62";
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (to_int(VAR_1185) < 0 || to_int(VAR_1185) > 8 || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1203, VAR_1185 + 50)) */) {
            VAR_1212 = "72";
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
    ...
    if (VAR_1212.substr(0, 2) == "00") {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1324, VAR_1264 + 101)) */) {
            VAR_1212 = "65";
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1357, VAR_1264 + 207)) */) {
            h_outlier_pay_amt_snt.replace(162, 5, VAR_1264.substr(207, 5));
        } else {
            h_outlier_pay_amt_snt.replace(162, 5, std::string(5, '0'));
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1322, VAR_1264 + 91)) */) {
            h_outlier_pay_amt_snt.replace(157, 5, VAR_1264.substr(91, 5));
        } else {
            h_outlier_pay_amt_snt.replace(157, 5, std::string(5, '0'));
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1323, VAR_1264 + 96)) */) {
            h_outlier_pay_amt_snt.replace(167, 5, VAR_1264.substr(96, 5));
        } else {
            h_outlier_pay_amt_snt.replace(167, 5, std::string(5, '0'));
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1326, VAR_1264 + 110)) */) {
            h_outlier_pay_amt_snt.replace(176, 4, VAR_1264.substr(110, 4));
        } else {
            h_outlier_pay_amt_snt.replace(176, 4, std::string(4, '0'));
        }
    }
    if (VAR_1212.substr(0, 2) == "00") {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1327, VAR_1264 + 114)) */) {
            h_outlier_pay_amt_snt.replace(180, 4, VAR_1264.substr(114, 4));
        } else {
...
void p_1200_days_used() {
    if (to_int(VAR_1185) > 0 && to_int(h_outlier_pay_amt_snt) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_1185 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_1212.replace(106, 3, h_outlier_pay_amt_snt.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_outlier_pay_amt_snt) > 0 && to_int(VAR_1185) == 0) {
            if (h_outlier_pay_amt_snt.substr(3, 3) > h_outlier_pay_amt_snt.substr(0, 3)) {
                VAR_1212.replace(103, 3, h_outlier_pay_amt_snt.substr(0, 3));
            } else {
                VAR_1212.replace(103, 3, h_outlier_pay_amt_snt.substr(3, 3));
            }
        } else {
            if (to_int(h_outlier_pay_amt_snt) > 0 && to_int(VAR_1185) > 0) {
                if (h_outlier_pay_amt_snt.substr(3, 3) > h_outlier_pay_amt_snt.substr(0, 3)) {
                    VAR_1212.replace(103, 3, h_outlier_pay_amt_snt.substr(0, 3));
                    VAR_1212.replace(106, 3, std::string(3, '0'));
                } else {
...
void p_1700_edit_drg_code() {
    VAR_1212.replace(95, 3, VAR_1185.substr(18, 3));
    if (VAR_1212.substr(0, 2) == "00") {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_37 + 15LL * ((cob_s64_t)(wwm_indx) - 1), VAR_1212 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_289;
...
void p_1800_edit_ipps_drg_code() {
    if (VAR_1185.substr(32, 8) >= wk_drgx_eff_date.substr(0, 8)) {
        drg_idx = to_string(1);
        // UNHANDLED: const int max = 757;
        while (true) {
...
void p_2000_assemble_pps_variables() {
    ...
    // MOVE to computed field
    if (to_int(VAR_1185) == 0 && to_int(VAR_1212) != 5) {
        VAR_1212.at(109) = static_cast<char>(53);
    }
    if (to_int(VAR_1185) >= 1 && to_int(VAR_1185) <= 8 && to_int(VAR_1212) < 6 || to_int(VAR_1212) > 8) {
        VAR_1212 = "72";
    }
    h_blend_snt = "0";
    h_blend_std = "1";
    h_outlier_pay_amt_snt.replace(14, 2, std::string(2, '0'));
    if (to_int(VAR_1264) == 2 || to_int(VAR_1264) == 12) {
        VAR_1212.replace(110, 4, VAR_1264.substr(87, 4));
    } else {
        VAR_1212.replace(110, 4, "1000");
    }
}
...
void p_3100_determine_payment_type() {
    if (to_int(VAR_1185) == 0 || VAR_1264.substr(10, 6) == "332006") {
        program_flags.at(0) = '1';
    }
    if (to_int(VAR_1185) == 1 && VAR_1212.substr(95, 3) == "876" || to_int(VAR_1185) == 4 || to_int(VAR_1185) == 5) {
        program_flags.at(0) = static_cast<char>(50);
    }
    if (to_int(VAR_1185) == 1 && VAR_1212.substr(95, 3) == "876" || VAR_1212.substr(95, 3) == "880" || VAR_1212.substr(95, 3) == "881" || VAR_1212.substr(95, 3) == "882" || VAR_1212.substr(95, 3) == "883" || VAR_1212.substr(95, 3) == "884" || VAR_1212.substr(95, 3) == "885" || VAR_1212.substr(95, 3) == "887" || VAR_1212.substr(95, 3) == "886" || VAR_1212.substr(95, 3) == "894" || VAR_1212.substr(95, 3) == "895" || VAR_1212.substr(95, 3) == "896" || VAR_1212.substr(95, 3) == "897" || VAR_1212.substr(95, 3) == "945" || VAR_1212.substr(95, 3) == "946" || to_int(VAR_1185) == 2 || to_int(VAR_1185) == 3 || to_int(VAR_1185) == 6 || to_int(VAR_1185) == 7 || to_int(VAR_1185) == 8) {
        h_bdgt_neut_factor = "0949";
        if (to_int(VAR_1212) == 8) {
            program_flags.at(0) = static_cast<char>(51);
        } else {
            if (to_int(VAR_1212) == 6 || to_int(VAR_1212) == 7) {
...
void p_3200_calc_standard_pmt() {
    ...
    h_outlier_pay_amt_snt.replace(417, 9, VAR_1212.substr(41, 9));
    ...
    if (to_int(h_los) <= to_int(h_ssot)) {
        ...
        if (program_flags.at(0) == '2' || program_flags.at(0) == '4') {
            ...
            VAR_1253.replace(27, 9, VAR_1212.substr(41, 9));
        }
    } else {
        if (program_flags.at(0) == '2' || program_flags.at(0) == '4') {
            program_flags.at(2) = '1';
            VAR_1253.replace(18, 9, VAR_1212.substr(41, 9));
        }
    }
}
...
void p_3300_calc_site_neutral_pmt() {
    ...
    if (VAR_1212.substr(68, 9) < h_outlier_pay_amt_snt.substr(271, 9)) {
        program_flags.at(1) = '1';
        VAR_1253 = VAR_1212.substr(68, 9);
    } else {
        program_flags.at(1) = static_cast<char>(50);
        VAR_1253.replace(9, 9, h_outlier_pay_amt_snt.substr(271, 9));
    }
}
...
void p_3400_short_stay() {
    ...
    if (h_outlier_pay_amt_snt.substr(29, 9) < h_outlier_pay_amt_snt.substr(20, 9)) {
        if (h_outlier_pay_amt_snt.substr(29, 9) < VAR_1212.substr(41, 9)) {
            VAR_1212.replace(41, 9, h_outlier_pay_amt_snt.substr(29, 9));
            if (program_flags.at(0) == '1') {
                VAR_1212 = "20";
            }
        ...
        if (h_outlier_pay_amt_snt.substr(20, 9) < VAR_1212.substr(41, 9)) {
            VAR_1212.replace(41, 9, h_outlier_pay_amt_snt.substr(20, 9));
            if (program_flags.at(0) == '1') {
                VAR_1212 = "21";
            }
    ...
    if (VAR_1264.substr(10, 6) == "332006") {
        if (VAR_1185.substr(32, 8) >= "20121229" && false /* cob_cmp > 0 */ && h_outlier_pay_amt_snt.substr(289, 9) < VAR_1212.substr(41, 9)) {
            VAR_1212.replace(41, 9, h_outlier_pay_amt_snt.substr(289, 9));
            if (program_flags.at(0) == '1') {
                VAR_1212 = std::string(2, static_cast<char>(50));
            }
            ...
            if (VAR_1185.substr(32, 8) >= "20121229" && false /* cob_cmp <= 0 */ && h_outlier_pay_amt_snt.substr(271, 9) <= VAR_1212.substr(41, 9)) {
                VAR_1212.replace(41, 9, h_outlier_pay_amt_snt.substr(271, 9));
                if (program_flags.at(0) == '1') {
                    VAR_1212 = "26";
                }
                ...
                if (VAR_1185.substr(32, 8) < "20121229" && h_outlier_pay_amt_snt.substr(289, 9) < VAR_1212.substr(41, 9)) {
                    VAR_1212.replace(41, 9, h_outlier_pay_amt_snt.substr(289, 9));
                    if (program_flags.at(0) == '1') {
                        VAR_1212 = std::string(2, static_cast<char>(50));
                    }
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(VAR_1264) == 2 || to_int(VAR_1264) == 12) {
        h_outlier_pay_amt_snt.replace(298, 4, VAR_1264.substr(87, 4));
    } else {
...
void p_4000_special_provider() {
    if (VAR_1185.substr(32, 8) >= "20030701" && VAR_1185.substr(32, 8) < "20040101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1185.substr(32, 8) >= "20040101" && VAR_1185.substr(32, 8) < "20050101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1185.substr(32, 8) >= "20050101" && VAR_1185.substr(32, 8) < "20060101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1185.substr(32, 8) >= "20060101" && VAR_1185.substr(32, 8) < "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1185.substr(32, 8) >= "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
}
...
void p_6000_calc_high_cost_outlier() {
    ...
    if (program_flags.at(0) == '4' && program_flags.at(1) == '1') {
        if (VAR_1212.substr(68, 9) > VAR_1212.substr(86, 9)) {
        }
    }
    if (program_flags.at(0) == '4') {
        if (program_flags.at(2) == '1') {
        ...
        if (VAR_1212.substr(68, 9) > h_outlier_pay_amt_snt.substr(383, 9)) {
            h_outlier_pay_amt_std = to_string(to_num(0) * to_num(1));
        }
        if (program_flags.at(1) == '2' && VAR_1212.substr(68, 9) > VAR_1212.substr(86, 9)) {
...
void p_6100_calc_charge_threshold() {
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) > 0 */ && program_flags.at(0) == '4' || VAR_1212.at(161) == 'Y') {
        if (VAR_1185.substr(24, 3) < h_outlier_pay_amt_snt.substr(0, 3) || VAR_1212.at(161) == 'Y' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1324, VAR_1264 + 101), 0LL) != 0 */) {
            if (VAR_1212.substr(162, 2) == "PC") {
                VAR_1212 = "67";
            }
        } else {
        }
...
void p_7100_set_old_return_codes() {
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) > 0 */ && VAR_1212.substr(0, 2) == "21") {
        VAR_1212 = "24";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) > 0 */ && VAR_1212.substr(0, 2) == "22") {
        VAR_1212 = "25";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) > 0 */ && VAR_1212.substr(0, 2) == "26") {
        VAR_1212 = "27";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) > 0 */ && VAR_1212.substr(0, 2) == "00") {
        VAR_1212 = "01";
    }
    if (VAR_1212.substr(0, 2) == "00" || VAR_1212.substr(0, 2) == "20" || VAR_1212.substr(0, 2) == "21" || VAR_1212.substr(0, 2) == "22" || VAR_1212.substr(0, 2) == "26") {
        if (false /* cob_cmp > 0 */) {
            VAR_1212.replace(106, 3, std::string(3, '0'));
        } else {
        }
...
void p_7200_set_new_return_codes() {
    VAR_1212 = std::string(2, ' ');
    VAR_1212.at(0) = static_cast<char>(67);
    p_7250_search_for_vent_proc();
    if (program_flags.at(3) == 'Y') {
        VAR_1212.at(0) = static_cast<char>(66);
    }
    if (VAR_1212.substr(95, 3) == "876" || VAR_1212.substr(95, 3) == "880" || VAR_1212.substr(95, 3) == "881" || VAR_1212.substr(95, 3) == "882" || VAR_1212.substr(95, 3) == "883" || VAR_1212.substr(95, 3) == "884" || VAR_1212.substr(95, 3) == "885" || VAR_1212.substr(95, 3) == "887" || VAR_1212.substr(95, 3) == "886" || VAR_1212.substr(95, 3) == "894" || VAR_1212.substr(95, 3) == "895" || VAR_1212.substr(95, 3) == "896" || VAR_1212.substr(95, 3) == "897" || VAR_1212.substr(95, 3) == "945" || VAR_1212.substr(95, 3) == "946" && program_flags.at(0) == '3' || program_flags.at(0) == '4') {
        VAR_1212.at(0) = 'A';
    }
    if (program_flags.at(0) == '4' && program_flags.at(1) == '1') {
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) == 0 */ && program_flags.at(2) == '1') {
            VAR_1212.at(1) = '0';
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) > 0 */ && program_flags.at(2) == '1') {
            VAR_1212.at(1) = '1';
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) == 0 */ && program_flags.at(2) == '2') {
            VAR_1212.at(1) = static_cast<char>(50);
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) > 0 */ && program_flags.at(2) == '2') {
            VAR_1212.at(1) = static_cast<char>(51);
        }
    }
    if (program_flags.at(0) == '4' && program_flags.at(1) == '2') {
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) == 0 */ && program_flags.at(2) == '1') {
            VAR_1212.at(1) = static_cast<char>(52);
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) > 0 */ && program_flags.at(2) == '1') {
            VAR_1212.at(1) = static_cast<char>(53);
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) == 0 */ && program_flags.at(2) == '2') {
            VAR_1212.at(1) = static_cast<char>(54);
        }
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) > 0 */ && program_flags.at(2) == '2') {
            VAR_1212.at(1) = static_cast<char>(55);
        }
    }
    if (program_flags.at(0) == '3') {
        ...
        if (program_flags.at(1) == '2') {
            if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) == 0 */) {
                VAR_1212.at(1) = static_cast<char>(66);
            } else {
                VAR_1212.at(1) = static_cast<char>(67);
            }
        }
    }
    if (program_flags.at(0) == '2') {
        if (program_flags.at(2) == '2' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) == 0 */) {
            VAR_1212.at(1) = static_cast<char>(68);
        }
        if (program_flags.at(2) == '2' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) > 0 */) {
            VAR_1212.at(1) = static_cast<char>(69);
        }
        if (program_flags.at(2) == '1' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) == 0 */) {
            VAR_1212.at(1) = static_cast<char>(70);
        }
        if (program_flags.at(2) == '1' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1224, VAR_1212 + 29), 0LL) > 0 */) {
            VAR_1212.at(1) = static_cast<char>(71);
        }
    }
}
...
void p_7250_search_for_vent_proc() {
    ...
    while (true) {
        ...
        if (false /* TODO: memcmp (fed_fy_begin_03 + 8, VAR_1185 + 227 + 7LL * ((cob_s64_t)(idx_proc) - 1), 7) == 0 */) {
...
void p_7300_set_subii_return_codes() {
    ...
    // MOVE to computed field
    VAR_1212.replace(29, 9, std::string(9, '0'));
    VAR_1212.replace(41, 9, std::string(9, '0'));
    VAR_1212.replace(50, 9, std::string(9, '0'));
    VAR_1212.replace(68, 9, std::string(9, '0'));
    VAR_1212.replace(95, 3, std::string(3, ' '));
    VAR_1212.replace(118, 6, std::string(6, '0'));
    VAR_1212.replace(124, 6, std::string(6, '0'));
    VAR_1212.replace(130, 7, std::string(7, '0'));
    VAR_1212.replace(137, 4, std::string(4, '0'));
    VAR_1212.replace(141, 4, std::string(4, '0'));
    VAR_1253 = std::string(9, '0');
    VAR_1253.replace(9, 9, std::string(9, '0'));
    VAR_1253.replace(18, 9, std::string(9, '0'));
    VAR_1253.replace(27, 9, std::string(9, '0'));
}
...
void p_9000_move_results() {
    if (VAR_1212.substr(0, 2) >= "50" && VAR_1212.at(0) == 'D') {
        VAR_1212.replace(38, 3, h_outlier_pay_amt_snt.substr(0, 3));
        VAR_1212.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_1212.replace(11, 4, std::string(4, ' '));
        VAR_1212.replace(15, 80, std::string(80, '0'));
        VAR_1212.replace(95, 8, std::string(8, ' '));
...
//   - Types hardened: 103
//   - Bounds checks added: 127
//   - Names converted: 152
//   - Error handlers: 1
//   - Vulnerabilities fixed: 0
//   - Empty functions flagged: 26
//
// Security Checklist:
