...
std::string VAR_1318; // Auto-declared by LAZARUS healer

std::string c_23; // Auto-declared by LAZARUS healer

std::string VAR_1312; // Auto-declared by LAZARUS healer

std::string VAR_1158; // Auto-declared by LAZARUS healer

std::string VAR_1218; // Auto-declared by LAZARUS healer

std::string VAR_1211; // Auto-declared by LAZARUS healer

std::string VAR_1176; // Auto-declared by LAZARUS healer
...
void p_0100_initial_routine() {
    VAR_1176 = std::string(2, '0');
    VAR_1176.replace(11, 4, std::string(4, ' '));
    VAR_1176.replace(15, 80, std::string(80, '0'));
    VAR_1176.replace(95, 8, std::string(8, ' '));
    VAR_1176.replace(103, 11, std::string(11, '0'));
    VAR_1176.replace(118, 27, std::string(27, '0'));
    VAR_1211 = std::string(5, ' ');
    ...
    VAR_1211 = VAR_1218.substr(139, 5);
    p_1900_apply_ssrfbn();
    if (to_int(VAR_1176) != 0) {
    }
    VAR_1176.replace(118, 6, "062537");
    VAR_1176.replace(124, 6, "037463");
    if (VAR_1218.at(138) == '1') {
        VAR_1176.replace(130, 7, "4060731");
    } else {
        VAR_1176.replace(130, 7, "3980874");
    }
    h_oper_dsh_reduction_factor.replace(64, 9, "001331400");
    VAR_1176.replace(137, 4, "1000");
    h_oper_dsh_reduction_factor.replace(340, 5, "42931");
    h_oper_dsh_reduction_factor.replace(345, 5, "20982");
    h_oper_dsh_reduction_factor.replace(350, 3, "075");
    h_oper_dsh_reduction_factor.replace(353, 3, "025");
    if (to_int(h_ipps_wage_index) > 1) {
        h_oper_dsh_reduction_factor.replace(297, 7, "0373771");
        h_oper_dsh_reduction_factor.replace(304, 7, "0163257");
    } else {
        h_oper_dsh_reduction_factor.replace(297, 7, "0332957");
        h_oper_dsh_reduction_factor.replace(304, 7, "0204071");
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1329, VAR_1318 + 21), 1LL) > 0 */) {
        h_oper_dsh_reduction_factor.replace(311, 7, "0160890");
        h_oper_dsh_reduction_factor.replace(318, 7, "0093682");
    } else {
        h_oper_dsh_reduction_factor.replace(311, 7, "0157835");
        h_oper_dsh_reduction_factor.replace(318, 7, "0096737");
    }
    h_oper_dsh_reduction_factor.replace(364, 4, "9570");
}
...
void p_1000_edit_the_bill_info() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1165, VAR_1158 + 21)) */ && to_int(VAR_1158) > 0) {
        h_oper_dsh_reduction_factor = VAR_1158.substr(21, 3);
    } else {
        VAR_1176 = "56";
    }
    if (to_int(VAR_1176) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1272, VAR_1218 + 87)) */) {
            VAR_1176 = "50";
        }
    }
    if (to_int(VAR_1176) == 0) {
    ...
    if (to_int(VAR_1176) == 0) {
        if (VAR_1158.substr(29, 8) < VAR_1218.substr(16, 8) || VAR_1158.substr(29, 8) < VAR_1312.substr(5, 8)) {
            VAR_1176 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_1176) == 0) {
        if (VAR_1218.substr(40, 8) > "00000000") {
            if (VAR_1158.substr(29, 8) >= VAR_1218.substr(40, 8)) {
                VAR_1176 = "51";
            }
        }
    }
    if (to_int(VAR_1176) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1173, VAR_1158 + 37)) */) {
            VAR_1176 = "58";
        }
    }
    if (to_int(VAR_1176) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1167, VAR_1158 + 27)) */ || to_int(VAR_1158) > 60) {
            VAR_1176 = "61";
        }
    }
    if (to_int(VAR_1176) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1166, VAR_1158 + 24)) */ || to_int(VAR_1158) == 0 && to_int(h_oper_dsh_reduction_factor) > 0) {
            VAR_1176 = "62";
        }
    }
    if (to_int(VAR_1176) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_1158 + 27, 2, cob_get_llint (COB_SET_DATA (f_1166, VAR_1158 + 24)), 0) > 0 */) {
            VAR_1176 = "62";
        }
    }
    if (to_int(VAR_1176) == 0) {
    ...
    if (to_int(VAR_1176) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1308, VAR_1218 + 207)) */) {
            h_oper_dsh_reduction_factor.replace(153, 5, VAR_1218.substr(207, 5));
        } else {
            h_oper_dsh_reduction_factor.replace(153, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_1176) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1273, VAR_1218 + 91)) */) {
            h_oper_dsh_reduction_factor.replace(148, 5, VAR_1218.substr(91, 5));
        } else {
            h_oper_dsh_reduction_factor.replace(148, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_1176) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1274, VAR_1218 + 96)) */) {
            h_oper_dsh_reduction_factor.replace(158, 5, VAR_1218.substr(96, 5));
        } else {
            h_oper_dsh_reduction_factor.replace(158, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_1176) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1277, VAR_1218 + 110)) */) {
            h_oper_dsh_reduction_factor.replace(167, 4, VAR_1218.substr(110, 4));
        } else {
            h_oper_dsh_reduction_factor.replace(167, 4, std::string(4, '0'));
        }
    }
    if (to_int(VAR_1176) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1278, VAR_1218 + 114)) */) {
            h_oper_dsh_reduction_factor.replace(171, 4, VAR_1218.substr(114, 4));
        } else {
...
void p_1200_days_used() {
    if (to_int(VAR_1158) > 0 && to_int(h_oper_dsh_reduction_factor) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_1158 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_1176.replace(106, 3, h_oper_dsh_reduction_factor.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_oper_dsh_reduction_factor) > 0 && to_int(VAR_1158) == 0) {
            if (h_oper_dsh_reduction_factor.substr(3, 3) > h_oper_dsh_reduction_factor.substr(0, 3)) {
                VAR_1176.replace(103, 3, h_oper_dsh_reduction_factor.substr(0, 3));
            } else {
                VAR_1176.replace(103, 3, h_oper_dsh_reduction_factor.substr(3, 3));
            }
        } else {
            if (to_int(h_oper_dsh_reduction_factor) > 0 && to_int(VAR_1158) > 0) {
                if (h_oper_dsh_reduction_factor.substr(3, 3) > h_oper_dsh_reduction_factor.substr(0, 3)) {
                    VAR_1176.replace(103, 3, h_oper_dsh_reduction_factor.substr(0, 3));
                    VAR_1176.replace(106, 3, std::string(3, '0'));
                } else {
...
void p_1700_edit_drg_code() {
    VAR_1176.replace(95, 3, VAR_1158.substr(18, 3));
    if (to_int(VAR_1176) == 0) {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_25 + 15LL * ((cob_s64_t)(wwm_indx) - 1), VAR_1176 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_275;
...
void p_1800_edit_ipps_drg_code() {
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1164, VAR_1158 + 18)) */) {
        VAR_1176 = "54";
    }
    if (VAR_1158.substr(29, 8) >= wk_drgx_eff_date.substr(0, 8)) {
        drg_idx = to_string(1);
        // UNHANDLED: const int max = 751;
        while (true) {
...
void p_2000_assemble_pps_variables() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1317, VAR_1312 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1317, VAR_1312 + 25), 0LL) > 0 */) {
        // MOVE to computed field
    } else {
        VAR_1176 = "52";
    }
    ...
    if (VAR_1218.at(137) == '1') {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1294, VAR_1218 + 154)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1294, VAR_1218 + 154), 0LL) > 0 */) {
            VAR_1176.replace(15, 6, VAR_1218.substr(154, 6));
        } else {
            VAR_1176 = "52";
        }
    }
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1275, VAR_1218 + 101)) */) {
        VAR_1176 = "65";
    }
    // MOVE to computed field
    if (to_int(VAR_1176) > 0 && to_int(VAR_1176) < 6) {
    } else {
        VAR_1176 = "72";
    }
    h_blend_fac = "0";
...
void p_3000_calc_payment() {
    if (to_int(VAR_1218) == 2 || to_int(VAR_1218) == 12) {
        VAR_1176.replace(110, 4, VAR_1218.substr(87, 4));
    } else {
        VAR_1176.replace(110, 4, "1000");
    }
    h_labor_portion = to_string(to_num(0) * to_num(1));
    h_nonlabor_portion = to_string(to_num(0) * to_num(1));
    h_oper_dsh_reduction_factor.replace(368, 9, VAR_1176.substr(41, 9));
...
void p_3400_short_stay() {
    ...
    if (h_oper_dsh_reduction_factor.substr(29, 9) < h_oper_dsh_reduction_factor.substr(20, 9)) {
        if (h_oper_dsh_reduction_factor.substr(29, 9) < VAR_1176.substr(41, 9)) {
            VAR_1176.replace(41, 9, h_oper_dsh_reduction_factor.substr(29, 9));
            VAR_1176 = "20";
            h_oper_dsh_reduction_factor.at(377) = 'Y';
        } else {
        }
    } else {
        if (h_oper_dsh_reduction_factor.substr(20, 9) < VAR_1176.substr(41, 9)) {
            VAR_1176.replace(41, 9, h_oper_dsh_reduction_factor.substr(20, 9));
            VAR_1176 = "21";
    ...
    if (VAR_1218.substr(10, 6) != "332006") {
        if (VAR_1158.substr(29, 8) >= "20121229" && false /* cob_cmp > 0 */ && h_oper_dsh_reduction_factor.substr(280, 9) < VAR_1176.substr(41, 9)) {
            VAR_1176.replace(41, 9, h_oper_dsh_reduction_factor.substr(280, 9));
            VAR_1176 = std::string(2, static_cast<char>(50));
            h_oper_dsh_reduction_factor.at(379) = 'Y';
            h_oper_dsh_reduction_factor.at(377) = 'N';
            h_oper_dsh_reduction_factor.at(378) = 'N';
            h_oper_dsh_reduction_factor.at(380) = 'N';
        } else {
            if (VAR_1158.substr(29, 8) >= "20121229" && false /* cob_cmp <= 0 */ && h_oper_dsh_reduction_factor.substr(262, 9) <= VAR_1176.substr(41, 9)) {
                VAR_1176.replace(41, 9, h_oper_dsh_reduction_factor.substr(262, 9));
                VAR_1176 = "26";
                ...
                if (VAR_1158.substr(29, 8) < "20121229" && h_oper_dsh_reduction_factor.substr(280, 9) < VAR_1176.substr(41, 9)) {
                    VAR_1176.replace(41, 9, h_oper_dsh_reduction_factor.substr(280, 9));
                    VAR_1176 = std::string(2, static_cast<char>(50));
                    h_oper_dsh_reduction_factor.at(379) = 'Y';
                    h_oper_dsh_reduction_factor.at(377) = 'N';
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(VAR_1218) == 2 || to_int(VAR_1218) == 12) {
        h_oper_dsh_reduction_factor.replace(289, 4, VAR_1218.substr(87, 4));
    } else {
...
void p_4000_special_provider() {
    if (VAR_1158.substr(29, 8) >= "20030701" && VAR_1158.substr(29, 8) < "20040101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1158.substr(29, 8) >= "20040101" && VAR_1158.substr(29, 8) < "20050101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1158.substr(29, 8) >= "20050101" && VAR_1158.substr(29, 8) < "20060101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1158.substr(29, 8) >= "20060101" && VAR_1158.substr(29, 8) < "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1158.substr(29, 8) >= "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
}
...
void p_7000_calc_outlier() {
    if (VAR_1176.substr(68, 9) > VAR_1176.substr(86, 9)) {
    }
    if (VAR_1158.at(46) == '1') {
        // MOVE "0" to computed field
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1184, VAR_1176 + 29), 0LL) > 0 */ && to_int(VAR_1176) == 21) {
        VAR_1176 = "24";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1184, VAR_1176 + 29), 0LL) > 0 */ && to_int(VAR_1176) == 22) {
        VAR_1176 = "25";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1184, VAR_1176 + 29), 0LL) > 0 */ && to_int(VAR_1176) == 26) {
        VAR_1176 = "27";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1184, VAR_1176 + 29), 0LL) > 0 */ && to_int(VAR_1176) == 0) {
        VAR_1176 = "01";
    }
    if (to_int(VAR_1176) == 0 || to_int(VAR_1176) == 20 || to_int(VAR_1176) == 21 || to_int(VAR_1176) == 22 || to_int(VAR_1176) == 26) {
        if (false /* cob_cmp > 0 */) {
            VAR_1176.replace(106, 3, std::string(3, '0'));
        } else {
        }
    }
    if (to_int(VAR_1176) == 1 || to_int(VAR_1176) == 24 || to_int(VAR_1176) == 25 || to_int(VAR_1176) == 27 || VAR_1176.at(161) == 'Y') {
        if (VAR_1158.substr(24, 3) < h_oper_dsh_reduction_factor.substr(0, 3) || VAR_1176.at(161) == 'Y' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1275, VAR_1218 + 101), 0LL) != 0 */) {
            if (VAR_1176.substr(162, 2) == "PC") {
                VAR_1176 = "67";
            }
        } else {
        }
...
void p_8000_blend() {
    ...
    if (to_int(VAR_1176) == 20 || to_int(VAR_1176) == 21 || to_int(VAR_1176) == 22 || to_int(VAR_1176) == 26 && to_int(h_oper_dsh_reduction_factor) > 0) {
    } else {
        if (to_int(VAR_1176) == 24 || to_int(VAR_1176) == 25 || to_int(VAR_1176) == 27 && to_int(h_oper_dsh_reduction_factor) > 0) {
        } else {
        }
    }
}
...
void p_9000_move_results() {
    if (to_int(VAR_1176) < 50) {
        VAR_1176.replace(38, 3, h_oper_dsh_reduction_factor.substr(0, 3));
        VAR_1176.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_1176.replace(11, 4, std::string(4, ' '));
        VAR_1176.replace(15, 80, std::string(80, '0'));
        VAR_1176.replace(95, 8, std::string(8, ' '));
