...
std::string VAR_322; // Auto-declared by LAZARUS healer

std::string VAR_389; // Auto-declared by LAZARUS healer
...
FixedString<100> area_wage_index;
FixedString<50> cal_version;
FixedString<100> cbsa_wir_area_wageind;
FixedString<50> current_days;
FixedString<50> days_to_100;
FixedString<50> day_of_stay;
FixedString<10> default_hipps_code;
FixedString<50> dx1;
FixedString<50> hipps_ncm_rate_comp;
FixedString<50> hipps_nta_rate_comp;
FixedString<50> hipps_nurse_rate_comp;
FixedString<50> hipps_ot_rate_comp;
FixedString<50> hipps_per_diem_components;
FixedString<50> hipps_per_diem_sum;
FixedString<50> hipps_pt_rate_comp;
FixedString<50> hipps_slp_rate_comp;
FixedString<10> hld_price_from_date;
FixedString<10> hld_price_thru_date;
FixedString<50> initial_payment_rate;
FixedString<50> init_payment_rate;
FixedString<50> labor_adjusted;
FixedString<50> labor_portion;
FixedString<50> non_labor_adjusted;
FixedString<50> non_labor_portion;
FixedString<8> pdpm_nta_idx_r;
FixedString<8> pdpm_nta_idx_u;
FixedString<8> pdpm_nurs_idx_r;
FixedString<8> pdpm_nurs_idx_u;
FixedString<8> pdpm_ptot_idx_r;
FixedString<8> pdpm_ptot_idx_u;
FixedString<8> pdpm_slp_idx_r;
FixedString<8> pdpm_slp_idx_u;
FixedString<50> percent_2021_labor;
FixedString<50> percent_2021_nlabor;
FixedString<50> prior_days;
FixedString<50> px1;
FixedString<10> replacement_hipps_code;
int RETURN_CODE = 0;
FixedString<10> snf_hipps_code;
FixedString<10> snf_other_diag_code10;
FixedString<10> snf_other_diag_code11;
FixedString<10> snf_other_diag_code12;
FixedString<10> snf_other_diag_code13;
FixedString<10> snf_other_diag_code14;
FixedString<10> snf_other_diag_code15;
FixedString<10> snf_other_diag_code16;
FixedString<10> snf_other_diag_code17;
FixedString<10> snf_other_diag_code18;
FixedString<10> snf_other_diag_code19;
FixedString<10> snf_other_diag_code2;
FixedString<10> snf_other_diag_code20;
FixedString<10> snf_other_diag_code21;
FixedString<10> snf_other_diag_code22;
FixedString<10> snf_other_diag_code23;
FixedString<10> snf_other_diag_code24;
FixedString<10> snf_other_diag_code25;
FixedString<10> snf_other_diag_code3;
FixedString<10> snf_other_diag_code4;
FixedString<10> snf_other_diag_code5;
FixedString<10> snf_other_diag_code6;
FixedString<10> snf_other_diag_code7;
FixedString<10> snf_other_diag_code8;
FixedString<10> snf_other_diag_code9;
FixedString<50> snf_payment_rate;
FixedString<50> snf_pdpm_units;
FixedString<10> snf_prin_diag_code;
FixedString<50> sub2;
FixedString<50> total_calc_payment_rate;
FixedString<50> total_days;
FixedString<50> total_labor_adj_rate;
FixedString<50> tot_pdpm_casemix_perdiem;
FixedString<50> urban_ncm_comp_2021;
FixedString<50> vbp_adj_pymt_rate;
FixedString<50> vbp_multiplier;
FixedString<50> vbp_pay_diff;
FixedString<50> vx1;
FixedString<10> wk_hipps_code;
FixedString<50> ws_nta_portion;
FixedString<50> ws_nta_util;
FixedString<50> ws_nurs_slp_ncm_portion;
FixedString<50> ws_per_diem_subtotals;
FixedString<50> ws_pt_ot_fee;
FixedString<50> ws_pt_ot_portion;
FixedString<50> ws_pt_ot_util;
FixedString<50> ws_total_days;
...
void p_0200_mainline_control();
void p_300_default_hipps_check();
void p_300_exit();
void p_400_validate_snf_input();
void p_400_exit();
void p_450_set_indicators();
void p_450_exit();
void p_500_days_in_stay_logic();
void p_500_exit();
void p_600_capture_rate_components();
void p_600_exit();
void p_700_calc_unadjusted_rate();
void p_700_exit();
void p_1000_apply_vbp_multiplier();
void p_1000_exit();
void p_2000_get_urban_pt_ot_rates();
void p_2000_exit();
void p_2010_pick_urban_pt_ot();
void p_2010_exit();
void p_2200_get_urban_slp_rates();
void p_2200_exit();
void p_2210_pick_urban_slp();
void p_2210_exit();
void p_2300_get_urban_nur_rates();
void p_2300_exit();
void p_2310_pick_urban_nurs();
void p_2310_exit();
void p_2400_get_urban_nta_rates();
void p_2400_exit();
void p_2410_pick_urban_nta();
void p_2410_exit();
void p_2500_get_urban_ncm_rates();
void p_2500_exit();
void p_3000_get_rural_pt_ot_rates();
void p_3000_exit();
void p_3010_pick_rural_pt_ot();
void p_3010_exit();
void p_3200_get_rural_slp_rates();
void p_3200_exit();
void p_3210_pick_rural_slp();
void p_3210_exit();
void p_3300_get_rural_nur_rates();
void p_3300_exit();
void p_3310_pick_rural_nurs();
void p_3310_exit();
void p_3400_get_rural_nta_rates();
void p_3400_exit();
void p_3410_pick_rural_nta();
void p_3410_exit();
void p_3500_get_rural_ncm_rates();
void p_3500_exit();
void p_6000_days_loop_routine();
void p_6000_exit();

void p_0200_mainline_control() {
    p_0200_mainline_control();
    prior_days.replace(5, 10, std::string(10, '0'));
    VAR_389.replace(17, 9, cal_version.substr(0, 9));
    ws_nurs_slp_ncm_portion.replace(5, 5, std::string(5, '0'));
    ws_nurs_slp_ncm_portion.replace(15, 8, std::string(8, '0'));
    ws_nurs_slp_ncm_portion.replace(10, 5, std::string(5, '0'));
    ws_nurs_slp_ncm_portion.replace(23, 8, std::string(8, '0'));
    ws_nurs_slp_ncm_portion.replace(31, 8, std::string(8, '0'));
    days_to_100 = std::string(3, '0');
    total_days = std::string(3, '0');
    tot_pdpm_casemix_perdiem = std::string(8, '0');
    total_calc_payment_rate = std::string(8, '0');
    labor_portion = std::string(8, '0');
    labor_adjusted = std::string(8, '0');
    non_labor_portion = std::string(8, '0');
    non_labor_adjusted = std::string(8, '0');
    total_labor_adj_rate = std::string(8, '0');
    sub2 = "001";
    if (to_int(VAR_322) == 0) {
        p_300_default_hipps_check();
        p_400_validate_snf_input();
    }
}

void p_300_default_hipps_check() {
    // MOVE to computed field
    if (to_int(wk_hipps_code) == to_int(default_hipps_code)) {
        wk_hipps_code = replacement_hipps_code;
    }
    if (false /* TODO: !(((*(prior_days) - 'A') >= 0) && ((*(prior_days) - 'P') <= 0)) */ || false /* TODO: !(((*(prior_days + 1) - 'A') >= 0) && ((*(prior_days + 1) - 'L') <= 0)) */ || false /* TODO: !(((*(prior_days + 2) - 'A') >= 0) && ((*(prior_days + 2) - 'Y') <= 0)) */ || false /* TODO: !(((*(prior_days + 3) - 'A') >= 0) && ((*(prior_days + 3) - 'F') <= 0)) */ || false /* TODO: !(((*(prior_days + 4) - '0') >= 0) && ((*(prior_days + 4) - '1') <= 0)) */) {
        VAR_322.replace(228, 2, "20");
    }
}
...
void p_400_validate_snf_input() {
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_379, VAR_322 + 230), 0LL) == 0 */) {
        VAR_322.replace(228, 2, "70");
    }
    if (to_int(VAR_322) == 0) {
        VAR_322.replace(228, 2, "20");
    }
    hld_price_thru_date = VAR_322.substr(29, 8);
    hld_price_from_date = VAR_322.substr(21, 8);
    if (hld_price_thru_date.substr(4, 4) == "1001" && hld_price_from_date.substr(0, 8) < hld_price_thru_date.substr(0, 8)) {
        hld_price_thru_date.replace(4, 4, "0930");
    }
    if (to_int(VAR_322) != 0) {
    }
    if (hld_price_thru_date.substr(0, 8) > "20190930") {
        // MOVE to computed field
    }
    p_450_set_indicators();
    p_500_days_in_stay_logic();
    p_600_capture_rate_components();
    sub2 = to_string(to_num(0) + to_num(1));
    total_days = to_string(to_num(0) + to_num(1));
    vx1 = sub2;
    while (true) {
        if (false /* TODO: cob_cmpswp_s16 (vx1, cob_get_llint (total_days)) > 0 */) break;
        p_6000_days_loop_routine();
        // ADD operation
    }
    p_700_calc_unadjusted_rate();
    p_1000_apply_vbp_multiplier();
}
...
void p_450_set_indicators() {
    if (false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */ || false /* cob_cmp == 0 */) {
        VAR_389.at(2) = 'Y';
    } else {
        VAR_389.at(2) = 'N';
    }
...
void p_500_days_in_stay_logic() {
    // MOVE to computed field
    prior_days.replace(37, 3, VAR_322.substr(252, 3));
}
...
void p_600_capture_rate_components() {
    if (VAR_389.at(0) == 'U') {
        p_2000_get_urban_pt_ot_rates();
    } else {
        p_3000_get_rural_pt_ot_rates();
    }
    if (VAR_389.at(0) == 'U') {
        p_2200_get_urban_slp_rates();
    } else {
        p_3200_get_rural_slp_rates();
    }
    if (VAR_389.at(0) == 'U') {
        p_2300_get_urban_nur_rates();
    } else {
        p_3300_get_rural_nur_rates();
    }
    if (VAR_389.at(0) == 'U') {
        p_2400_get_urban_nta_rates();
    } else {
        p_3400_get_rural_nta_rates();
    }
    if (VAR_389.at(0) == 'U') {
        p_2500_get_urban_ncm_rates();
    } else {
        p_3500_get_rural_ncm_rates();
    }
}
...
void p_700_calc_unadjusted_rate() {
    ws_pt_ot_fee = to_string(to_num(0) + to_num(1));
    ws_pt_ot_portion = to_string(to_num(0) * to_num(1));
    ws_nta_portion = to_string(to_num(0) * to_num(1));
    ws_nurs_slp_ncm_portion = to_string(to_num(0) * to_num(1));
    tot_pdpm_casemix_perdiem = to_string(to_num(0) + to_num(1));
    labor_portion = to_string(to_num(0) * to_num(1));
    labor_adjusted = to_string(to_num(0) * to_num(1));
    non_labor_portion = to_string(to_num(0) * to_num(1));
    total_labor_adj_rate = to_string(to_num(0) + to_num(1));
    total_calc_payment_rate = to_string(to_num(0) + to_num(1));
}
...
void p_2000_get_urban_pt_ot_rates() {
    pdpm_ptot_idx_u = to_string(1);
    // UNHANDLED: const int max = 16;
    while (true) {
        if (false /* TODO: pdpm_ptot_idx_u > max */) {
            VAR_322.replace(228, 2, "20");
        }
        if (false /* TODO: (*(VAR_108 + 29LL * ((cob_s64_t)(pdpm_ptot_idx_u) - 1)) - *(prior_days)) == 0 */) {
            p_2010_pick_urban_pt_ot();
            break;
        }
        // UNHANDLED: b_127++;
    }
...
void p_2200_get_urban_slp_rates() {
    pdpm_slp_idx_u = to_string(1);
    // UNHANDLED: const int max = 12;
    while (true) {
        if (false /* TODO: pdpm_slp_idx_u > max */) {
            VAR_322.replace(228, 2, "20");
        }
        if (false /* TODO: (*(VAR_138 + 15LL * ((cob_s64_t)(pdpm_slp_idx_u) - 1)) - *(prior_days + 1)) == 0 */) {
            p_2210_pick_urban_slp();
            break;
        }
        // UNHANDLED: b_153++;
    }
...
void p_2300_get_urban_nur_rates() {
    pdpm_nurs_idx_u = to_string(1);
    // UNHANDLED: const int max = 25;
    while (true) {
        if (false /* TODO: pdpm_nurs_idx_u > max */) {
            VAR_322.replace(228, 2, "20");
        }
        if (false /* TODO: (*(VAR_160 + 29LL * ((cob_s64_t)(pdpm_nurs_idx_u) - 1)) - *(prior_days + 2)) == 0 */) {
            p_2310_pick_urban_nurs();
            break;
        }
        // UNHANDLED: b_188++;
    }
...
void p_2310_pick_urban_nurs() {
    ...
    if (VAR_389.at(1) == 'Y' && VAR_389.at(2) == 'Y') {
        // MOVE to computed field
    }
    if (VAR_389.at(1) == 'N') {
        // MOVE to computed field
    }
    if (VAR_389.at(1) == 'N' && VAR_389.at(2) == 'Y') {
        // MOVE to computed field
    }
}
...
void p_2400_get_urban_nta_rates() {
    pdpm_nta_idx_u = to_string(1);
    if (VAR_389.at(2) == 'Y' && false /* TODO: (*(prior_days + 3) - 'A') >= 0 */ && false /* TODO: (*(prior_days + 3) - 'D') <= 0 */) {
        prior_days.at(3) = 'A';
    } else {
        if (VAR_389.at(2) == 'Y' && prior_days.at(3) == 'E') {
            prior_days.at(3) = static_cast<char>(66);
        } else {
            if (VAR_389.at(2) == 'Y' && prior_days.at(3) == 'F') {
                prior_days.at(3) = static_cast<char>(67);
            }
        }
    }
    // UNHANDLED: const int max = 6;
    while (true) {
        if (false /* TODO: pdpm_nta_idx_u > max */) {
            VAR_322.replace(228, 2, "20");
        }
        if (false /* TODO: (*(VAR_199 + 15LL * ((cob_s64_t)(pdpm_nta_idx_u) - 1)) - *(prior_days + 3)) == 0 */) {
            p_2410_pick_urban_nta();
            break;
        }
        // UNHANDLED: b_208++;
    }
...
void p_2500_get_urban_ncm_rates() {
    if (VAR_389.at(1) == 'Y') {
        hipps_ncm_rate_comp.replace(25, 5, urban_ncm_comp_2021.substr(5, 5));
    } else {
        hipps_ncm_rate_comp.replace(25, 5, urban_ncm_comp_2021.substr(0, 5));
    }
}
...
void p_3000_get_rural_pt_ot_rates() {
    pdpm_ptot_idx_r = to_string(1);
    // UNHANDLED: const int max = 16;
    while (true) {
        if (false /* TODO: pdpm_ptot_idx_r > max */) {
            VAR_322.replace(228, 2, "20");
        }
        if (false /* TODO: (*(VAR_215 + 29LL * ((cob_s64_t)(pdpm_ptot_idx_r) - 1)) - *(prior_days)) == 0 */) {
            p_3010_pick_rural_pt_ot();
            break;
        }
        // UNHANDLED: b_234++;
    }
...
void p_3200_get_rural_slp_rates() {
    pdpm_slp_idx_r = to_string(1);
    // UNHANDLED: const int max = 12;
    while (true) {
        if (false /* TODO: pdpm_slp_idx_r > max */) {
            VAR_322.replace(228, 2, "20");
        }
        if (false /* TODO: (*(VAR_245 + 15LL * ((cob_s64_t)(pdpm_slp_idx_r) - 1)) - *(prior_days + 1)) == 0 */) {
            p_3210_pick_rural_slp();
            break;
        }
        // UNHANDLED: b_260++;
    }
...
void p_3300_get_rural_nur_rates() {
    pdpm_nurs_idx_r = to_string(1);
    // UNHANDLED: const int max = 25;
    while (true) {
        if (false /* TODO: pdpm_nurs_idx_r > max */) {
            VAR_322.replace(228, 2, "20");
        }
        if (false /* TODO: (*(VAR_267 + 29LL * ((cob_s64_t)(pdpm_nurs_idx_r) - 1)) - *(prior_days + 2)) == 0 */) {
            p_3310_pick_rural_nurs();
            break;
        }
        // UNHANDLED: b_295++;
    }
...
void p_3400_get_rural_nta_rates() {
    ...
    // UNHANDLED: const int max = 6;
    while (true) {
        if (false /* TODO: pdpm_nta_idx_r > max */) {
            VAR_322.replace(228, 2, "20");
        }
        if (false /* TODO: (*(VAR_306 + 15LL * ((cob_s64_t)(pdpm_nta_idx_r) - 1)) - *(prior_days + 3)) == 0 */) {
            p_3410_pick_rural_nta();
            break;
        }
        // UNHANDLED: b_315++;
    }
...
void p_3500_get_rural_ncm_rates() {
    if (VAR_389.at(1) == 'Y') {
        hipps_ncm_rate_comp.replace(25, 5, urban_ncm_comp_2021.substr(15, 5));
    } else {
        hipps_ncm_rate_comp.replace(25, 5, urban_ncm_comp_2021.substr(10, 5));
    }
}
...
void p_6000_days_loop_routine() {
    ws_pt_ot_util = to_string(to_num(0) + to_num(1));
    ws_nta_util = to_string(to_num(0) + to_num(1));
}
...
//   - Types hardened: 91
//   - Bounds checks added: 38
//   - Names converted: 144
//   - Error handlers: 1
//   - Vulnerabilities fixed: 0
//   - Empty functions flagged: 28
//
// Security Checklist:
