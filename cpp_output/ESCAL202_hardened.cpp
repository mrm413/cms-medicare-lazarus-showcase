...
std::string VAR_372; // Auto-declared by LAZARUS healer

std::string c_13; // Auto-declared by LAZARUS healer

std::string VAR_191; // Auto-declared by LAZARUS healer

std::string VAR_301; // Auto-declared by LAZARUS healer
...
void p_0000_start_to_finish() {
    VAR_301 = std::string(2, '0');
    VAR_301.replace(2, 9, std::string(9, ' '));
    VAR_301.replace(11, 15, std::string(15, '0'));
    VAR_301.replace(26, 11, std::string(11, ' '));
    VAR_301.replace(37, 18, std::string(18, '0'));
    VAR_301.replace(57, 50, std::string(50, '0'));
    VAR_301.replace(108, 6, std::string(6, ' '));
    VAR_301.replace(138, 54, std::string(54, '0'));
    VAR_301.replace(192, 138, std::string(138, '0'));
    VAR_191.at(103) = 'Y';
    if (VAR_191.at(449) == 'T') {
        VAR_191.replace(229, 23, std::string(23, '0'));
        VAR_191.at(253) = ' ';
        VAR_191.replace(255, 2, std::string(2, '0'));
        VAR_191.replace(260, 91, std::string(91, '0'));
        VAR_191.replace(369, 80, std::string(80, '0'));
        VAR_191.at(253) = ' ';
        VAR_191.replace(255, 2, std::string(2, '0'));
    }
    VAR_301.replace(26, 5, cal_version.substr(0, 5));
    VAR_301 = std::string(2, '0');
    p_1000_validate_bill_elements();
    if (to_int(VAR_301) == 0) {
        p_1200_initialization();
        if (VAR_191.substr(0, 2) == "84") {
            h_pps_final_pay_amt = h_bun_base_wage_amt;
            VAR_301 = "02";
            VAR_301.replace(112, 2, "10");
        } else {
...
void p_1000_validate_bill_elements() {
    if (to_int(VAR_301) == 0) {
        if (VAR_191.substr(0, 2) != "73" && VAR_191.substr(0, 2) != "74" && VAR_191.substr(0, 2) != "84" && VAR_191.substr(0, 2) != "87" && VAR_191.substr(0, 2) != "") {
            VAR_301 = "58";
        }
    }
    if (to_int(VAR_301) == 0) {
        if (VAR_191.substr(86, 2) == "40" || VAR_191.substr(86, 2) == "41" || VAR_191.substr(86, 2) == "05") {
        } else {
            VAR_301 = "52";
        }
    }
    if (to_int(VAR_301) == 0) {
        if (VAR_191.at(85) != '1' && VAR_191.at(85) != ' ') {
            VAR_301 = "53";
        }
    }
    if (to_int(VAR_301) == 0) {
        if (false /* TODO: memcmp (VAR_191 + 32, COB_ZEROES_ALPHABETIC, 8) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_205, VAR_191 + 32)) */) {
            VAR_301 = "54";
        }
    }
    if (to_int(VAR_301) == 0) {
        if (VAR_191.substr(0, 2) != "84") {
            if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_199, VAR_191 + 15), 0LL) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_199, VAR_191 + 15)) */) {
                VAR_301 = std::string(2, static_cast<char>(53));
            }
        }
    }
    if (to_int(VAR_301) == 0) {
        if (VAR_191.substr(0, 2) != "84") {
            if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_197, VAR_191 + 6), 0LL) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_197, VAR_191 + 6)) */) {
                VAR_301 = "56";
            }
        }
    }
    if (to_int(VAR_301) == 0) {
        if (VAR_191.substr(2, 4) == "0821" || VAR_191.substr(2, 4) == "0831" || VAR_191.substr(2, 4) == "0841" || VAR_191.substr(2, 4) == "0851" || VAR_191.substr(2, 4) == "0881") {
        } else {
            VAR_301 = "57";
        }
    }
    if (to_int(VAR_301) == 0) {
        if (VAR_191.at(106) != '1' && VAR_191.at(106) != '2' && VAR_191.at(106) != '3' && VAR_191.at(106) != '4' && VAR_191.at(106) != ' ') {
            VAR_301 = "53";
        }
    }
    if (to_int(VAR_301) == 0) {
    ...
    if (to_int(VAR_301) == 0) {
        if (to_int(VAR_191) == 0 || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_231, VAR_191 + 146)) */) {
            VAR_301 = "73";
        }
    }
    if (to_int(VAR_301) == 0) {
        if (false /* TODO: memcmp (VAR_191 + 148, COB_ZEROES_ALPHABETIC, 8) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_232, VAR_191 + 148)) */) {
            VAR_301 = "74";
        }
    }
    if (to_int(VAR_301) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_236, VAR_191 + 156)) */) {
            VAR_301 = "75";
        }
    }
    if (to_int(VAR_301) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_240, VAR_191 + 164)) */) {
            VAR_301 = "76";
        }
    }
    if (to_int(VAR_301) == 0) {
        if (VAR_191.substr(0, 2) != "84") {
            if (false /* TODO: memcmp (VAR_191 + 227, COB_SPACES_ALPHABETIC, 2) == 0 */ || VAR_191.substr(227, 2) == "10" || VAR_191.substr(227, 2) == "20" || VAR_191.substr(227, 2) == "40" || VAR_191.substr(227, 2) == "50" || VAR_191.substr(227, 2) == "60") {
            } else {
                VAR_301 = "81";
            }
        }
...
void p_1200_initialization() {
    ...
    h_final_amt_with_hdpa.replace(251, 55, std::string(55, '0'));
...
void p_2000_calculate_bundled_factors() {
    ...
    if (VAR_191.substr(36, 2) > VAR_191.substr(28, 2)) {
        h_patient_age = to_string(to_num(0) - to_num(1));
    }
    ...
    if (false /* TODO: memcmp (VAR_191 + 227, COB_SPACES_ALPHABETIC, 2) == 0 */) {
    } else {
        h_final_amt_with_hdpa.at(250) = 'Y';
        h_final_amt_with_hdpa.replace(190, 2, VAR_191.substr(213, 2));
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        h_final_amt_with_hdpa.replace(202, 2, VAR_191.substr(227, 2));
        if (VAR_191.substr(227, 2) == "10") {
            VAR_191.replace(213, 2, std::string(2, ' '));
            VAR_191.replace(227, 2, std::string(2, ' '));
        } else {
            if (VAR_191.substr(227, 2) == "20") {
                VAR_191.replace(213, 2, "MA");
                VAR_191.replace(227, 2, std::string(2, ' '));
            } else {
                if (VAR_191.substr(227, 2) == "40") {
                    VAR_191.replace(213, 2, std::string(2, ' '));
                    // UNHANDLED: memcpy (b_191 + 215 * 2, "MC", 2);
                    VAR_191.replace(227, 2, std::string(2, ' '));
                } else {
                    if (VAR_191.substr(227, 2) == "50") {
                        VAR_191.replace(213, 2, std::string(2, ' '));
                        // UNHANDLED: memcpy (b_191 + 215 * 3, "MD", 2);
                        VAR_191.replace(227, 2, std::string(2, ' '));
                    } else {
                        if (VAR_191.substr(227, 2) == "60") {
                            VAR_191.replace(213, 2, std::string(2, ' '));
                            // UNHANDLED: memcpy (b_191 + 215 * 4, "ME", 2);
                            VAR_191.replace(227, 2, std::string(2, ' '));
                        }
                    }
                }
    ...
    if (to_int(h_patient_age) < 13) {
        if (VAR_191.substr(2, 4) == "0821" || VAR_191.substr(2, 4) == "0881") {
    ...
    if (false /* TODO: memcmp (VAR_191 + 156, COB_ZEROES_ALPHABETIC, 8) > 0 */) {
    ...
    if (VAR_191.substr(0, 2) == "73" || VAR_191.substr(0, 2) == "87") {
        if (to_int(h_bun_onset_factor) == to_int(cm_onset_le_120)) {
        ...
        if (VAR_191.substr(0, 2) == "74" && VAR_191.substr(2, 4) == "0841" || VAR_191.substr(2, 4) == "0851") {
            h_per_diem_amt_without_hdpa = to_string(to_num(0) / to_num(1));
            h_per_diem_amt_with_hdpa = to_string(to_num(0) * to_num(1));
        } else {
            h_final_amt_with_hdpa.replace(68, 11, std::string(11, '0'));
            h_final_amt_with_hdpa.replace(266, 11, std::string(11, '0'));
            h_final_amt_with_hdpa.replace(277, 11, std::string(11, '0'));
        }
    }
    if (VAR_191.substr(0, 2) == "74" && VAR_191.substr(2, 4) == "0841" || VAR_191.substr(2, 4) == "0851") {
    ...
    h_final_amt_without_hdpa = to_string(to_num(0) + to_num(1));
    h_final_amt_with_hdpa = to_string(to_num(0) + to_num(1));
    if (VAR_191.substr(184, 2) == "94") {
        h_final_amt_with_hdpa.replace(101, 9, h_final_amt_with_hdpa.substr(297, 9));
    } else {
        h_final_amt_with_hdpa.replace(101, 9, h_final_amt_with_hdpa.substr(288, 9));
    }
...
void p_2100_calc_comorbid_adjust() {
    ...
    while (true) {
        ...
        if (false /* TODO: memcmp (VAR_191 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (h_final_amt_with_hdpa + 212, 4)) - 1), (cob_u8_ptr)"MA", 2) == 0 */) {
            h_final_amt_with_hdpa.replace(185, 4, cm_onset_le_120.substr(92, 4));
            paid_return_code_trackers.at(1) = 'Y';
            VAR_301.replace(112, 2, "20");
        } else {
            if (false /* TODO: memcmp (VAR_191 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (h_final_amt_with_hdpa + 212, 4)) - 1), (cob_u8_ptr)"MC", 2) == 0 */) {
                ...
                if (false /* TODO: memcmp (VAR_191 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (h_final_amt_with_hdpa + 212, 4)) - 1), (cob_u8_ptr)"MD", 2) == 0 */) {
                    if (cm_onset_le_120.substr(100, 4) > h_final_amt_with_hdpa.substr(185, 4)) {
                        ...
                        VAR_301.replace(112, 2, "50");
                    }
                } else {
                    if (false /* TODO: memcmp (VAR_191 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (h_final_amt_with_hdpa + 212, 4)) - 1), (cob_u8_ptr)"ME", 2) == 0 */) {
...
void p_2500_calc_outlier_factors() {
    ...
    VAR_301.replace(277, 11, h_out_rural_multiplier.substr(99, 11));
    if (VAR_191.substr(0, 2) == "74" && VAR_191.substr(2, 4) == "0841" || VAR_191.substr(2, 4) == "0851") {
        h_out_payment = to_string(to_num(0) * to_num(1));
    }
}
...
void p_3100_low_vol_out_pps_payment() {
    ...
    VAR_301.replace(277, 11, h_final_amt_with_hdpa.substr(174, 11));
    if (VAR_191.substr(0, 2) == "74" && VAR_191.substr(2, 4) == "0841" || VAR_191.substr(2, 4) == "0851") {
        h_lv_out_payment = to_string(to_num(0) * to_num(1));
    }
}
                ...
                if (paid_return_code_trackers.at(5) == 'Y') {
                    if (paid_return_code_trackers.at(2) == 'Y') {
                        ...
                        if (paid_return_code_trackers.at(1) == 'Y') {
                            ...
                            VAR_301 = std::string(2, static_cast<char>(51));
                        }
                    }
                } else {
                    if (paid_return_code_trackers.at(2) == 'Y') {
            ...
            if (paid_return_code_trackers.at(4) == 'Y') {
                ...
                if (paid_return_code_trackers.at(5) == 'Y') {
                    if (paid_return_code_trackers.at(2) == 'Y') {
                        ...
                        if (paid_return_code_trackers.at(1) == 'Y') {
                            VAR_301 = std::string(2, static_cast<char>(50));
                        } else {
                            VAR_301 = std::string(2, static_cast<char>(49));
                        }
                    }
                } else {
                    if (paid_return_code_trackers.at(3) == 'Y') {
...
void p_9100_move_results() {
    if (false /* TODO: (*(h_final_amt_with_hdpa + 250) - ' ') == 0 */) {
        ...
        VAR_191.replace(213, 2, h_final_amt_with_hdpa.substr(190, 2));
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        VAR_191.replace(227, 2, h_final_amt_with_hdpa.substr(202, 2));
    }
    VAR_301.replace(2, 4, VAR_191.substr(76, 4));
    VAR_301.replace(6, 5, VAR_191.substr(80, 5));
    VAR_301.replace(11, 6, h_patient_age.substr(12, 6));
    VAR_301.replace(31, 2, VAR_191.substr(0, 2));
    VAR_301.replace(33, 4, VAR_191.substr(2, 4));
    // MOVE to computed field
    VAR_301.replace(43, 6, bun_nat_labor_pct.substr(0, 6));
    VAR_301.replace(49, 6, bun_nat_nonlabor_pct.substr(0, 6));
    VAR_301.replace(57, 6, nat_labor_pct.substr(0, 6));
    VAR_301.replace(63, 6, nat_nonlabor_pct.substr(0, 6));
    VAR_301.replace(69, 4, h_patient_age.substr(21, 4));
    VAR_301.replace(73, 5, h_patient_age.substr(25, 5));
    VAR_301.replace(78, 5, h_patient_age.substr(30, 5));
    VAR_301.replace(83, 5, case_mix_bdgt_neut_factor.substr(0, 5));
    VAR_301.replace(88, 4, h_final_amt_with_hdpa.substr(20, 4));
    VAR_301.replace(92, 5, h_final_amt_with_hdpa.substr(31, 5));
    VAR_301.replace(97, 5, h_final_amt_with_hdpa.substr(43, 5));
    VAR_301.replace(102, 5, transition_bdgt_neut_factor.substr(0, 5));
    VAR_301.replace(108, 2, std::string(2, ' '));
    VAR_301.replace(110, 2, std::string(2, ' '));
    if (VAR_191.substr(0, 2) == "74" && VAR_191.substr(2, 4) == "0841" || VAR_191.substr(2, 4) == "0851") {
        h_out_payment = to_string(to_num(0) / to_num(1));
    }
    if (VAR_191.at(103) == 'N') {
    } else {
        VAR_301.replace(147, 9, std::string(9, '0'));
        VAR_301.replace(165, 9, std::string(9, '0'));
        VAR_301.replace(183, 9, std::string(9, '0'));
    }
    // MOVE to computed field
    VAR_301.replace(156, 9, h_final_amt_with_hdpa.substr(101, 9));
    VAR_301.replace(17, 9, h_final_amt_with_hdpa.substr(101, 9));
    // MOVE to computed field
    VAR_301.replace(294, 11, h_final_amt_with_hdpa.substr(255, 11));
    if (VAR_191.substr(0, 2) != "84") {
        if (VAR_191.at(106) == ' ') {
        } else {
            h_final_amt_without_hdpa = to_string(to_num(0) * to_num(1));
        ...
        if (VAR_191.substr(184, 2) == "94") {
            VAR_301.replace(156, 9, h_final_amt_with_hdpa.substr(297, 9));
            // MOVE to computed field
        } else {
            VAR_301.replace(156, 9, h_final_amt_with_hdpa.substr(288, 9));
            VAR_301.replace(319, 11, std::string(11, '0'));
        }
    }
    if (VAR_191.at(449) == 'T') {
        VAR_191.replace(229, 5, drug_addon.substr(0, 5));
        // MOVE "00" to computed field
        VAR_191.replace(240, 6, h_patient_age.substr(12, 6));
        VAR_191.replace(246, 6, base_payment_rate.substr(0, 6));
        VAR_191.replace(260, 3, h_patient_age.substr(18, 3));
        // MOVE "00" to computed field
        VAR_191.replace(269, 6, VAR_372.substr(13, 6));
        VAR_191.replace(281, 7, h_patient_age.substr(42, 7));
        VAR_191.replace(288, 7, h_patient_age.substr(35, 7));
        VAR_191.replace(295, 3, msa_blend_pct.substr(0, 3));
        VAR_191.replace(298, 3, cbsa_blend_pct.substr(0, 3));
        if (VAR_191.at(103) == 'N') {
            VAR_191.replace(301, 3, com_cbsa_blend_pct.substr(0, 3));
            VAR_191.replace(304, 3, bun_cbsa_blend_pct.substr(0, 3));
        } else {
            VAR_191.replace(301, 3, std::string(3, '0'));
            VAR_191.replace(304, 3, waive_cbsa_blend_pct.substr(0, 3));
        }
        VAR_191.replace(316, 7, h_final_amt_with_hdpa.substr(24, 7));
        VAR_191.replace(323, 7, h_final_amt_with_hdpa.substr(36, 7));
        VAR_191.replace(330, 5, h_final_amt_with_hdpa.substr(48, 5));
        VAR_191.replace(335, 4, h_final_amt_with_hdpa.substr(53, 4));
        VAR_191.replace(347, 4, h_final_amt_with_hdpa.substr(204, 4));
        VAR_191.replace(369, 4, h_out_rural_multiplier.substr(0, 4));
        VAR_191.replace(373, 7, h_out_rural_multiplier.substr(4, 7));
        VAR_301.replace(212, 4, cm_onset_le_120.substr(20, 4));
        VAR_191.replace(380, 5, h_out_rural_multiplier.substr(11, 5));
        VAR_191.replace(385, 7, h_out_rural_multiplier.substr(16, 7));
        VAR_191.replace(392, 5, h_out_rural_multiplier.substr(23, 5));
        VAR_191.replace(397, 5, h_out_rural_multiplier.substr(28, 5));
        VAR_191.replace(402, 4, h_out_rural_multiplier.substr(33, 4));
        // MOVE to computed field
        // MOVE to computed field
        // MOVE to computed field
        VAR_191.replace(406, 4, h_out_rural_multiplier.substr(37, 4));
        VAR_191.replace(410, 5, h_out_rural_multiplier.substr(41, 5));
        // MOVE to computed field
        VAR_191.replace(426, 6, h_out_rural_multiplier.substr(46, 6));
        VAR_191.replace(415, 3, h_out_rural_multiplier.substr(52, 3));
        VAR_191.replace(432, 11, h_out_rural_multiplier.substr(88, 11));
        VAR_301.replace(248, 4, cr_age_lt_18.substr(24, 4));
        VAR_301.replace(252, 4, cr_age_lt_18.substr(28, 4));
        VAR_301.replace(220, 3, a_49_cent_part_d_drug_adj.substr(0, 3));
        VAR_301.replace(223, 4, cm_onset_le_120.substr(76, 4));
        VAR_301.replace(227, 4, cm_onset_le_120.substr(80, 4));
        VAR_301.replace(231, 6, bundled_base_pmt_rate.substr(0, 6));
        // MOVE to computed field
        VAR_301.replace(237, 11, h_final_amt_with_hdpa.substr(57, 11));
        VAR_301.replace(262, 11, h_final_amt_with_hdpa.substr(68, 11));
        VAR_301.replace(273, 4, training_add_on_pmt_amt.substr(0, 4));
        VAR_301.replace(288, 6, h_patient_age.substr(0, 6));
    }
}
