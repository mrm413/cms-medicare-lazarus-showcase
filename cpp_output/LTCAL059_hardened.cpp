...
std::string VAR_313; // Auto-declared by LAZARUS healer

std::string VAR_231; // Auto-declared by LAZARUS healer
...
void p_0100_initial_routine() {
    ...
    VAR_193.replace(130, 7, "3683369");
    h_fixed_loss_amt = "17864";
    VAR_193.replace(137, 4, "0995");
}
...
void p_1000_edit_the_bill_info() {
    ...
    if (to_int(VAR_193) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_285, VAR_231 + 87)) */) {
            VAR_193 = "50";
        }
    }
    if (to_int(VAR_193) == 0) {
    ...
    if (to_int(VAR_193) == 0) {
        if (VAR_175.substr(29, 8) < VAR_231.substr(16, 8) || VAR_175.substr(29, 8) < VAR_313.substr(4, 8)) {
            VAR_193 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_193) == 0) {
        if (VAR_231.substr(40, 8) > "00000000") {
            if (VAR_175.substr(29, 8) >= VAR_231.substr(40, 8)) {
                VAR_193 = "51";
            }
        }
    }
...
void p_2000_assemble_pps_variables() {
    if (false /* cob_cmp >= 0 */) {
        if (VAR_175.substr(29, 8) >= VAR_231.substr(24, 8)) {
            if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_318, VAR_313 + 24)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_318, VAR_313 + 24), 0LL) > 0 */) {
                // MOVE to computed field
            } else {
                VAR_193 = "52";
            }
        } else {
            if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_317, VAR_313 + 18)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_317, VAR_313 + 18), 0LL) > 0 */) {
                // MOVE to computed field
            } else {
                VAR_193 = "52";
            }
        ...
        if (VAR_175.substr(29, 8) >= VAR_231.substr(24, 8)) {
            ...
            if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_316, VAR_313 + 12)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_316, VAR_313 + 12), 0LL) > 0 */) {
                // MOVE to computed field
            } else {
                VAR_193 = "52";
            }
    ...
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_288, VAR_231 + 101)) */) {
        VAR_193 = "65";
    }
    // MOVE to computed field
...
void p_3000_calc_payment() {
    VAR_193.replace(110, 4, VAR_231.substr(87, 4));
