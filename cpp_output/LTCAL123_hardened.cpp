...
std::string VAR_706; // Auto-declared by LAZARUS healer

std::string c_23; // Auto-declared by LAZARUS healer

std::string VAR_700; // Auto-declared by LAZARUS healer

std::string VAR_547; // Auto-declared by LAZARUS healer

std::string VAR_606; // Auto-declared by LAZARUS healer

std::string VAR_599; // Auto-declared by LAZARUS healer

std::string VAR_565; // Auto-declared by LAZARUS healer
...
void p_0100_initial_routine() {
    VAR_565 = std::string(2, '0');
    VAR_565.replace(11, 4, std::string(4, ' '));
    VAR_565.replace(15, 80, std::string(80, '0'));
    VAR_565.replace(95, 8, std::string(8, ' '));
    VAR_565.replace(103, 11, std::string(11, '0'));
    VAR_565.replace(118, 23, std::string(23, '0'));
    VAR_599 = std::string(5, ' ');
    ...
    VAR_599 = VAR_606.substr(139, 5);
    p_1900_apply_ssrfbn();
    if (to_int(VAR_565) != 0) {
    }
    VAR_565.replace(118, 6, "070199");
    VAR_565.replace(124, 6, "029801");
    VAR_565.replace(130, 7, "4022205");
    h_ipps_wage_index.replace(64, 9, "001793100");
    VAR_565.replace(137, 4, "1000");
    h_ipps_wage_index.replace(339, 5, "42142");
    h_ipps_wage_index.replace(344, 5, "20386");
    h_ipps_wage_index.replace(349, 3, "075");
    h_ipps_wage_index.replace(352, 3, "025");
    if (to_int(h_ipps_wage_index) > 1) {
        h_ipps_wage_index.replace(297, 7, "0358430");
        h_ipps_wage_index.replace(304, 7, "0162544");
    } else {
        h_ipps_wage_index.replace(297, 7, "0323004");
        h_ipps_wage_index.replace(304, 7, "0197970");
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_717, VAR_706 + 21), 1LL) > 0 */) {
        h_ipps_wage_index.replace(311, 7, "0155329");
        h_ipps_wage_index.replace(318, 7, "0094798");
    } else {
        h_ipps_wage_index.replace(311, 7, "0155079");
        h_ipps_wage_index.replace(318, 7, "0095048");
    }
}
...
void p_1000_edit_the_bill_info() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_554, VAR_547 + 21)) */ && to_int(VAR_547) > 0) {
        h_ipps_wage_index = VAR_547.substr(21, 3);
    } else {
        VAR_565 = "56";
    }
    if (to_int(VAR_565) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_660, VAR_606 + 87)) */) {
            VAR_565 = "50";
        }
    }
    if (to_int(VAR_565) == 0) {
    ...
    if (to_int(VAR_565) == 0) {
        if (VAR_547.substr(29, 8) < VAR_606.substr(16, 8) || VAR_547.substr(29, 8) < VAR_700.substr(5, 8)) {
            VAR_565 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_565) == 0) {
        if (VAR_606.substr(40, 8) > "00000000") {
            if (VAR_547.substr(29, 8) >= VAR_606.substr(40, 8)) {
                VAR_565 = "51";
            }
        }
    }
    if (to_int(VAR_565) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_562, VAR_547 + 37)) */) {
            VAR_565 = "58";
        }
    }
    if (to_int(VAR_565) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_556, VAR_547 + 27)) */ || to_int(VAR_547) > 60) {
            VAR_565 = "61";
        }
    }
    if (to_int(VAR_565) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_555, VAR_547 + 24)) */ || to_int(VAR_547) == 0 && to_int(h_ipps_wage_index) > 0) {
            VAR_565 = "62";
        }
    }
    if (to_int(VAR_565) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_547 + 27, 2, cob_get_llint (COB_SET_DATA (f_555, VAR_547 + 24)), 0) > 0 */) {
            VAR_565 = "62";
        }
    }
    if (to_int(VAR_565) == 0) {
    ...
    if (to_int(VAR_565) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_696, VAR_606 + 207)) */) {
            h_ipps_wage_index.replace(153, 5, VAR_606.substr(207, 5));
        } else {
            h_ipps_wage_index.replace(153, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_565) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_661, VAR_606 + 91)) */) {
            h_ipps_wage_index.replace(148, 5, VAR_606.substr(91, 5));
        } else {
            h_ipps_wage_index.replace(148, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_565) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_662, VAR_606 + 96)) */) {
            h_ipps_wage_index.replace(158, 5, VAR_606.substr(96, 5));
        } else {
            h_ipps_wage_index.replace(158, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_565) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_665, VAR_606 + 110)) */) {
            h_ipps_wage_index.replace(167, 4, VAR_606.substr(110, 4));
        } else {
            h_ipps_wage_index.replace(167, 4, std::string(4, '0'));
        }
    }
    if (to_int(VAR_565) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_666, VAR_606 + 114)) */) {
            h_ipps_wage_index.replace(171, 4, VAR_606.substr(114, 4));
        } else {
...
void p_1200_days_used() {
    if (to_int(VAR_547) > 0 && to_int(h_ipps_wage_index) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_547 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_565.replace(106, 3, h_ipps_wage_index.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_ipps_wage_index) > 0 && to_int(VAR_547) == 0) {
            if (h_ipps_wage_index.substr(3, 3) > h_ipps_wage_index.substr(0, 3)) {
                VAR_565.replace(103, 3, h_ipps_wage_index.substr(0, 3));
            } else {
                VAR_565.replace(103, 3, h_ipps_wage_index.substr(3, 3));
            }
        } else {
            if (to_int(h_ipps_wage_index) > 0 && to_int(VAR_547) > 0) {
                if (h_ipps_wage_index.substr(3, 3) > h_ipps_wage_index.substr(0, 3)) {
                    VAR_565.replace(103, 3, h_ipps_wage_index.substr(0, 3));
                    VAR_565.replace(106, 3, std::string(3, '0'));
                } else {
...
void p_1700_edit_drg_code() {
    VAR_565.replace(95, 3, VAR_547.substr(18, 3));
    if (to_int(VAR_565) == 0) {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_25 + 11LL * ((cob_s64_t)(wwm_indx) - 1), VAR_565 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_214;
...
void p_1800_edit_ipps_drg_code() {
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_553, VAR_547 + 18)) */) {
        VAR_565 = "54";
    }
    if (false /* TODO: memcmp (VAR_547 + 29, VAR_218 + 14008LL * ((cob_s64_t)(dx5) - 1), 8) >= 0 */ && to_int(VAR_565) == 0) {
        // dx6 = cob_get_numdisp (b_547 + 18, 3);
...
void p_2000_assemble_pps_variables() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_705, VAR_700 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_705, VAR_700 + 25), 0LL) > 0 */) {
        // MOVE to computed field
    } else {
        VAR_565 = "52";
    }
    ...
    if (VAR_606.at(137) == '1') {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_682, VAR_606 + 154)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_682, VAR_606 + 154), 0LL) > 0 */) {
            VAR_565.replace(15, 6, VAR_606.substr(154, 6));
        } else {
            VAR_565 = "52";
        }
    }
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_663, VAR_606 + 101)) */) {
        VAR_565 = "65";
    }
    // MOVE to computed field
    if (to_int(VAR_565) > 0 && to_int(VAR_565) < 6) {
    } else {
        VAR_565 = "72";
    }
    h_blend_fac = "0";
...
void p_3000_calc_payment() {
    if (to_int(VAR_606) == 2 || to_int(VAR_606) == 12) {
        VAR_565.replace(110, 4, VAR_606.substr(87, 4));
    } else {
        VAR_565.replace(110, 4, "1000");
    }
    h_labor_portion = to_string(to_num(0) * to_num(1));
    h_nonlabor_portion = to_string(to_num(0) * to_num(1));
    h_ipps_wage_index.replace(363, 9, VAR_565.substr(41, 9));
...
void p_3400_short_stay() {
    if (VAR_606.substr(10, 6) == "332006") {
        p_4000_special_provider();
    } else {
        h_ipps_wage_index.replace(29, 9, VAR_565.substr(68, 9));
    ...
    if (h_ipps_wage_index.substr(29, 9) < h_ipps_wage_index.substr(20, 9)) {
        if (h_ipps_wage_index.substr(29, 9) < VAR_565.substr(41, 9)) {
            VAR_565.replace(41, 9, h_ipps_wage_index.substr(29, 9));
            VAR_565 = "20";
            h_ipps_wage_index.at(372) = 'Y';
        } else {
        }
    } else {
        if (h_ipps_wage_index.substr(20, 9) < VAR_565.substr(41, 9)) {
            VAR_565.replace(41, 9, h_ipps_wage_index.substr(20, 9));
            VAR_565 = "21";
    ...
    if (VAR_606.substr(10, 6) != "332006") {
        if (h_ipps_wage_index.substr(280, 9) < VAR_565.substr(41, 9)) {
            VAR_565.replace(41, 9, h_ipps_wage_index.substr(280, 9));
            VAR_565 = std::string(2, static_cast<char>(50));
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(VAR_606) == 2 || to_int(VAR_606) == 12) {
        h_ipps_wage_index.replace(289, 4, VAR_606.substr(87, 4));
    } else {
...
void p_4000_special_provider() {
    if (VAR_547.substr(29, 8) >= "20030701" && VAR_547.substr(29, 8) < "20040101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_547.substr(29, 8) >= "20040101" && VAR_547.substr(29, 8) < "20050101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_547.substr(29, 8) >= "20050101" && VAR_547.substr(29, 8) < "20060101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_547.substr(29, 8) >= "20060101" && VAR_547.substr(29, 8) < "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_547.substr(29, 8) >= "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
}
...
void p_7000_calc_outlier() {
    if (VAR_565.substr(68, 9) > VAR_565.substr(86, 9)) {
    }
    if (VAR_547.at(46) == '1') {
        // MOVE "0" to computed field
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_573, VAR_565 + 29), 0LL) > 0 */ && to_int(VAR_565) == 21) {
        VAR_565 = "24";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_573, VAR_565 + 29), 0LL) > 0 */ && to_int(VAR_565) == 22) {
        VAR_565 = "25";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_573, VAR_565 + 29), 0LL) > 0 */ && to_int(VAR_565) == 26) {
        VAR_565 = "27";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_573, VAR_565 + 29), 0LL) > 0 */ && to_int(VAR_565) == 0) {
        VAR_565 = "01";
    }
    if (to_int(VAR_565) == 0 || to_int(VAR_565) == 20 || to_int(VAR_565) == 21 || to_int(VAR_565) == 22 || to_int(VAR_565) == 26) {
        if (false /* cob_cmp > 0 */) {
            VAR_565.replace(106, 3, std::string(3, '0'));
        } else {
        }
    }
    if (to_int(VAR_565) == 1 || to_int(VAR_565) == 24 || to_int(VAR_565) == 25 || to_int(VAR_565) == 27 || VAR_565.at(157) == 'Y') {
        if (VAR_547.substr(24, 3) < h_ipps_wage_index.substr(0, 3) || VAR_565.at(157) == 'Y' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_663, VAR_606 + 101), 0LL) != 0 */) {
            if (VAR_565.substr(158, 2) == "PC") {
                VAR_565 = "67";
            }
        } else {
        }
...
void p_8000_blend() {
    ...
    if (to_int(VAR_565) == 20 || to_int(VAR_565) == 21 || to_int(VAR_565) == 22 || to_int(VAR_565) == 26 && to_int(h_ipps_wage_index) > 0) {
    } else {
        if (to_int(VAR_565) == 24 || to_int(VAR_565) == 25 || to_int(VAR_565) == 27 && to_int(h_ipps_wage_index) > 0) {
        } else {
        }
    }
}
...
void p_9000_move_results() {
    if (to_int(VAR_565) < 50) {
        VAR_565.replace(38, 3, h_ipps_wage_index.substr(0, 3));
        VAR_565.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_565.replace(11, 4, std::string(4, ' '));
        VAR_565.replace(15, 80, std::string(80, '0'));
        VAR_565.replace(95, 8, std::string(8, ' '));
