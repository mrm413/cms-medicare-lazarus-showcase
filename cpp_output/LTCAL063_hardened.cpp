...
std::string VAR_325; // Auto-declared by LAZARUS healer

std::string VAR_232; // Auto-declared by LAZARUS healer

std::string VAR_175; // Auto-declared by LAZARUS healer
...
void p_0100_initial_routine() {
    VAR_193 = std::string(2, '0');
    VAR_193.replace(11, 4, std::string(4, ' '));
    VAR_193.replace(15, 80, std::string(80, '0'));
    VAR_193.replace(95, 8, std::string(8, ' '));
    VAR_193.replace(103, 11, std::string(11, '0'));
    VAR_193.replace(118, 23, std::string(23, '0'));
    h_los_ratio = std::string(85, '0');
    VAR_193.replace(118, 6, "072885");
    VAR_193.replace(124, 6, "027115");
    VAR_193.replace(130, 7, "3808604");
    h_fixed_loss_amt = "10501";
    VAR_193.replace(137, 4, "1000");
}
...
void p_1000_edit_the_bill_info() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_182, VAR_175 + 21)) */ && to_int(VAR_175) > 0) {
        h_los_ratio = VAR_175.substr(21, 3);
    } else {
        VAR_193 = "56";
    }
    if (to_int(VAR_193) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_286, VAR_232 + 87)) */) {
            VAR_193 = "50";
        }
    }
    if (to_int(VAR_193) == 0) {
    ...
    if (to_int(VAR_193) == 0) {
        if (VAR_175.substr(29, 8) < VAR_232.substr(16, 8) || VAR_175.substr(29, 8) < VAR_325.substr(5, 8)) {
            VAR_193 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_193) == 0) {
        if (VAR_232.substr(40, 8) > "00000000") {
            if (VAR_175.substr(29, 8) >= VAR_232.substr(40, 8)) {
                VAR_193 = "51";
            }
        }
    }
    if (to_int(VAR_193) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_190, VAR_175 + 37)) */) {
            VAR_193 = "58";
        }
    }
    if (to_int(VAR_193) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_184, VAR_175 + 27)) */ || to_int(VAR_175) > 60) {
            VAR_193 = "61";
        }
    }
    if (to_int(VAR_193) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_183, VAR_175 + 24)) */ || to_int(VAR_175) == 0 && to_int(h_los_ratio) > 0) {
            VAR_193 = "62";
        }
    }
    if (to_int(VAR_193) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_175 + 27, 2, cob_get_llint (COB_SET_DATA (f_183, VAR_175 + 24)), 0) > 0 */) {
            VAR_193 = "62";
        }
    }
    if (to_int(VAR_193) == 0) {
...
void p_1200_days_used() {
    if (to_int(VAR_175) > 0 && to_int(h_los_ratio) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_175 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_193.replace(106, 3, h_los_ratio.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_los_ratio) > 0 && to_int(VAR_175) == 0) {
            if (h_los_ratio.substr(3, 3) > h_los_ratio.substr(0, 3)) {
                VAR_193.replace(103, 3, h_los_ratio.substr(0, 3));
            } else {
                VAR_193.replace(103, 3, h_los_ratio.substr(3, 3));
            }
        } else {
            if (to_int(h_los_ratio) > 0 && to_int(VAR_175) > 0) {
                if (h_los_ratio.substr(3, 3) > h_los_ratio.substr(0, 3)) {
                    VAR_193.replace(103, 3, h_los_ratio.substr(0, 3));
                    VAR_193.replace(106, 3, std::string(3, '0'));
                } else {
...
void p_1700_edit_drg_code() {
    VAR_193.replace(95, 3, VAR_175.substr(18, 3));
    if (to_int(VAR_193) == 0) {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_25 + 11LL * ((cob_s64_t)(wwm_indx) - 1), VAR_193 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_156;
...
void p_2000_assemble_pps_variables() {
    if (false /* cob_cmp >= 0 */) {
        if (VAR_175.substr(29, 8) >= VAR_232.substr(24, 8)) {
            if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_330, VAR_325 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_330, VAR_325 + 25), 0LL) > 0 */) {
                // MOVE to computed field
            } else {
                VAR_193 = "52";
            }
        } else {
            if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_329, VAR_325 + 19)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_329, VAR_325 + 19), 0LL) > 0 */) {
                // MOVE to computed field
            } else {
                VAR_193 = "52";
            }
        ...
        if (VAR_175.substr(29, 8) >= VAR_232.substr(24, 8)) {
            ...
            if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_328, VAR_325 + 13)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_328, VAR_325 + 13), 0LL) > 0 */) {
                // MOVE to computed field
            } else {
                VAR_193 = "52";
            }
    ...
    if (VAR_232.at(137) == '1') {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_308, VAR_232 + 154)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_308, VAR_232 + 154), 0LL) > 0 */) {
            VAR_193.replace(15, 6, VAR_232.substr(154, 6));
        } else {
            VAR_193 = "52";
        }
    }
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_289, VAR_232 + 101)) */) {
        VAR_193 = "65";
    }
    // MOVE to computed field
    if (to_int(VAR_193) > 0 && to_int(VAR_193) < 6) {
    } else {
        VAR_193 = "72";
    }
    h_blend_fac = "0";
...
void p_3000_calc_payment() {
    VAR_193.replace(110, 4, VAR_232.substr(87, 4));
...
void p_3400_short_stay() {
    ...
    if (h_los_ratio.substr(28, 9) < h_los_ratio.substr(19, 9)) {
        if (h_los_ratio.substr(28, 9) < VAR_193.substr(41, 9)) {
            VAR_193.replace(41, 9, h_los_ratio.substr(28, 9));
            VAR_193 = "02";
        } else {
        }
    } else {
        if (h_los_ratio.substr(19, 9) < VAR_193.substr(41, 9)) {
            VAR_193.replace(41, 9, h_los_ratio.substr(19, 9));
            VAR_193 = "02";
        } else {
        }
    }
...
void p_4000_special_provider() {
    if (VAR_175.substr(29, 8) >= "20030701" && VAR_175.substr(29, 8) < "20040101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_175.substr(29, 8) >= "20040101" && VAR_175.substr(29, 8) < "20050101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_175.substr(29, 8) >= "20050101" && VAR_175.substr(29, 8) < "20060101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_175.substr(29, 8) >= "20060101" && VAR_175.substr(29, 8) < "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_175.substr(29, 8) >= "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
}
...
void p_7000_calc_outlier() {
    if (VAR_193.substr(68, 9) > VAR_193.substr(86, 9)) {
    }
    if (VAR_175.at(46) == '1') {
        // MOVE "0" to computed field
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_201, VAR_193 + 29), 0LL) > 0 */ && to_int(VAR_193) == 2) {
        VAR_193 = "03";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_201, VAR_193 + 29), 0LL) > 0 */ && to_int(VAR_193) == 0) {
        VAR_193 = "01";
    }
    if (to_int(VAR_193) == 0 || to_int(VAR_193) == 2) {
        if (false /* TODO: cob_cmp_numdisp (VAR_193 + 103, 3, cob_get_llint (h_ssot), 0) > 0 */) {
            VAR_193.replace(106, 3, std::string(3, '0'));
        } else {
        }
    }
    if (to_int(VAR_193) == 1 || to_int(VAR_193) == 3) {
        if (VAR_175.substr(24, 3) < h_los_ratio.substr(0, 3) || VAR_193.at(161) == 'Y') {
            VAR_193 = "67";
        } else {
        }
    } else {
...
void p_9000_move_results() {
    if (to_int(VAR_193) < 50) {
        VAR_193.replace(38, 3, h_los_ratio.substr(0, 3));
        VAR_193.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_193.replace(11, 4, std::string(4, ' '));
        VAR_193.replace(15, 80, std::string(80, '0'));
        VAR_193.replace(95, 8, std::string(8, ' '));
