...
std::string VAR_219; // Auto-declared by LAZARUS healer

std::string VAR_48; // Auto-declared by LAZARUS healer

std::string VAR_158; // Auto-declared by LAZARUS healer
...
void p_0100_initial_routine() {
    VAR_158 = std::string(2, '0');
    VAR_158.replace(2, 9, std::string(9, ' '));
    VAR_158.replace(11, 15, std::string(15, '0'));
    VAR_158.replace(26, 11, std::string(11, ' '));
    VAR_158.replace(37, 18, std::string(18, '0'));
    VAR_158.replace(57, 50, std::string(50, '0'));
    VAR_158.replace(108, 6, std::string(6, ' '));
    VAR_158.replace(138, 54, std::string(54, '0'));
    VAR_158.replace(192, 138, std::string(138, '0'));
    VAR_48.replace(229, 23, std::string(23, '0'));
    VAR_48.at(253) = ' ';
    VAR_48.replace(255, 2, std::string(2, '0'));
    VAR_48.replace(260, 91, std::string(91, '0'));
    VAR_48.replace(369, 80, std::string(80, '0'));
    h_drug_addon = std::string(72, '0');
    VAR_158 = std::string(2, '0');
    VAR_158.replace(26, 5, cal_version.substr(0, 5));
    if (VAR_48.substr(86, 2) == "40") {
        VAR_158.replace(57, 6, std::string(6, '0'));
        VAR_158.replace(63, 6, std::string(6, '0'));
        // MOVE to computed field
        VAR_48.replace(263, 6, VAR_219.substr(12, 6));
    } else {
        if (VAR_48.substr(86, 2) == "41") {
            VAR_158.replace(57, 6, std::string(6, '0'));
            VAR_158.replace(63, 6, std::string(6, '0'));
            // MOVE to computed field
            VAR_48.replace(263, 6, VAR_219.substr(18, 6));
        } else {
            VAR_158 = "52";
            VAR_158.replace(11, 6, std::string(6, '0'));
        }
    }
    VAR_158.replace(192, 6, VAR_158.substr(11, 6));
    VAR_158.replace(83, 5, case_mix_bdgt_neut_factor.substr(0, 5));
    h_drug_addon.replace(67, 5, drug_addon.substr(0, 5));
}

void p_1000_edit_the_bill_info() {
    if (to_int(VAR_158) == 0) {
        if (VAR_48.at(85) != '1' && VAR_48.at(85) != ' ') {
            VAR_158 = "53";
        }
    }
    if (to_int(VAR_158) == 0) {
        if (false /* TODO: memcmp (VAR_48 + 32, COB_ZEROES_ALPHABETIC, 8) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_62, VAR_48 + 32)) */) {
            VAR_158 = "54";
        }
    }
    if (to_int(VAR_158) == 0) {
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_56, VAR_48 + 15), 0LL) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_56, VAR_48 + 15)) */) {
            VAR_158 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_158) == 0) {
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_54, VAR_48 + 6), 0LL) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_54, VAR_48 + 6)) */) {
            VAR_158 = "56";
        }
    }
    if (to_int(VAR_158) == 0) {
        if (VAR_48.substr(2, 4) == "0821" || VAR_48.substr(2, 4) == "0831" || VAR_48.substr(2, 4) == "0841" || VAR_48.substr(2, 4) == "0851" || VAR_48.substr(2, 4) == "0880" || VAR_48.substr(2, 4) == "0881") {
        } else {
            VAR_158 = "57";
        }
    }
    if (to_int(VAR_158) == 0) {
        if (VAR_48.substr(0, 2) != "73" && VAR_48.substr(0, 2) != "74" && VAR_48.substr(0, 2) != "") {
            VAR_158 = "58";
        }
    }
    if (to_int(VAR_158) == 0) {
...
void p_3000_calc_payment() {
    ...
    VAR_48.replace(307, 9, h_drug_addon.substr(0, 9));
    VAR_48.replace(252, 8, std::string(8, ' '));
    if (VAR_48.substr(0, 2) == "73" && VAR_48.substr(2, 4) == "0821" || VAR_48.substr(2, 4) == "0831" || VAR_48.substr(2, 4) == "0851") {
        h_pymt_amt = to_string(to_num(0) + to_num(1));
        VAR_48.at(253) = 'A';
        VAR_48.replace(255, 2, hemo_peri_ccpd_amt.substr(0, 2));
    } else {
        if (VAR_48.substr(0, 2) == "73" && VAR_48.substr(2, 4) == "0841") {
            h_pymt_amt = to_string(to_num(0) + to_num(1));
            VAR_48.at(253) = 'A';
            VAR_48.replace(255, 2, capd_amt.substr(0, 2));
        } else {
            if (VAR_48.substr(0, 2) == "74" && VAR_48.substr(2, 4) == "0841" || VAR_48.substr(2, 4) == "0851") {
                h_pymt_amt = to_string(to_num(0) * to_num(1));
                // MOVE to computed field
            } else {
                VAR_48.at(253) = 'A';
    ...
    VAR_158.replace(17, 9, h_drug_addon.substr(0, 9));
    VAR_158.replace(11, 6, std::string(6, '0'));
}

void p_9000_move_results() {
    if (to_int(VAR_158) < 50) {
        VAR_158.replace(31, 2, VAR_48.substr(0, 2));
        VAR_158.replace(33, 4, VAR_48.substr(2, 4));
        VAR_158.replace(2, 4, VAR_48.substr(76, 4));
        VAR_158.replace(6, 5, VAR_48.substr(80, 5));
        VAR_158.replace(69, 4, h_drug_addon.substr(39, 4));
        VAR_158.replace(73, 5, h_drug_addon.substr(43, 5));
        VAR_158.replace(78, 5, h_drug_addon.substr(48, 5));
        if (VAR_48.at(122) == 'T') {
            VAR_48.replace(229, 5, h_drug_addon.substr(67, 5));
            if (VAR_48.substr(86, 2) == "40" || VAR_48.substr(86, 2) == "05") {
                // MOVE to computed field
                VAR_48.replace(263, 6, VAR_219.substr(12, 6));
                // MOVE to computed field
            } else {
            ...
            VAR_48.replace(240, 6, std::string(6, '0'));
            VAR_48.replace(298, 3, cbsa_blend_pct.substr(0, 3));
            VAR_48.replace(295, 3, msa_blend_pct.substr(0, 3));
            VAR_48.replace(246, 6, std::string(6, '0'));
            VAR_48.replace(260, 3, h_drug_addon.substr(36, 3));
            VAR_48.replace(269, 6, std::string(6, '0'));
            VAR_48.replace(275, 6, nat_labor_pct.substr(0, 6));
        }
    } else {
        if (VAR_48.at(122) == 'T') {
            VAR_158.replace(31, 2, std::string(2, ' '));
            VAR_158.replace(33, 4, std::string(4, ' '));
            VAR_158.replace(2, 4, std::string(4, ' '));
            VAR_158.replace(6, 5, std::string(5, ' '));
            VAR_158.replace(69, 4, std::string(4, '0'));
            VAR_158.replace(73, 5, std::string(5, '0'));
            VAR_158.replace(78, 5, std::string(5, '0'));
            VAR_48.replace(229, 5, std::string(5, '0'));
            VAR_48.replace(234, 6, std::string(6, '0'));
            VAR_48.replace(240, 6, std::string(6, '0'));
            VAR_48.replace(298, 3, std::string(3, '0'));
            VAR_48.replace(295, 3, std::string(3, '0'));
            VAR_48.replace(307, 9, std::string(9, '0'));
            VAR_48.replace(246, 6, std::string(6, '0'));
            VAR_48.replace(252, 8, std::string(8, '0'));
            VAR_48.replace(260, 3, std::string(3, '0'));
        }
    }
}
