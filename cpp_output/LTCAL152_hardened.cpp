...
std::string VAR_1349; // Auto-declared by LAZARUS healer

std::string c_23; // Auto-declared by LAZARUS healer

std::string VAR_1343; // Auto-declared by LAZARUS healer

std::string VAR_1189; // Auto-declared by LAZARUS healer

std::string VAR_1249; // Auto-declared by LAZARUS healer

std::string VAR_1242; // Auto-declared by LAZARUS healer

std::string VAR_1207; // Auto-declared by LAZARUS healer
...
void p_0100_initial_routine() {
    VAR_1207 = std::string(2, '0');
    VAR_1207.replace(11, 4, std::string(4, ' '));
    VAR_1207.replace(15, 80, std::string(80, '0'));
    VAR_1207.replace(95, 8, std::string(8, ' '));
    VAR_1207.replace(103, 11, std::string(11, '0'));
    VAR_1207.replace(118, 27, std::string(27, '0'));
    VAR_1242 = std::string(5, ' ');
    ...
    VAR_1242 = VAR_1249.substr(139, 5);
    p_1900_get_ipps_wage_index();
    if (to_int(VAR_1207) != 0) {
    }
    VAR_1207.replace(118, 6, "062306");
    VAR_1207.replace(124, 6, "037694");
    if (VAR_1249.at(138) == '1') {
        VAR_1207.replace(130, 7, "4104371");
    } else {
        VAR_1207.replace(130, 7, "4024051");
    }
    h_oper_dsh_reduction_factor.replace(64, 9, "001497200");
    VAR_1207.replace(137, 4, "1000");
    ...
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1360, VAR_1349 + 21), 1LL) > 0 */) {
...
void p_1000_edit_the_bill_info() {
    ...
    if (to_int(VAR_1207) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1303, VAR_1249 + 87)) */) {
            VAR_1207 = "50";
        }
    }
    if (to_int(VAR_1207) == 0) {
    ...
    if (to_int(VAR_1207) == 0) {
        if (VAR_1189.substr(29, 8) < VAR_1249.substr(16, 8) || VAR_1189.substr(29, 8) < VAR_1343.substr(5, 8)) {
            VAR_1207 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_1207) == 0) {
        if (VAR_1249.substr(40, 8) > "00000000") {
            if (VAR_1189.substr(29, 8) >= VAR_1249.substr(40, 8)) {
                VAR_1207 = "51";
            }
        }
    }
    if (to_int(VAR_1207) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1204, VAR_1189 + 37)) */) {
            VAR_1207 = "58";
        }
    }
    if (to_int(VAR_1207) == 0) {
    ...
    if (to_int(VAR_1207) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1339, VAR_1249 + 207)) */) {
            h_oper_dsh_reduction_factor.replace(153, 5, VAR_1249.substr(207, 5));
        } else {
            h_oper_dsh_reduction_factor.replace(153, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_1207) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1304, VAR_1249 + 91)) */) {
            h_oper_dsh_reduction_factor.replace(148, 5, VAR_1249.substr(91, 5));
        } else {
            h_oper_dsh_reduction_factor.replace(148, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_1207) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1305, VAR_1249 + 96)) */) {
            h_oper_dsh_reduction_factor.replace(158, 5, VAR_1249.substr(96, 5));
        } else {
            h_oper_dsh_reduction_factor.replace(158, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_1207) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1308, VAR_1249 + 110)) */) {
            h_oper_dsh_reduction_factor.replace(167, 4, VAR_1249.substr(110, 4));
        } else {
            h_oper_dsh_reduction_factor.replace(167, 4, std::string(4, '0'));
        }
    }
    if (to_int(VAR_1207) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1309, VAR_1249 + 114)) */) {
            h_oper_dsh_reduction_factor.replace(171, 4, VAR_1249.substr(114, 4));
        } else {
...
void p_1200_days_used() {
    if (to_int(VAR_1189) > 0 && to_int(h_oper_dsh_reduction_factor) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_1189 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_1207.replace(106, 3, h_oper_dsh_reduction_factor.substr(0, 3));
        } else {
        ...
        if (to_int(h_oper_dsh_reduction_factor) > 0 && to_int(VAR_1189) == 0) {
            if (h_oper_dsh_reduction_factor.substr(3, 3) > h_oper_dsh_reduction_factor.substr(0, 3)) {
                VAR_1207.replace(103, 3, h_oper_dsh_reduction_factor.substr(0, 3));
            } else {
                VAR_1207.replace(103, 3, h_oper_dsh_reduction_factor.substr(3, 3));
            }
        } else {
            if (to_int(h_oper_dsh_reduction_factor) > 0 && to_int(VAR_1189) > 0) {
                if (h_oper_dsh_reduction_factor.substr(3, 3) > h_oper_dsh_reduction_factor.substr(0, 3)) {
                    VAR_1207.replace(103, 3, h_oper_dsh_reduction_factor.substr(0, 3));
                    VAR_1207.replace(106, 3, std::string(3, '0'));
                } else {
...
void p_1700_edit_drg_code() {
    VAR_1207.replace(95, 3, VAR_1189.substr(18, 3));
    if (to_int(VAR_1207) == 0) {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_25 + 15LL * ((cob_s64_t)(wwm_indx) - 1), VAR_1207 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_275;
...
void p_1800_edit_ipps_drg_code() {
    ...
    if (VAR_1189.substr(29, 8) >= wk_drgx_eff_date.substr(0, 8)) {
        drg_idx = to_string(1);
...
void p_1900_get_ipps_wage_index() {
    ...
    while (true) {
        ...
        if (false /* TODO: (ret = memcmp (VAR_1055 + 12LL * ((cob_s64_t)(ibw_indx) - 1), VAR_1249 + 10, 6)) == 0 */) {
            // MOVE to computed field
            break;
        }
...
void p_2000_assemble_pps_variables() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1348, VAR_1343 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1348, VAR_1343 + 25), 0LL) > 0 */) {
        // MOVE to computed field
    } else {
        VAR_1207 = "52";
    }
    ...
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1306, VAR_1249 + 101)) */) {
        VAR_1207 = "65";
    }
    // MOVE to computed field
    if (to_int(VAR_1207) > 0 && to_int(VAR_1207) < 6) {
    } else {
        VAR_1207 = "72";
    }
    h_blend_fac = "0";
...
void p_3000_calc_payment() {
    if (to_int(VAR_1249) == 2 || to_int(VAR_1249) == 12) {
        VAR_1207.replace(110, 4, VAR_1249.substr(87, 4));
    } else {
        VAR_1207.replace(110, 4, "1000");
    }
    h_labor_portion = to_string(to_num(0) * to_num(1));
    h_nonlabor_portion = to_string(to_num(0) * to_num(1));
    h_oper_dsh_reduction_factor.replace(368, 9, VAR_1207.substr(41, 9));
...
void p_3400_short_stay() {
    if (VAR_1249.substr(10, 6) == "332006") {
        p_4000_special_provider();
    } else {
        h_oper_dsh_reduction_factor.replace(29, 9, VAR_1207.substr(68, 9));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
        if (false /* TODO: cob_is_numeric (h_ipps_wage_index) */ && to_int(h_ipps_wage_index) > 0) {
            if (VAR_1189.substr(29, 8) >= "20121229") {
                if (false /* cob_cmp > 0 */) {
    ...
    if (h_oper_dsh_reduction_factor.substr(29, 9) < h_oper_dsh_reduction_factor.substr(20, 9)) {
        if (h_oper_dsh_reduction_factor.substr(29, 9) < VAR_1207.substr(41, 9)) {
            VAR_1207.replace(41, 9, h_oper_dsh_reduction_factor.substr(29, 9));
            VAR_1207 = "20";
            h_oper_dsh_reduction_factor.at(377) = 'Y';
        } else {
        }
    } else {
        if (h_oper_dsh_reduction_factor.substr(20, 9) < VAR_1207.substr(41, 9)) {
            VAR_1207.replace(41, 9, h_oper_dsh_reduction_factor.substr(20, 9));
            VAR_1207 = "21";
    ...
    if (VAR_1249.substr(10, 6) != "332006") {
        if (VAR_1189.substr(29, 8) >= "20121229" && false /* cob_cmp > 0 */ && h_oper_dsh_reduction_factor.substr(280, 9) < VAR_1207.substr(41, 9)) {
            VAR_1207.replace(41, 9, h_oper_dsh_reduction_factor.substr(280, 9));
            VAR_1207 = std::string(2, static_cast<char>(50));
            h_oper_dsh_reduction_factor.at(379) = 'Y';
            h_oper_dsh_reduction_factor.at(377) = 'N';
            h_oper_dsh_reduction_factor.at(378) = 'N';
            h_oper_dsh_reduction_factor.at(380) = 'N';
        } else {
            if (VAR_1189.substr(29, 8) >= "20121229" && false /* cob_cmp <= 0 */ && h_oper_dsh_reduction_factor.substr(262, 9) <= VAR_1207.substr(41, 9)) {
                VAR_1207.replace(41, 9, h_oper_dsh_reduction_factor.substr(262, 9));
                VAR_1207 = "26";
                ...
                if (VAR_1189.substr(29, 8) < "20121229" && h_oper_dsh_reduction_factor.substr(280, 9) < VAR_1207.substr(41, 9)) {
                    VAR_1207.replace(41, 9, h_oper_dsh_reduction_factor.substr(280, 9));
                    VAR_1207 = std::string(2, static_cast<char>(50));
                    h_oper_dsh_reduction_factor.at(379) = 'Y';
                    h_oper_dsh_reduction_factor.at(377) = 'N';
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(VAR_1249) == 2 || to_int(VAR_1249) == 12) {
        h_oper_dsh_reduction_factor.replace(289, 4, VAR_1249.substr(87, 4));
    } else {
...
void p_4000_special_provider() {
    if (VAR_1189.substr(29, 8) >= "20030701" && VAR_1189.substr(29, 8) < "20040101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1189.substr(29, 8) >= "20040101" && VAR_1189.substr(29, 8) < "20050101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1189.substr(29, 8) >= "20050101" && VAR_1189.substr(29, 8) < "20060101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1189.substr(29, 8) >= "20060101" && VAR_1189.substr(29, 8) < "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1189.substr(29, 8) >= "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
}
...
void p_7000_calc_outlier() {
    if (VAR_1207.substr(68, 9) > VAR_1207.substr(86, 9)) {
    }
    if (VAR_1189.at(46) == '1') {
        // MOVE "0" to computed field
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1215, VAR_1207 + 29), 0LL) > 0 */ && to_int(VAR_1207) == 21) {
        VAR_1207 = "24";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1215, VAR_1207 + 29), 0LL) > 0 */ && to_int(VAR_1207) == 22) {
        VAR_1207 = "25";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1215, VAR_1207 + 29), 0LL) > 0 */ && to_int(VAR_1207) == 26) {
        VAR_1207 = "27";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1215, VAR_1207 + 29), 0LL) > 0 */ && to_int(VAR_1207) == 0) {
        VAR_1207 = "01";
    }
    if (to_int(VAR_1207) == 0 || to_int(VAR_1207) == 20 || to_int(VAR_1207) == 21 || to_int(VAR_1207) == 22 || to_int(VAR_1207) == 26) {
        if (false /* cob_cmp > 0 */) {
            VAR_1207.replace(106, 3, std::string(3, '0'));
        } else {
        }
    }
    if (to_int(VAR_1207) == 1 || to_int(VAR_1207) == 24 || to_int(VAR_1207) == 25 || to_int(VAR_1207) == 27 || VAR_1207.at(161) == 'Y') {
        if (VAR_1189.substr(24, 3) < h_oper_dsh_reduction_factor.substr(0, 3) || VAR_1207.at(161) == 'Y' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1306, VAR_1249 + 101), 0LL) != 0 */) {
            if (VAR_1207.substr(162, 2) == "PC") {
                VAR_1207 = "67";
            }
        } else {
        }
...
void p_8000_blend() {
    ...
    if (to_int(VAR_1207) == 20 || to_int(VAR_1207) == 21 || to_int(VAR_1207) == 22 || to_int(VAR_1207) == 26 && to_int(h_oper_dsh_reduction_factor) > 0) {
    } else {
        if (to_int(VAR_1207) == 24 || to_int(VAR_1207) == 25 || to_int(VAR_1207) == 27 && to_int(h_oper_dsh_reduction_factor) > 0) {
        } else {
        }
    }
}
...
void p_9000_move_results() {
    if (to_int(VAR_1207) < 50) {
        VAR_1207.replace(38, 3, h_oper_dsh_reduction_factor.substr(0, 3));
        VAR_1207.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_1207.replace(11, 4, std::string(4, ' '));
        VAR_1207.replace(15, 80, std::string(80, '0'));
        VAR_1207.replace(95, 8, std::string(8, ' '));
