...
std::string VAR_804; // Auto-declared by LAZARUS healer

std::string c_23; // Auto-declared by LAZARUS healer

std::string VAR_798; // Auto-declared by LAZARUS healer

std::string VAR_645; // Auto-declared by LAZARUS healer

std::string VAR_704; // Auto-declared by LAZARUS healer

std::string VAR_697; // Auto-declared by LAZARUS healer

std::string VAR_663; // Auto-declared by LAZARUS healer
...
FixedString<50> mes_add_prov;
FixedString<50> mes_chg_prov;
FixedString<50> mes_intro;
FixedString<50> mes_pps_state;
FixedString<50> mes_ssrfbn_rate;
FixedString<50> mes_ssrfbn_state;
FixedString<50> mes_tot_pay;
...
void p_0100_initial_routine() {
    VAR_663 = std::string(2, '0');
    VAR_663.replace(11, 4, std::string(4, ' '));
    VAR_663.replace(15, 80, std::string(80, '0'));
    VAR_663.replace(95, 8, std::string(8, ' '));
    VAR_663.replace(103, 11, std::string(11, '0'));
    VAR_663.replace(118, 23, std::string(23, '0'));
    VAR_697 = std::string(5, ' ');
    ...
    VAR_697 = VAR_704.substr(139, 5);
    p_1900_apply_ssrfbn();
    if (to_int(VAR_663) != 0) {
    }
    VAR_663.replace(118, 6, "075779");
    VAR_663.replace(124, 6, "024221");
    VAR_663.replace(130, 7, "3989665");
    h_ipps_wage_index.replace(64, 9, "001842500");
    VAR_663.replace(137, 4, "1000");
    h_ipps_wage_index.replace(339, 5, "42926");
    h_ipps_wage_index.replace(344, 5, "20356");
    h_ipps_wage_index.replace(349, 3, "075");
    h_ipps_wage_index.replace(352, 3, "025");
    if (to_int(h_ipps_wage_index) > 1) {
        h_ipps_wage_index.replace(297, 7, "0359352");
        h_ipps_wage_index.replace(304, 7, "0162962");
    } else {
        h_ipps_wage_index.replace(297, 7, "0323835");
        h_ipps_wage_index.replace(304, 7, "0198479");
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_815, VAR_804 + 21), 1LL) > 0 */) {
        h_ipps_wage_index.replace(311, 7, "0154272");
        h_ipps_wage_index.replace(318, 7, "0094152");
    } else {
        h_ipps_wage_index.replace(311, 7, "0154023");
        h_ipps_wage_index.replace(318, 7, "0094401");
    }
}
...
void p_1000_edit_the_bill_info() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_652, VAR_645 + 21)) */ && to_int(VAR_645) > 0) {
        h_ipps_wage_index = VAR_645.substr(21, 3);
    } else {
        VAR_663 = "56";
    }
    if (to_int(VAR_663) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_758, VAR_704 + 87)) */) {
            VAR_663 = "50";
        }
    }
    if (to_int(VAR_663) == 0) {
    ...
    if (to_int(VAR_663) == 0) {
        if (VAR_645.substr(29, 8) < VAR_704.substr(16, 8) || VAR_645.substr(29, 8) < VAR_798.substr(5, 8)) {
            VAR_663 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_663) == 0) {
        if (VAR_704.substr(40, 8) > "00000000") {
            if (VAR_645.substr(29, 8) >= VAR_704.substr(40, 8)) {
                VAR_663 = "51";
            }
        }
    }
    if (to_int(VAR_663) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_660, VAR_645 + 37)) */) {
            VAR_663 = "58";
        }
    }
    if (to_int(VAR_663) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_654, VAR_645 + 27)) */ || to_int(VAR_645) > 60) {
            VAR_663 = "61";
        }
    }
    if (to_int(VAR_663) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_653, VAR_645 + 24)) */ || to_int(VAR_645) == 0 && to_int(h_ipps_wage_index) > 0) {
            VAR_663 = "62";
        }
    }
    if (to_int(VAR_663) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_645 + 27, 2, cob_get_llint (COB_SET_DATA (f_653, VAR_645 + 24)), 0) > 0 */) {
            VAR_663 = "62";
        }
    }
    if (to_int(VAR_663) == 0) {
    ...
    if (to_int(VAR_663) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_794, VAR_704 + 207)) */) {
            h_ipps_wage_index.replace(153, 5, VAR_704.substr(207, 5));
        } else {
            h_ipps_wage_index.replace(153, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_663) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_759, VAR_704 + 91)) */) {
            h_ipps_wage_index.replace(148, 5, VAR_704.substr(91, 5));
        } else {
            h_ipps_wage_index.replace(148, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_663) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_760, VAR_704 + 96)) */) {
            h_ipps_wage_index.replace(158, 5, VAR_704.substr(96, 5));
        } else {
            h_ipps_wage_index.replace(158, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_663) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_763, VAR_704 + 110)) */) {
            h_ipps_wage_index.replace(167, 4, VAR_704.substr(110, 4));
        } else {
            h_ipps_wage_index.replace(167, 4, std::string(4, '0'));
        }
    }
    if (to_int(VAR_663) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_764, VAR_704 + 114)) */) {
            h_ipps_wage_index.replace(171, 4, VAR_704.substr(114, 4));
        } else {
...
void p_1200_days_used() {
    if (to_int(VAR_645) > 0 && to_int(h_ipps_wage_index) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_645 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_663.replace(106, 3, h_ipps_wage_index.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_ipps_wage_index) > 0 && to_int(VAR_645) == 0) {
            if (h_ipps_wage_index.substr(3, 3) > h_ipps_wage_index.substr(0, 3)) {
                VAR_663.replace(103, 3, h_ipps_wage_index.substr(0, 3));
            } else {
                VAR_663.replace(103, 3, h_ipps_wage_index.substr(3, 3));
            }
        } else {
            if (to_int(h_ipps_wage_index) > 0 && to_int(VAR_645) > 0) {
                if (h_ipps_wage_index.substr(3, 3) > h_ipps_wage_index.substr(0, 3)) {
                    VAR_663.replace(103, 3, h_ipps_wage_index.substr(0, 3));
                    VAR_663.replace(106, 3, std::string(3, '0'));
                } else {
...
void p_1700_edit_drg_code() {
    VAR_663.replace(95, 3, VAR_645.substr(18, 3));
    if (to_int(VAR_663) == 0) {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_25 + 11LL * ((cob_s64_t)(wwm_indx) - 1), VAR_663 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_212;
...
void p_1800_edit_ipps_drg_code() {
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_651, VAR_645 + 18)) */) {
        VAR_663 = "54";
    }
    if (false /* TODO: memcmp (VAR_645 + 29, VAR_216 + 14008LL * ((cob_s64_t)(dx5) - 1), 8) >= 0 */ && to_int(VAR_663) == 0) {
        // dx6 = cob_get_numdisp (b_645 + 18, 3);
...
void p_1900_apply_ssrfbn() {
    // MOVE to computed field
    mes_pps_state = VAR_704.substr(10, 2);
    p_1950_find_ssrfbn();
    if (to_int(VAR_663) == 0) {
        if (VAR_704.at(137) == '1' || VAR_704.at(137) == '2') {
            h_ipps_wage_index = to_string(to_num(0) + to_num(1));
        } else {
            h_ipps_wage_index = to_string(to_num(0) * to_num(1));
        }
    }
...
void p_1950_find_ssrfbn() {
    ssrfbn_idx = to_string(1);
    // UNHANDLED: const int max = 72;
    while (true) {
        if (false /* TODO: ssrfbn_idx > max */) {
            VAR_663 = "68";
        }
        if (false /* cob_cmp == 0 */) {
            break;
...
void p_2000_assemble_pps_variables() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_803, VAR_798 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_803, VAR_798 + 25), 0LL) > 0 */) {
        // MOVE to computed field
    } else {
        VAR_663 = "52";
    }
    ...
    if (VAR_704.at(137) == '1') {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_780, VAR_704 + 154)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_780, VAR_704 + 154), 0LL) > 0 */) {
            VAR_663.replace(15, 6, VAR_704.substr(154, 6));
        } else {
            VAR_663 = "52";
        }
    }
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_761, VAR_704 + 101)) */) {
        VAR_663 = "65";
    }
    // MOVE to computed field
    if (to_int(VAR_663) > 0 && to_int(VAR_663) < 6) {
    } else {
        VAR_663 = "72";
    }
    h_blend_fac = "0";
...
void p_3000_calc_payment() {
    if (to_int(VAR_704) == 2 || to_int(VAR_704) == 12) {
        VAR_663.replace(110, 4, VAR_704.substr(87, 4));
    } else {
        VAR_663.replace(110, 4, "1000");
    }
    h_labor_portion = to_string(to_num(0) * to_num(1));
    h_nonlabor_portion = to_string(to_num(0) * to_num(1));
    h_ipps_wage_index.replace(363, 9, VAR_663.substr(41, 9));
...
void p_3400_short_stay() {
    if (VAR_704.substr(10, 6) == "332006") {
        p_4000_special_provider();
    } else {
        h_ipps_wage_index.replace(29, 9, VAR_663.substr(68, 9));
    ...
    if (h_ipps_wage_index.substr(29, 9) < h_ipps_wage_index.substr(20, 9)) {
        if (h_ipps_wage_index.substr(29, 9) < VAR_663.substr(41, 9)) {
            VAR_663.replace(41, 9, h_ipps_wage_index.substr(29, 9));
            VAR_663 = "20";
            h_ipps_wage_index.at(372) = 'Y';
        } else {
        }
    } else {
        if (h_ipps_wage_index.substr(20, 9) < VAR_663.substr(41, 9)) {
            VAR_663.replace(41, 9, h_ipps_wage_index.substr(20, 9));
            VAR_663 = "21";
    ...
    if (VAR_704.substr(10, 6) != "332006") {
        if (h_ipps_wage_index.substr(280, 9) < VAR_663.substr(41, 9)) {
            VAR_663.replace(41, 9, h_ipps_wage_index.substr(280, 9));
            VAR_663 = std::string(2, static_cast<char>(50));
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(VAR_704) == 2 || to_int(VAR_704) == 12) {
        h_ipps_wage_index.replace(289, 4, VAR_704.substr(87, 4));
    } else {
...
void p_4000_special_provider() {
    if (VAR_645.substr(29, 8) >= "20030701" && VAR_645.substr(29, 8) < "20040101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_645.substr(29, 8) >= "20040101" && VAR_645.substr(29, 8) < "20050101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_645.substr(29, 8) >= "20050101" && VAR_645.substr(29, 8) < "20060101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_645.substr(29, 8) >= "20060101" && VAR_645.substr(29, 8) < "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_645.substr(29, 8) >= "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
}
...
void p_7000_calc_outlier() {
    if (VAR_663.substr(68, 9) > VAR_663.substr(86, 9)) {
    }
    if (VAR_645.at(46) == '1') {
        // MOVE "0" to computed field
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_671, VAR_663 + 29), 0LL) > 0 */ && to_int(VAR_663) == 21) {
        VAR_663 = "24";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_671, VAR_663 + 29), 0LL) > 0 */ && to_int(VAR_663) == 22) {
        VAR_663 = "25";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_671, VAR_663 + 29), 0LL) > 0 */ && to_int(VAR_663) == 26) {
        VAR_663 = "27";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_671, VAR_663 + 29), 0LL) > 0 */ && to_int(VAR_663) == 0) {
        VAR_663 = "01";
    }
    if (to_int(VAR_663) == 0 || to_int(VAR_663) == 20 || to_int(VAR_663) == 21 || to_int(VAR_663) == 22 || to_int(VAR_663) == 26) {
        if (false /* cob_cmp > 0 */) {
            VAR_663.replace(106, 3, std::string(3, '0'));
        } else {
        }
    }
    if (to_int(VAR_663) == 1 || to_int(VAR_663) == 24 || to_int(VAR_663) == 25 || to_int(VAR_663) == 27 || VAR_663.at(157) == 'Y') {
        if (VAR_645.substr(24, 3) < h_ipps_wage_index.substr(0, 3) || VAR_663.at(157) == 'Y' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_761, VAR_704 + 101), 0LL) != 0 */) {
            if (VAR_663.substr(158, 2) == "PC") {
                VAR_663 = "67";
            }
        } else {
        }
...
void p_8000_blend() {
    ...
    if (to_int(VAR_663) == 20 || to_int(VAR_663) == 21 || to_int(VAR_663) == 22 || to_int(VAR_663) == 26 && to_int(h_ipps_wage_index) > 0) {
    } else {
        if (to_int(VAR_663) == 24 || to_int(VAR_663) == 25 || to_int(VAR_663) == 27 && to_int(h_ipps_wage_index) > 0) {
        } else {
        }
    }
}
...
void p_9000_move_results() {
    if (to_int(VAR_663) < 50) {
        VAR_663.replace(38, 3, h_ipps_wage_index.substr(0, 3));
        VAR_663.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_663.replace(11, 4, std::string(4, ' '));
        VAR_663.replace(15, 80, std::string(80, '0'));
        VAR_663.replace(95, 8, std::string(8, ' '));
