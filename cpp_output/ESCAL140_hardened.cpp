...
std::string VAR_365; // Auto-declared by LAZARUS healer

std::string c_14; // Auto-declared by LAZARUS healer

std::string VAR_184; // Auto-declared by LAZARUS healer

std::string VAR_294; // Auto-declared by LAZARUS healer
...
FixedString<50> case_mix_fctr_adj_rate;
...
FixedString<50> cr_bmi_lt_18_5;
FixedString<50> cr_bsa;
...
FixedString<50> pps_2011_full_pps_rate;
...
void p_5000_calc_comp_rate_factors();
void p_9000_set_return_code();
void p_9100_move_results();

void p_0000_start_to_finish() {
    VAR_294 = std::string(2, '0');
    VAR_294.replace(2, 9, std::string(9, ' '));
    VAR_294.replace(11, 15, std::string(15, '0'));
    VAR_294.replace(26, 11, std::string(11, ' '));
    VAR_294.replace(37, 18, std::string(18, '0'));
    VAR_294.replace(57, 50, std::string(50, '0'));
    VAR_294.replace(108, 6, std::string(6, ' '));
    VAR_294.replace(138, 54, std::string(54, '0'));
    VAR_294.replace(192, 138, std::string(138, '0'));
    VAR_184.at(103) = 'Y';
    if (VAR_184.at(449) == 'T') {
        VAR_184.replace(229, 23, std::string(23, '0'));
        VAR_184.at(253) = ' ';
        VAR_184.replace(255, 2, std::string(2, '0'));
        VAR_184.replace(260, 91, std::string(91, '0'));
        VAR_184.replace(369, 80, std::string(80, '0'));
        VAR_184.at(253) = ' ';
        VAR_184.replace(255, 2, std::string(2, '0'));
    }
    VAR_294.replace(26, 5, cal_version.substr(0, 5));
    VAR_294 = std::string(2, '0');
    p_1000_validate_bill_elements();
    if (to_int(VAR_294) == 0) {
        p_1200_initialization();
        h_patient_age = to_string(to_num(0) - to_num(1));
        if (VAR_184.substr(36, 2) > VAR_184.substr(28, 2)) {
            h_patient_age = to_string(to_num(0) - to_num(1));
        }
        if (to_int(h_bmi) < 18) {
...
void p_1000_validate_bill_elements() {
    if (VAR_184.substr(86, 2) == "40" || VAR_184.substr(86, 2) == "41" || VAR_184.substr(86, 2) == "05") {
    } else {
        VAR_294 = "52";
    }
    if (to_int(VAR_294) == 0) {
        if (VAR_184.at(85) != '1' && VAR_184.at(85) != ' ') {
            VAR_294 = "53";
        }
    }
    if (to_int(VAR_294) == 0) {
        if (false /* TODO: memcmp (VAR_184 + 32, COB_ZEROES_ALPHABETIC, 8) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_198, VAR_184 + 32)) */) {
            VAR_294 = "54";
        }
    }
    if (to_int(VAR_294) == 0) {
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_192, VAR_184 + 15), 0LL) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_192, VAR_184 + 15)) */) {
            VAR_294 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_294) == 0) {
        if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_190, VAR_184 + 6), 0LL) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_190, VAR_184 + 6)) */) {
            VAR_294 = "56";
        }
    }
    if (to_int(VAR_294) == 0) {
        if (VAR_184.substr(2, 4) == "0821" || VAR_184.substr(2, 4) == "0831" || VAR_184.substr(2, 4) == "0841" || VAR_184.substr(2, 4) == "0851" || VAR_184.substr(2, 4) == "0881") {
        } else {
            VAR_294 = "57";
        }
    }
    if (to_int(VAR_294) == 0) {
        if (VAR_184.substr(0, 2) != "73" && VAR_184.substr(0, 2) != "74" && VAR_184.substr(0, 2) != "") {
            VAR_294 = "58";
        }
    }
    if (to_int(VAR_294) == 0) {
        if (VAR_184.at(106) != '1' && VAR_184.at(106) != '2' && VAR_184.at(106) != '3' && VAR_184.at(106) != '4' && VAR_184.at(106) != ' ') {
            VAR_294 = "53";
        }
    }
    if (to_int(VAR_294) == 0) {
    ...
    if (to_int(VAR_294) == 0) {
        if (to_int(VAR_184) == 0 || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_224, VAR_184 + 146)) */) {
            VAR_294 = "73";
        }
    }
    if (to_int(VAR_294) == 0) {
        if (false /* TODO: memcmp (VAR_184 + 148, COB_ZEROES_ALPHABETIC, 8) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_225, VAR_184 + 148)) */) {
            VAR_294 = "74";
        }
    }
    if (to_int(VAR_294) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_229, VAR_184 + 156)) */) {
            VAR_294 = "75";
        }
    }
    if (to_int(VAR_294) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_233, VAR_184 + 164)) */) {
            VAR_294 = "76";
        }
    }
    if (to_int(VAR_294) == 0) {
        if (false /* TODO: memcmp (VAR_184 + 227, COB_SPACES_ALPHABETIC, 2) == 0 */ || VAR_184.substr(227, 2) == "10" || VAR_184.substr(227, 2) == "20" || VAR_184.substr(227, 2) == "30" || VAR_184.substr(227, 2) == "40" || VAR_184.substr(227, 2) == "50" || VAR_184.substr(227, 2) == "60" || VAR_184.substr(227, 2) == "70") {
        } else {
            VAR_294 = "81";
        }
    }
...
void p_1200_initialization() {
    h_bmi = std::string(97, '0');
    onset_date = std::string(189, '0');
    onset_date.replace(189, 15, std::string(15, ' '));
    onset_date.replace(204, 46, std::string(46, '0'));
    onset_date.at(250) = ' ';
    h_out_payment = std::string(121, '0');
    paid_return_code_trackers = std::string(8, ' ');
    onset_date.at(250) = ' ';
    if (VAR_184.at(106) == ' ') {
        onset_date.replace(208, 4, "1000");
    } else {
        if (VAR_184.at(106) == '1') {
            onset_date.replace(208, 4, "0995");
        } else {
            if (VAR_184.at(106) == '2') {
                onset_date.replace(208, 4, "0990");
            } else {
                if (VAR_184.at(106) == '3') {
                    onset_date.replace(208, 4, "0985");
                } else {
                    onset_date.replace(208, 4, "0980");
                }
            }
        }
    }
    if (false /* TODO: memcmp (VAR_184 + 227, COB_SPACES_ALPHABETIC, 2) == 0 */) {
    } else {
        onset_date.at(250) = 'Y';
        onset_date.replace(190, 2, VAR_184.substr(213, 2));
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        onset_date.replace(202, 2, VAR_184.substr(227, 2));
        if (VAR_184.substr(227, 2) == "10") {
            VAR_184.replace(213, 2, std::string(2, ' '));
            VAR_184.replace(227, 2, std::string(2, ' '));
        } else {
            if (VAR_184.substr(227, 2) == "20") {
                VAR_184.replace(213, 2, "MA");
                VAR_184.replace(227, 2, std::string(2, ' '));
            } else {
                if (VAR_184.substr(227, 2) == "30") {
                    VAR_184.replace(213, 2, std::string(2, ' '));
                    // UNHANDLED: memcpy (b_184 + 215 * 1, "MB", 2);
                    VAR_184.replace(227, 2, std::string(2, ' '));
                } else {
                    if (VAR_184.substr(227, 2) == "40") {
                        VAR_184.replace(213, 2, std::string(2, ' '));
                        // UNHANDLED: memcpy (b_184 + 215 * 2, "MC", 2);
                        VAR_184.replace(227, 2, std::string(2, ' '));
                    } else {
                        if (VAR_184.substr(227, 2) == "50") {
                            VAR_184.replace(213, 2, std::string(2, ' '));
                            // UNHANDLED: memcpy (b_184 + 215 * 3, "MD", 2);
                            VAR_184.replace(227, 2, std::string(2, ' '));
                        } else {
                            if (VAR_184.substr(227, 2) == "60") {
                                VAR_184.replace(213, 2, std::string(2, ' '));
                                // UNHANDLED: memcpy (b_184 + 215 * 4, "ME", 2);
                                VAR_184.replace(227, 2, std::string(2, ' '));
                            } else {
                                VAR_184.replace(213, 2, std::string(2, ' '));
                                VAR_184.replace(227, 2, std::string(2, ' '));
                                // UNHANDLED: memcpy (b_184 + 215 * 5, "MF", 2);
                            }
                        }
                    }
                }
...
void p_2000_calculate_bundled_factors() {
    if (to_int(h_bmi) < 13) {
        if (VAR_184.substr(2, 4) == "0821" || VAR_184.substr(2, 4) == "0881") {
            onset_date.replace(20, 4, sb_age_lt_13_pd_mode.substr(20, 4));
        } else {
            onset_date.replace(20, 4, sb_age_lt_13_pd_mode.substr(16, 4));
        }
    } else {
        if (to_int(h_bmi) < 18) {
            if (VAR_184.substr(2, 4) == "0821" || VAR_184.substr(2, 4) == "0881") {
                onset_date.replace(20, 4, sb_age_lt_13_pd_mode.substr(28, 4));
            } else {
                onset_date.replace(20, 4, sb_age_lt_13_pd_mode.substr(24, 4));
            }
        } else {
            if (to_int(h_bmi) < 45) {
                onset_date.replace(20, 4, cm_onset_le_120.substr(60, 4));
            } else {
                if (to_int(h_bmi) < 60) {
                    onset_date.replace(20, 4, cm_onset_le_120.substr(64, 4));
                } else {
                    if (to_int(h_bmi) < 70) {
                        onset_date.replace(20, 4, cm_onset_le_120.substr(68, 4));
                    } else {
                        if (to_int(h_bmi) < 80) {
                            onset_date.replace(20, 4, cm_onset_le_120.substr(72, 4));
                        } else {
                            onset_date.replace(20, 4, cm_onset_le_120.substr(76, 4));
                        }
                    }
                }
            }
    ...
    if (to_int(h_bmi) > 17 && to_int(h_bun_bmi) < to_int(c_14)) {
        h_bun_bmi_factor = cm_bmi_lt_18_5;
        paid_return_code_trackers.at(7) = 'Y';
    } else {
        h_bun_bmi_factor = "1000";
    }
    if (false /* TODO: memcmp (VAR_184 + 156, COB_ZEROES_ALPHABETIC, 8) > 0 */) {
    ...
    if (false /* TODO: memcmp (VAR_184 + 227, COB_SPACES_ALPHABETIC, 2) == 0 */) {
        if (to_int(h_bmi) < 18) {
            onset_date.replace(53, 4, "1000");
            VAR_294.replace(112, 2, "10");
        } else {
            if (to_int(h_bun_onset_factor) == to_int(cm_onset_le_120)) {
                ...
                onset_date.replace(53, 4, onset_date.substr(185, 4));
            }
        }
    } else {
        if (VAR_184.substr(227, 2) == "10") {
            ...
            if (VAR_184.substr(227, 2) == "20") {
                onset_date.replace(53, 4, cm_onset_le_120.substr(100, 4));
                VAR_294.replace(112, 2, "20");
            } else {
                if (VAR_184.substr(227, 2) == "30") {
                    onset_date.replace(53, 4, cm_onset_le_120.substr(96, 4));
                    VAR_294.replace(112, 2, "30");
                } else {
                    if (VAR_184.substr(227, 2) == "40") {
                        onset_date.replace(53, 4, cm_onset_le_120.substr(92, 4));
                        VAR_294.replace(112, 2, "40");
                    }
                }
            }
        }
    ...
    if (VAR_184.at(104) == 'Y') {
        if (to_int(h_bmi) > 17) {
            onset_date.replace(204, 4, cm_onset_le_120.substr(116, 4));
            paid_return_code_trackers.at(4) = 'Y';
        } else {
            onset_date.replace(204, 4, "1000");
        }
    } else {
        onset_date.replace(204, 4, "1000");
    }
    h_bun_adjusted_base_wage_amt = to_string(to_num(0) * to_num(1));
    if (VAR_184.substr(0, 2) == "73") {
        if (to_int(h_bun_onset_factor) == to_int(cm_onset_le_120)) {
            onset_date.replace(68, 11, std::string(11, '0'));
        } else {
            h_bun_wage_adj_training_amt = to_string(to_num(0) * to_num(1));
            paid_return_code_trackers.at(5) = 'Y';
        }
    } else {
        if (VAR_184.substr(0, 2) == "74" && VAR_184.substr(2, 4) == "0841" || VAR_184.substr(2, 4) == "0851") {
            h_cc_74_per_diem_amt = to_string(to_num(0) / to_num(1));
        } else {
            onset_date.replace(68, 11, std::string(11, '0'));
            onset_date.replace(79, 11, std::string(11, '0'));
        }
    }
    if (VAR_184.substr(0, 2) == "74" && VAR_184.substr(2, 4) == "0841" || VAR_184.substr(2, 4) == "0851") {
        h_pps_final_pay_amt = to_string(to_num(0) + to_num(1));
...
void p_2100_calc_comorbid_adjust() {
    onset_date.at(189) = 'N';
    onset_date.replace(185, 4, "1000");
    VAR_294.replace(112, 2, "10");
    onset_date.replace(212, 4, "0001");
    while (true) {
        if (to_int(onset_date) > 6 || onset_date.at(189) == 'Y') break;
        if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (onset_date + 212, 4)) - 1), (cob_u8_ptr)"MA", 2) == 0 */) {
            onset_date.replace(185, 4, cm_onset_le_120.substr(100, 4));
            onset_date.at(189) = 'Y';
            paid_return_code_trackers.at(1) = 'Y';
            VAR_294.replace(112, 2, "20");
        } else {
            if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (onset_date + 212, 4)) - 1), (cob_u8_ptr)"MB", 2) == 0 */) {
                if (cm_onset_le_120.substr(96, 4) > onset_date.substr(185, 4)) {
                    onset_date.replace(185, 4, cm_onset_le_120.substr(96, 4));
                    paid_return_code_trackers.at(1) = 'Y';
                    VAR_294.replace(112, 2, "30");
                }
            } else {
                if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (onset_date + 212, 4)) - 1), (cob_u8_ptr)"MC", 2) == 0 */) {
                    if (cm_onset_le_120.substr(92, 4) > onset_date.substr(185, 4)) {
                        onset_date.replace(185, 4, cm_onset_le_120.substr(92, 4));
                        paid_return_code_trackers.at(1) = 'Y';
                        VAR_294.replace(112, 2, "40");
                    }
                } else {
                    if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (onset_date + 212, 4)) - 1), (cob_u8_ptr)"MD", 2) == 0 */) {
                        if (cm_onset_le_120.substr(108, 4) > onset_date.substr(185, 4)) {
                            onset_date.replace(185, 4, cm_onset_le_120.substr(108, 4));
                            paid_return_code_trackers.at(2) = 'Y';
                            VAR_294.replace(112, 2, "50");
                        }
                    } else {
                        if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (onset_date + 212, 4)) - 1), (cob_u8_ptr)"ME", 2) == 0 */) {
                            if (cm_onset_le_120.substr(104, 4) > onset_date.substr(185, 4)) {
                                onset_date.replace(185, 4, cm_onset_le_120.substr(104, 4));
                                paid_return_code_trackers.at(2) = 'Y';
                                VAR_294.replace(112, 2, "60");
                            }
                        } else {
                            if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (onset_date + 212, 4)) - 1), (cob_u8_ptr)"MF", 2) == 0 */) {
                                if (cm_onset_le_120.substr(112, 4) > onset_date.substr(185, 4)) {
                                    onset_date.replace(185, 4, cm_onset_le_120.substr(112, 4));
                                    paid_return_code_trackers.at(2) = 'Y';
                                    VAR_294.replace(112, 2, "70");
                                }
                            }
                        }
                    }
...
void p_2500_calc_outlier_factors() {
    if (to_int(h_bmi) < 13) {
        if (VAR_184.substr(2, 4) == "0821" || VAR_184.substr(2, 4) == "0881") {
            h_out_payment = sb_age_lt_13_pd_mode.substr(4, 4);
        } else {
            h_out_payment = sb_age_lt_13_pd_mode.substr(0, 4);
        }
    } else {
        if (to_int(h_bmi) < 18) {
            if (VAR_184.substr(2, 4) == "0821" || VAR_184.substr(2, 4) == "0881") {
                h_out_payment = sb_age_lt_13_pd_mode.substr(12, 4);
            } else {
                h_out_payment = sb_age_lt_13_pd_mode.substr(8, 4);
            }
        } else {
            if (to_int(h_bmi) < 45) {
                h_out_payment = cm_onset_le_120.substr(0, 4);
            } else {
                if (to_int(h_bmi) < 60) {
                    h_out_payment = cm_onset_le_120.substr(4, 4);
                } else {
                    if (to_int(h_bmi) < 70) {
                        h_out_payment = cm_onset_le_120.substr(8, 4);
                    } else {
                        if (to_int(h_bmi) < 80) {
                            h_out_payment = cm_onset_le_120.substr(12, 4);
                        } else {
                            h_out_payment = cm_onset_le_120.substr(16, 4);
                        }
                    }
                }
            }
    ...
    if (to_int(h_bmi) > 17 && to_int(h_out_bmi) < to_int(c_14)) {
    ...
    if (false /* TODO: memcmp (VAR_184 + 227, COB_SPACES_ALPHABETIC, 2) == 0 */) {
        if (to_int(h_bmi) < 18) {
            h_out_payment.replace(33, 4, "1000");
            VAR_294.replace(112, 2, "10");
        } else {
            if (to_int(h_bun_onset_factor) == to_int(cm_onset_le_120)) {
                h_out_payment.replace(33, 4, "1000");
        ...
        if (VAR_184.substr(227, 2) == "10") {
            ...
            if (VAR_184.substr(227, 2) == "20") {
                h_out_payment.replace(33, 4, cm_onset_le_120.substr(40, 4));
            } else {
                if (VAR_184.substr(227, 2) == "30") {
                    h_out_payment.replace(33, 4, cm_onset_le_120.substr(36, 4));
                } else {
                    if (VAR_184.substr(227, 2) == "40") {
                        h_out_payment.replace(33, 4, cm_onset_le_120.substr(32, 4));
                    }
                }
            }
        }
    ...
    if (VAR_184.at(104) == 'N') {
        ...
        if (to_int(h_bmi) < 18) {
            ...
            h_out_payment.replace(37, 4, cm_onset_le_120.substr(56, 4));
            paid_return_code_trackers.at(4) = 'Y';
        }
    }
    ...
    if (to_int(h_bmi) < 18) {
        ...
        h_out_payment.replace(46, 6, loss_sharing_pct_gt_17.substr(12, 6));
        if (h_out_payment.substr(66, 11) > h_out_payment.substr(88, 11)) {
            h_out_payment = to_string(to_num(0) * to_num(1));
            h_out_loss_sharing_pct = loss_sharing_pct_lt_18;
            paid_return_code_trackers.at(0) = 'Y';
        } else {
            h_out_payment.replace(99, 11, std::string(11, '0'));
            h_out_payment.replace(52, 3, std::string(3, '0'));
        }
    } else {
        h_out_predicted_map = to_string(to_num(0) + to_num(1));
        h_out_payment.replace(46, 6, loss_sharing_pct_gt_17.substr(18, 6));
        if (h_out_payment.substr(66, 11) > h_out_payment.substr(88, 11)) {
            h_out_payment = to_string(to_num(0) * to_num(1));
    ...
    VAR_294.replace(277, 11, h_out_payment.substr(99, 11));
    if (VAR_184.substr(0, 2) == "74" && VAR_184.substr(2, 4) == "0841" || VAR_184.substr(2, 4) == "0851") {
        h_out_payment = to_string(to_num(0) * to_num(1));
    }
}
...
void p_2600_calc_comorbid_out_adjust() {
    ...
    while (true) {
        ...
        if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (onset_date + 212, 4)) - 1), (cob_u8_ptr)"MA", 2) == 0 */) {
            ...
            if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (onset_date + 212, 4)) - 1), (cob_u8_ptr)"MB", 2) == 0 */) {
                if (cm_onset_le_120.substr(36, 4) > h_out_payment.substr(33, 4)) {
                    h_out_payment.replace(33, 4, cm_onset_le_120.substr(36, 4));
                    paid_return_code_trackers.at(1) = 'Y';
                }
            } else {
                if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (onset_date + 212, 4)) - 1), (cob_u8_ptr)"MC", 2) == 0 */) {
                    if (cm_onset_le_120.substr(32, 4) > h_out_payment.substr(33, 4)) {
                        h_out_payment.replace(33, 4, cm_onset_le_120.substr(32, 4));
                        paid_return_code_trackers.at(1) = 'Y';
                    }
                } else {
                    if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (onset_date + 212, 4)) - 1), (cob_u8_ptr)"MD", 2) == 0 */) {
                        if (cm_onset_le_120.substr(48, 4) > h_out_payment.substr(33, 4)) {
                            h_out_payment.replace(33, 4, cm_onset_le_120.substr(48, 4));
                            paid_return_code_trackers.at(2) = 'Y';
                        }
                    } else {
                        if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (onset_date + 212, 4)) - 1), (cob_u8_ptr)"ME", 2) == 0 */) {
                            if (cm_onset_le_120.substr(44, 4) > h_out_payment.substr(33, 4)) {
                                h_out_payment.replace(33, 4, cm_onset_le_120.substr(44, 4));
                                paid_return_code_trackers.at(2) = 'Y';
                            }
                        } else {
                            if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (onset_date + 212, 4)) - 1), (cob_u8_ptr)"MF", 2) == 0 */) {
                                if (cm_onset_le_120.substr(52, 4) > h_out_payment.substr(33, 4)) {
                                    h_out_payment.replace(33, 4, cm_onset_le_120.substr(52, 4));
                                    paid_return_code_trackers.at(2) = 'Y';
                                }
                            }
                        }
...
void p_3100_low_vol_out_pps_payment() {
    ...
    if (to_int(h_bmi) < 18) {
        ...
        h_out_payment.replace(46, 6, loss_sharing_pct_gt_17.substr(12, 6));
        if (h_out_payment.substr(66, 11) > onset_date.substr(163, 11)) {
            h_lv_out_payment = to_string(to_num(0) * to_num(1));
            h_out_loss_sharing_pct = loss_sharing_pct_lt_18;
        } else {
            onset_date.replace(174, 11, std::string(11, '0'));
            h_out_payment.replace(52, 3, std::string(3, '0'));
        }
    } else {
        h_lv_out_predicted_map = to_string(to_num(0) + to_num(1));
    ...
    VAR_294.replace(277, 11, onset_date.substr(174, 11));
    if (VAR_184.substr(0, 2) == "74" && VAR_184.substr(2, 4) == "0841" || VAR_184.substr(2, 4) == "0851") {
        h_lv_out_payment = to_string(to_num(0) * to_num(1));
    }
}
...
void p_5000_calc_comp_rate_factors() {
    if (to_int(h_bmi) < 18) {
        h_bmi.replace(21, 4, cr_bmi_lt_18_5.substr(0, 4));
    } else {
        if (to_int(h_bmi) < 45) {
            h_bmi.replace(21, 4, cr_bmi_lt_18_5.substr(4, 4));
        } else {
            if (to_int(h_bmi) < 60) {
                h_bmi.replace(21, 4, cr_bmi_lt_18_5.substr(8, 4));
            } else {
                if (to_int(h_bmi) < 70) {
                    h_bmi.replace(21, 4, cr_bmi_lt_18_5.substr(12, 4));
                } else {
                    if (to_int(h_bmi) < 80) {
                        h_bmi.replace(21, 4, cr_bmi_lt_18_5.substr(16, 4));
                    } else {
                        h_bmi.replace(21, 4, cr_bmi_lt_18_5.substr(20, 4));
                    }
                }
            }
        }
    ...
    if (to_int(h_bmi) > 17 && to_int(h_bmi) < to_int(c_14)) {
        h_bmi_factor = cr_bmi_lt_18_5;
    } else {
        h_bmi_factor = "1000";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_212, VAR_184 + 94), 0LL) == 0 */) {
        h_bmi = base_payment_rate.substr(0, 6);
    } else {
        // MOVE to computed field
    }
    ...
    // MOVE to computed field
    VAR_184.replace(252, 8, std::string(8, ' '));
    if (VAR_184.substr(0, 2) == "73" && VAR_184.substr(2, 4) == "0821" || VAR_184.substr(2, 4) == "0831" || VAR_184.substr(2, 4) == "0851") {
        h_pymt_amt = to_string(to_num(0) + to_num(1));
        VAR_184.at(253) = 'A';
        VAR_184.replace(255, 2, hemo_peri_ccpd_amt.substr(0, 2));
    } else {
        if (VAR_184.substr(0, 2) == "73" && VAR_184.substr(2, 4) == "0841") {
            h_pymt_amt = to_string(to_num(0) + to_num(1));
            VAR_184.at(253) = 'A';
            VAR_184.replace(255, 2, capd_amt.substr(0, 2));
        } else {
            if (VAR_184.substr(0, 2) == "74" && VAR_184.substr(2, 4) == "0841" || VAR_184.substr(2, 4) == "0851") {
                h_pymt_amt = to_string(to_num(0) * to_num(1));
                // MOVE to computed field
                ...
                if (paid_return_code_trackers.at(5) == 'Y') {
                    if (paid_return_code_trackers.at(2) == 'Y') {
                        ...
                        if (paid_return_code_trackers.at(1) == 'Y') {
                            ...
                            VAR_294 = std::string(2, static_cast<char>(51));
                        }
                    }
                } else {
                    if (paid_return_code_trackers.at(2) == 'Y') {
            ...
            if (paid_return_code_trackers.at(4) == 'Y') {
                ...
                if (paid_return_code_trackers.at(5) == 'Y') {
                    if (paid_return_code_trackers.at(2) == 'Y') {
                        ...
                        if (paid_return_code_trackers.at(1) == 'Y') {
                            VAR_294 = std::string(2, static_cast<char>(50));
                        } else {
                            VAR_294 = std::string(2, static_cast<char>(49));
                        }
                    }
                } else {
                    if (paid_return_code_trackers.at(3) == 'Y') {
...
void p_9100_move_results() {
    if (false /* TODO: (*(onset_date + 250) - ' ') == 0 */) {
    } else {
        VAR_184.replace(213, 2, onset_date.substr(190, 2));
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        VAR_184.replace(227, 2, onset_date.substr(202, 2));
    }
    VAR_294.replace(2, 4, VAR_184.substr(76, 4));
    VAR_294.replace(6, 5, VAR_184.substr(80, 5));
    VAR_294.replace(11, 6, h_bmi.substr(12, 6));
    VAR_294.replace(31, 2, VAR_184.substr(0, 2));
    VAR_294.replace(33, 4, VAR_184.substr(2, 4));
    // MOVE to computed field
    VAR_294.replace(43, 6, bun_nat_labor_pct.substr(0, 6));
    VAR_294.replace(49, 6, bun_nat_nonlabor_pct.substr(0, 6));
    VAR_294.replace(57, 6, nat_labor_pct.substr(0, 6));
    VAR_294.replace(63, 6, nat_nonlabor_pct.substr(0, 6));
    VAR_294.replace(69, 4, h_bmi.substr(21, 4));
    VAR_294.replace(73, 5, h_bmi.substr(25, 5));
    VAR_294.replace(78, 5, h_bmi.substr(30, 5));
    VAR_294.replace(83, 5, case_mix_bdgt_neut_factor.substr(0, 5));
    VAR_294.replace(88, 4, onset_date.substr(20, 4));
    VAR_294.replace(92, 5, onset_date.substr(31, 5));
    VAR_294.replace(97, 5, onset_date.substr(43, 5));
    VAR_294.replace(102, 5, transition_bdgt_neut_factor.substr(0, 5));
    VAR_294.replace(108, 2, std::string(2, ' '));
    VAR_294.replace(110, 2, std::string(2, ' '));
    if (VAR_184.substr(0, 2) == "74" && VAR_184.substr(2, 4) == "0841" || VAR_184.substr(2, 4) == "0851") {
        h_out_payment = to_string(to_num(0) / to_num(1));
    }
    if (VAR_184.at(103) == 'N') {
    } else {
        VAR_294.replace(147, 9, std::string(9, '0'));
        VAR_294.replace(165, 9, std::string(9, '0'));
        VAR_294.replace(183, 9, std::string(9, '0'));
    }
    // MOVE to computed field
    VAR_294.replace(156, 9, onset_date.substr(101, 9));
    VAR_294.replace(17, 9, onset_date.substr(101, 9));
    // MOVE to computed field
    if (VAR_184.at(106) == ' ') {
    } else {
    }
    if (VAR_184.at(449) == 'T') {
        VAR_184.replace(229, 5, drug_addon.substr(0, 5));
        // MOVE "00" to computed field
        VAR_184.replace(240, 6, h_bmi.substr(12, 6));
        VAR_184.replace(246, 6, base_payment_rate.substr(0, 6));
        VAR_184.replace(260, 3, h_bmi.substr(18, 3));
        // MOVE "00" to computed field
        VAR_184.replace(269, 6, VAR_365.substr(13, 6));
        VAR_184.replace(281, 7, h_bmi.substr(42, 7));
        VAR_184.replace(288, 7, h_bmi.substr(35, 7));
        VAR_184.replace(295, 3, msa_blend_pct.substr(0, 3));
        VAR_184.replace(298, 3, cbsa_blend_pct.substr(0, 3));
        if (VAR_184.at(103) == 'N') {
            VAR_184.replace(301, 3, com_cbsa_blend_pct.substr(0, 3));
            VAR_184.replace(304, 3, bun_cbsa_blend_pct.substr(0, 3));
        } else {
            VAR_184.replace(301, 3, std::string(3, '0'));
            VAR_184.replace(304, 3, waive_cbsa_blend_pct.substr(0, 3));
        }
        VAR_184.replace(316, 7, onset_date.substr(24, 7));
        VAR_184.replace(323, 7, onset_date.substr(36, 7));
        VAR_184.replace(330, 5, onset_date.substr(48, 5));
        VAR_184.replace(335, 4, onset_date.substr(53, 4));
        VAR_184.replace(347, 4, onset_date.substr(204, 4));
        VAR_184.replace(369, 4, h_out_payment.substr(0, 4));
        VAR_184.replace(373, 7, h_out_payment.substr(4, 7));
        VAR_294.replace(212, 4, cm_onset_le_120.substr(20, 4));
        VAR_184.replace(380, 5, h_out_payment.substr(11, 5));
        VAR_184.replace(385, 7, h_out_payment.substr(16, 7));
        VAR_184.replace(392, 5, h_out_payment.substr(23, 5));
        VAR_184.replace(397, 5, h_out_payment.substr(28, 5));
        VAR_184.replace(402, 4, h_out_payment.substr(33, 4));
        // MOVE to computed field
        // MOVE to computed field
        // MOVE to computed field
        VAR_184.replace(406, 4, h_out_payment.substr(37, 4));
        VAR_184.replace(410, 5, h_out_payment.substr(41, 5));
        // MOVE to computed field
        VAR_184.replace(426, 6, h_out_payment.substr(46, 6));
        VAR_184.replace(415, 3, h_out_payment.substr(52, 3));
        VAR_184.replace(432, 11, h_out_payment.substr(88, 11));
        VAR_294.replace(248, 4, cr_bmi_lt_18_5.substr(24, 4));
        VAR_294.replace(252, 4, cr_bmi_lt_18_5.substr(28, 4));
        VAR_294.replace(220, 3, a_49_cent_part_d_drug_adj.substr(0, 3));
        VAR_294.replace(223, 4, cm_onset_le_120.substr(80, 4));
        VAR_294.replace(227, 4, cm_onset_le_120.substr(84, 4));
        VAR_294.replace(231, 6, bundled_base_pmt_rate.substr(0, 6));
        // MOVE to computed field
        VAR_294.replace(237, 11, onset_date.substr(57, 11));
        VAR_294.replace(262, 11, onset_date.substr(68, 11));
        VAR_294.replace(273, 4, training_add_on_pmt_amt.substr(0, 4));
        VAR_294.replace(288, 6, h_bmi.substr(0, 6));
    }
}
