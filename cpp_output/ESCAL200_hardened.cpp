...
std::string VAR_367; // Auto-declared by LAZARUS healer

std::string c_13; // Auto-declared by LAZARUS healer

std::string VAR_186; // Auto-declared by LAZARUS healer

std::string VAR_296; // Auto-declared by LAZARUS healer
...
void p_0000_start_to_finish() {
    VAR_296 = std::string(2, '0');
    VAR_296.replace(2, 9, std::string(9, ' '));
    VAR_296.replace(11, 15, std::string(15, '0'));
    VAR_296.replace(26, 11, std::string(11, ' '));
    VAR_296.replace(37, 18, std::string(18, '0'));
    VAR_296.replace(57, 50, std::string(50, '0'));
    VAR_296.replace(108, 6, std::string(6, ' '));
    VAR_296.replace(138, 54, std::string(54, '0'));
    VAR_296.replace(192, 138, std::string(138, '0'));
    VAR_186.at(103) = 'Y';
    if (VAR_186.at(449) == 'T') {
        VAR_186.replace(229, 23, std::string(23, '0'));
        VAR_186.at(253) = ' ';
        VAR_186.replace(255, 2, std::string(2, '0'));
        VAR_186.replace(260, 91, std::string(91, '0'));
        VAR_186.replace(369, 80, std::string(80, '0'));
        VAR_186.at(253) = ' ';
        VAR_186.replace(255, 2, std::string(2, '0'));
    }
    VAR_296.replace(26, 5, cal_version.substr(0, 5));
    VAR_296 = std::string(2, '0');
    p_1000_validate_bill_elements();
    if (to_int(VAR_296) == 0) {
        p_1200_initialization();
        if (VAR_186.substr(0, 2) == "84") {
            h_pps_final_pay_amt = h_bun_base_wage_amt;
            VAR_296 = "02";
            VAR_296.replace(112, 2, "10");
        } else {
...
void p_1000_validate_bill_elements() {
    if (to_int(VAR_296) == 0) {
        if (VAR_186.substr(0, 2) != "73" && VAR_186.substr(0, 2) != "74" && VAR_186.substr(0, 2) != "84" && VAR_186.substr(0, 2) != "87" && VAR_186.substr(0, 2) != "") {
            VAR_296 = "58";
        }
    }
    if (to_int(VAR_296) == 0) {
        if (VAR_186.substr(86, 2) == "40" || VAR_186.substr(86, 2) == "41" || VAR_186.substr(86, 2) == "05") {
        } else {
            VAR_296 = "52";
        }
    }
    if (to_int(VAR_296) == 0) {
        if (VAR_186.at(85) != '1' && VAR_186.at(85) != ' ') {
            VAR_296 = "53";
        }
    }
    if (to_int(VAR_296) == 0) {
        if (false /* TODO: memcmp (VAR_186 + 32, COB_ZEROES_ALPHABETIC, 8) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_200, VAR_186 + 32)) */) {
            VAR_296 = "54";
        }
    }
    if (to_int(VAR_296) == 0) {
        if (VAR_186.substr(0, 2) != "84") {
            if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_194, VAR_186 + 15), 0LL) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_194, VAR_186 + 15)) */) {
                VAR_296 = std::string(2, static_cast<char>(53));
            }
        }
    }
    if (to_int(VAR_296) == 0) {
        if (VAR_186.substr(0, 2) != "84") {
            if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_192, VAR_186 + 6), 0LL) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_192, VAR_186 + 6)) */) {
                VAR_296 = "56";
            }
        }
    }
    if (to_int(VAR_296) == 0) {
        if (VAR_186.substr(2, 4) == "0821" || VAR_186.substr(2, 4) == "0831" || VAR_186.substr(2, 4) == "0841" || VAR_186.substr(2, 4) == "0851" || VAR_186.substr(2, 4) == "0881") {
        } else {
            VAR_296 = "57";
        }
    }
    if (to_int(VAR_296) == 0) {
        if (VAR_186.at(106) != '1' && VAR_186.at(106) != '2' && VAR_186.at(106) != '3' && VAR_186.at(106) != '4' && VAR_186.at(106) != ' ') {
            VAR_296 = "53";
        }
    }
    if (to_int(VAR_296) == 0) {
    ...
    if (to_int(VAR_296) == 0) {
        if (to_int(VAR_186) == 0 || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_226, VAR_186 + 146)) */) {
            VAR_296 = "73";
        }
    }
    if (to_int(VAR_296) == 0) {
        if (false /* TODO: memcmp (VAR_186 + 148, COB_ZEROES_ALPHABETIC, 8) == 0 */ || false /* TODO: !cob_is_numeric (COB_SET_DATA (f_227, VAR_186 + 148)) */) {
            VAR_296 = "74";
        }
    }
    if (to_int(VAR_296) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_231, VAR_186 + 156)) */) {
            VAR_296 = "75";
        }
    }
    if (to_int(VAR_296) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_235, VAR_186 + 164)) */) {
            VAR_296 = "76";
        }
    }
    if (to_int(VAR_296) == 0) {
        if (VAR_186.substr(0, 2) != "84") {
            if (false /* TODO: memcmp (VAR_186 + 227, COB_SPACES_ALPHABETIC, 2) == 0 */ || VAR_186.substr(227, 2) == "10" || VAR_186.substr(227, 2) == "20" || VAR_186.substr(227, 2) == "40" || VAR_186.substr(227, 2) == "50" || VAR_186.substr(227, 2) == "60") {
            } else {
                VAR_296 = "81";
            }
        }
...
void p_1200_initialization() {
    ...
    h_tdapa_payment = std::string(189, '0');
    h_tdapa_payment.replace(189, 15, std::string(15, ' '));
    h_tdapa_payment.replace(204, 46, std::string(46, '0'));
    h_tdapa_payment.at(250) = ' ';
    h_tdapa_payment.replace(251, 15, std::string(15, '0'));
...
void p_2000_calculate_bundled_factors() {
    ...
    if (VAR_186.substr(36, 2) > VAR_186.substr(28, 2)) {
        h_patient_age = to_string(to_num(0) - to_num(1));
    }
    ...
    h_tdapa_payment.at(250) = ' ';
    if (VAR_186.at(106) == ' ') {
        h_tdapa_payment.replace(208, 4, "1000");
    } else {
        if (VAR_186.at(106) == '1') {
            h_tdapa_payment.replace(208, 4, "0995");
        } else {
            if (VAR_186.at(106) == '2') {
                h_tdapa_payment.replace(208, 4, "0990");
            } else {
                if (VAR_186.at(106) == '3') {
                    h_tdapa_payment.replace(208, 4, "0985");
                } else {
                    h_tdapa_payment.replace(208, 4, "0980");
                }
            }
        }
    }
    if (false /* TODO: memcmp (VAR_186 + 227, COB_SPACES_ALPHABETIC, 2) == 0 */) {
    } else {
        h_tdapa_payment.at(250) = 'Y';
        h_tdapa_payment.replace(190, 2, VAR_186.substr(213, 2));
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        h_tdapa_payment.replace(202, 2, VAR_186.substr(227, 2));
        if (VAR_186.substr(227, 2) == "10") {
            VAR_186.replace(213, 2, std::string(2, ' '));
            VAR_186.replace(227, 2, std::string(2, ' '));
        } else {
            if (VAR_186.substr(227, 2) == "20") {
                VAR_186.replace(213, 2, "MA");
                VAR_186.replace(227, 2, std::string(2, ' '));
            } else {
                if (VAR_186.substr(227, 2) == "40") {
                    VAR_186.replace(213, 2, std::string(2, ' '));
                    // UNHANDLED: memcpy (b_186 + 215 * 2, "MC", 2);
                    VAR_186.replace(227, 2, std::string(2, ' '));
                } else {
                    if (VAR_186.substr(227, 2) == "50") {
                        VAR_186.replace(213, 2, std::string(2, ' '));
                        // UNHANDLED: memcpy (b_186 + 215 * 3, "MD", 2);
                        VAR_186.replace(227, 2, std::string(2, ' '));
                    } else {
                        if (VAR_186.substr(227, 2) == "60") {
                            VAR_186.replace(213, 2, std::string(2, ' '));
                            // UNHANDLED: memcpy (b_186 + 215 * 4, "ME", 2);
                            VAR_186.replace(227, 2, std::string(2, ' '));
                        }
                    }
                }
    ...
    if (to_int(h_patient_age) < 13) {
        if (VAR_186.substr(2, 4) == "0821" || VAR_186.substr(2, 4) == "0881") {
            h_tdapa_payment.replace(20, 4, sb_age_lt_13_pd_mode.substr(20, 4));
        } else {
            h_tdapa_payment.replace(20, 4, sb_age_lt_13_pd_mode.substr(16, 4));
        }
    } else {
        if (to_int(h_patient_age) < 18) {
            if (VAR_186.substr(2, 4) == "0821" || VAR_186.substr(2, 4) == "0881") {
                h_tdapa_payment.replace(20, 4, sb_age_lt_13_pd_mode.substr(28, 4));
            } else {
                h_tdapa_payment.replace(20, 4, sb_age_lt_13_pd_mode.substr(24, 4));
            }
        } else {
            if (to_int(h_patient_age) < 45) {
                h_tdapa_payment.replace(20, 4, cm_onset_le_120.substr(56, 4));
            } else {
                if (to_int(h_patient_age) < 60) {
                    h_tdapa_payment.replace(20, 4, cm_onset_le_120.substr(60, 4));
                } else {
                    if (to_int(h_patient_age) < 70) {
                        h_tdapa_payment.replace(20, 4, cm_onset_le_120.substr(64, 4));
                    } else {
                        if (to_int(h_patient_age) < 80) {
                            h_tdapa_payment.replace(20, 4, cm_onset_le_120.substr(68, 4));
                        } else {
                            h_tdapa_payment.replace(20, 4, cm_onset_le_120.substr(72, 4));
                        }
                    }
                }
            }
    ...
    if (false /* TODO: memcmp (VAR_186 + 156, COB_ZEROES_ALPHABETIC, 8) > 0 */) {
    ...
    if (false /* TODO: memcmp (VAR_186 + 227, COB_SPACES_ALPHABETIC, 2) == 0 */) {
        if (to_int(h_patient_age) < 18) {
            h_tdapa_payment.replace(53, 4, "1000");
            VAR_296.replace(112, 2, "10");
        } else {
            if (to_int(h_bun_onset_factor) == to_int(cm_onset_le_120)) {
                ...
                h_tdapa_payment.replace(53, 4, h_tdapa_payment.substr(185, 4));
            }
        }
    } else {
        if (VAR_186.substr(227, 2) == "10") {
            ...
            if (VAR_186.substr(227, 2) == "20") {
                h_tdapa_payment.replace(53, 4, cm_onset_le_120.substr(92, 4));
                VAR_296.replace(112, 2, "20");
            } else {
                if (VAR_186.substr(227, 2) == "40") {
                    h_tdapa_payment.replace(53, 4, cm_onset_le_120.substr(88, 4));
                    VAR_296.replace(112, 2, "40");
                }
            }
        }
    }
    if (VAR_186.at(104) == 'Y') {
        if (to_int(h_patient_age) > 17) {
            h_tdapa_payment.replace(204, 4, cm_onset_le_120.substr(104, 4));
            paid_return_code_trackers.at(4) = 'Y';
        } else {
            h_tdapa_payment.replace(204, 4, "1000");
        }
    } else {
        h_tdapa_payment.replace(204, 4, "1000");
    }
    if (false /* cob_cmp < 0 */ && to_int(h_patient_age) > 17) {
        h_tdapa_payment.replace(251, 4, cm_onset_le_120.substr(108, 4));
    } else {
        h_tdapa_payment.replace(251, 4, "1000");
    }
    h_bun_adjusted_base_wage_amt = to_string(to_num(0) * to_num(1));
    if (VAR_186.substr(0, 2) == "73" || VAR_186.substr(0, 2) == "87") {
        if (to_int(h_bun_onset_factor) == to_int(cm_onset_le_120)) {
            h_tdapa_payment.replace(68, 11, std::string(11, '0'));
        } else {
            h_bun_wage_adj_training_amt = to_string(to_num(0) * to_num(1));
            paid_return_code_trackers.at(5) = 'Y';
        }
    } else {
        if (VAR_186.substr(0, 2) == "74" && VAR_186.substr(2, 4) == "0841" || VAR_186.substr(2, 4) == "0851") {
            h_cc_74_per_diem_amt = to_string(to_num(0) / to_num(1));
        } else {
            h_tdapa_payment.replace(68, 11, std::string(11, '0'));
            h_tdapa_payment.replace(79, 11, std::string(11, '0'));
        }
    }
    if (VAR_186.substr(0, 2) == "74" && VAR_186.substr(2, 4) == "0841" || VAR_186.substr(2, 4) == "0851") {
...
void p_2100_calc_comorbid_adjust() {
    h_tdapa_payment.at(189) = 'N';
    h_tdapa_payment.replace(185, 4, "1000");
    VAR_296.replace(112, 2, "10");
    h_tdapa_payment.replace(212, 4, "0001");
    while (true) {
        if (to_int(h_tdapa_payment) > 6 || h_tdapa_payment.at(189) == 'Y') break;
        if (false /* TODO: memcmp (VAR_186 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (h_tdapa_payment + 212, 4)) - 1), (cob_u8_ptr)"MA", 2) == 0 */) {
            h_tdapa_payment.replace(185, 4, cm_onset_le_120.substr(92, 4));
            paid_return_code_trackers.at(1) = 'Y';
            VAR_296.replace(112, 2, "20");
        } else {
            if (false /* TODO: memcmp (VAR_186 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (h_tdapa_payment + 212, 4)) - 1), (cob_u8_ptr)"MC", 2) == 0 */) {
                if (cm_onset_le_120.substr(88, 4) > h_tdapa_payment.substr(185, 4)) {
                    h_tdapa_payment.replace(185, 4, cm_onset_le_120.substr(88, 4));
                    paid_return_code_trackers.at(1) = 'Y';
                    VAR_296.replace(112, 2, "40");
                }
            } else {
                if (false /* TODO: memcmp (VAR_186 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (h_tdapa_payment + 212, 4)) - 1), (cob_u8_ptr)"MD", 2) == 0 */) {
                    if (cm_onset_le_120.substr(100, 4) > h_tdapa_payment.substr(185, 4)) {
                        h_tdapa_payment.replace(185, 4, cm_onset_le_120.substr(100, 4));
                        paid_return_code_trackers.at(2) = 'Y';
                        VAR_296.replace(112, 2, "50");
                    }
                } else {
                    if (false /* TODO: memcmp (VAR_186 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (h_tdapa_payment + 212, 4)) - 1), (cob_u8_ptr)"ME", 2) == 0 */) {
                        if (cm_onset_le_120.substr(96, 4) > h_tdapa_payment.substr(185, 4)) {
                            h_tdapa_payment.replace(185, 4, cm_onset_le_120.substr(96, 4));
                            paid_return_code_trackers.at(2) = 'Y';
                            VAR_296.replace(112, 2, "60");
                        }
                    }
                }
            }
...
void p_2500_calc_outlier_factors() {
    ...
    VAR_296.replace(277, 11, h_out_rural_multiplier.substr(99, 11));
    if (VAR_186.substr(0, 2) == "74" && VAR_186.substr(2, 4) == "0841" || VAR_186.substr(2, 4) == "0851") {
        h_out_payment = to_string(to_num(0) * to_num(1));
    }
}
...
void p_3100_low_vol_out_pps_payment() {
    ...
    if (to_int(h_patient_age) < 18) {
        ...
        h_out_rural_multiplier.replace(46, 6, loss_sharing_pct_gt_17.substr(12, 6));
        if (h_out_rural_multiplier.substr(66, 11) > h_tdapa_payment.substr(163, 11)) {
            h_lv_out_payment = to_string(to_num(0) * to_num(1));
            h_out_loss_sharing_pct = loss_sharing_pct_lt_18;
        } else {
            h_tdapa_payment.replace(174, 11, std::string(11, '0'));
            h_out_rural_multiplier.replace(52, 3, std::string(3, '0'));
        }
    } else {
        h_lv_out_predicted_map = to_string(to_num(0) + to_num(1));
    ...
    VAR_296.replace(277, 11, h_tdapa_payment.substr(174, 11));
    if (VAR_186.substr(0, 2) == "74" && VAR_186.substr(2, 4) == "0841" || VAR_186.substr(2, 4) == "0851") {
        h_lv_out_payment = to_string(to_num(0) * to_num(1));
    }
}
                ...
                if (paid_return_code_trackers.at(5) == 'Y') {
                    if (paid_return_code_trackers.at(2) == 'Y') {
                        ...
                        if (paid_return_code_trackers.at(1) == 'Y') {
                            ...
                            VAR_296 = std::string(2, static_cast<char>(51));
                        }
                    }
                } else {
                    if (paid_return_code_trackers.at(2) == 'Y') {
            ...
            if (paid_return_code_trackers.at(4) == 'Y') {
                ...
                if (paid_return_code_trackers.at(5) == 'Y') {
                    if (paid_return_code_trackers.at(2) == 'Y') {
                        ...
                        if (paid_return_code_trackers.at(1) == 'Y') {
                            VAR_296 = std::string(2, static_cast<char>(50));
                        } else {
                            VAR_296 = std::string(2, static_cast<char>(49));
                        }
                    }
                } else {
                    if (paid_return_code_trackers.at(3) == 'Y') {
...
void p_9100_move_results() {
    if (false /* TODO: (*(h_tdapa_payment + 250) - ' ') == 0 */) {
    } else {
        VAR_186.replace(213, 2, h_tdapa_payment.substr(190, 2));
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        VAR_186.replace(227, 2, h_tdapa_payment.substr(202, 2));
    }
    VAR_296.replace(2, 4, VAR_186.substr(76, 4));
    VAR_296.replace(6, 5, VAR_186.substr(80, 5));
    VAR_296.replace(11, 6, h_patient_age.substr(12, 6));
    VAR_296.replace(31, 2, VAR_186.substr(0, 2));
    VAR_296.replace(33, 4, VAR_186.substr(2, 4));
    // MOVE to computed field
    VAR_296.replace(43, 6, bun_nat_labor_pct.substr(0, 6));
    VAR_296.replace(49, 6, bun_nat_nonlabor_pct.substr(0, 6));
    VAR_296.replace(57, 6, nat_labor_pct.substr(0, 6));
    VAR_296.replace(63, 6, nat_nonlabor_pct.substr(0, 6));
    VAR_296.replace(69, 4, h_patient_age.substr(21, 4));
    VAR_296.replace(73, 5, h_patient_age.substr(25, 5));
    VAR_296.replace(78, 5, h_patient_age.substr(30, 5));
    VAR_296.replace(83, 5, case_mix_bdgt_neut_factor.substr(0, 5));
    VAR_296.replace(88, 4, h_tdapa_payment.substr(20, 4));
    VAR_296.replace(92, 5, h_tdapa_payment.substr(31, 5));
    VAR_296.replace(97, 5, h_tdapa_payment.substr(43, 5));
    VAR_296.replace(102, 5, transition_bdgt_neut_factor.substr(0, 5));
    VAR_296.replace(108, 2, std::string(2, ' '));
    VAR_296.replace(110, 2, std::string(2, ' '));
    if (VAR_186.substr(0, 2) == "74" && VAR_186.substr(2, 4) == "0841" || VAR_186.substr(2, 4) == "0851") {
        h_out_payment = to_string(to_num(0) / to_num(1));
    }
    if (VAR_186.at(103) == 'N') {
    } else {
        VAR_296.replace(147, 9, std::string(9, '0'));
        VAR_296.replace(165, 9, std::string(9, '0'));
        VAR_296.replace(183, 9, std::string(9, '0'));
    }
    // MOVE to computed field
    VAR_296.replace(156, 9, h_tdapa_payment.substr(101, 9));
    VAR_296.replace(17, 9, h_tdapa_payment.substr(101, 9));
    // MOVE to computed field
    VAR_296.replace(294, 11, h_tdapa_payment.substr(255, 11));
    if (VAR_186.substr(0, 2) != "84") {
        if (VAR_186.at(106) == ' ') {
        } else {
        }
    ...
    if (VAR_186.at(449) == 'T') {
        VAR_186.replace(229, 5, drug_addon.substr(0, 5));
        // MOVE "00" to computed field
        VAR_186.replace(240, 6, h_patient_age.substr(12, 6));
        VAR_186.replace(246, 6, base_payment_rate.substr(0, 6));
        VAR_186.replace(260, 3, h_patient_age.substr(18, 3));
        // MOVE "00" to computed field
        VAR_186.replace(269, 6, VAR_367.substr(13, 6));
        VAR_186.replace(281, 7, h_patient_age.substr(42, 7));
        VAR_186.replace(288, 7, h_patient_age.substr(35, 7));
        VAR_186.replace(295, 3, msa_blend_pct.substr(0, 3));
        VAR_186.replace(298, 3, cbsa_blend_pct.substr(0, 3));
        if (VAR_186.at(103) == 'N') {
            VAR_186.replace(301, 3, com_cbsa_blend_pct.substr(0, 3));
            VAR_186.replace(304, 3, bun_cbsa_blend_pct.substr(0, 3));
        } else {
            VAR_186.replace(301, 3, std::string(3, '0'));
            VAR_186.replace(304, 3, waive_cbsa_blend_pct.substr(0, 3));
        }
        VAR_186.replace(316, 7, h_tdapa_payment.substr(24, 7));
        VAR_186.replace(323, 7, h_tdapa_payment.substr(36, 7));
        VAR_186.replace(330, 5, h_tdapa_payment.substr(48, 5));
        VAR_186.replace(335, 4, h_tdapa_payment.substr(53, 4));
        VAR_186.replace(347, 4, h_tdapa_payment.substr(204, 4));
        VAR_186.replace(369, 4, h_out_rural_multiplier.substr(0, 4));
        VAR_186.replace(373, 7, h_out_rural_multiplier.substr(4, 7));
        VAR_296.replace(212, 4, cm_onset_le_120.substr(20, 4));
        VAR_186.replace(380, 5, h_out_rural_multiplier.substr(11, 5));
        VAR_186.replace(385, 7, h_out_rural_multiplier.substr(16, 7));
        VAR_186.replace(392, 5, h_out_rural_multiplier.substr(23, 5));
        VAR_186.replace(397, 5, h_out_rural_multiplier.substr(28, 5));
        VAR_186.replace(402, 4, h_out_rural_multiplier.substr(33, 4));
        // MOVE to computed field
        // MOVE to computed field
        // MOVE to computed field
        VAR_186.replace(406, 4, h_out_rural_multiplier.substr(37, 4));
        VAR_186.replace(410, 5, h_out_rural_multiplier.substr(41, 5));
        // MOVE to computed field
        VAR_186.replace(426, 6, h_out_rural_multiplier.substr(46, 6));
        VAR_186.replace(415, 3, h_out_rural_multiplier.substr(52, 3));
        VAR_186.replace(432, 11, h_out_rural_multiplier.substr(88, 11));
        VAR_296.replace(248, 4, cr_age_lt_18.substr(24, 4));
        VAR_296.replace(252, 4, cr_age_lt_18.substr(28, 4));
        VAR_296.replace(220, 3, a_49_cent_part_d_drug_adj.substr(0, 3));
        VAR_296.replace(223, 4, cm_onset_le_120.substr(76, 4));
        VAR_296.replace(227, 4, cm_onset_le_120.substr(80, 4));
        VAR_296.replace(231, 6, bundled_base_pmt_rate.substr(0, 6));
        // MOVE to computed field
        VAR_296.replace(237, 11, h_tdapa_payment.substr(57, 11));
        VAR_296.replace(262, 11, h_tdapa_payment.substr(68, 11));
        VAR_296.replace(273, 4, training_add_on_pmt_amt.substr(0, 4));
        VAR_296.replace(288, 6, h_patient_age.substr(0, 6));
    }
}
