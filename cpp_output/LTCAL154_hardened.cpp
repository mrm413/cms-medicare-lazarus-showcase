...
std::string VAR_1358; // Auto-declared by LAZARUS healer

std::string c_23; // Auto-declared by LAZARUS healer

std::string VAR_1352; // Auto-declared by LAZARUS healer

std::string VAR_1189; // Auto-declared by LAZARUS healer

std::string VAR_1250; // Auto-declared by LAZARUS healer

std::string VAR_1257; // Auto-declared by LAZARUS healer

std::string VAR_1215; // Auto-declared by LAZARUS healer
...
FixedString<50> ibw_indx;
FixedString<50> ibw_max;
...
void p_1800_exit();
void p_1900_get_ipps_wage_index();
void p_1900_exit();
...
void p_8000_blend();
void p_8000_exit();
void p_8100_subclauseii_final_pay();
void p_8100_exit();
...
void p_0000_mainline_control() {
    ...
    if (to_int(VAR_1215) < 50) {
        if (VAR_1257.substr(10, 6) == "332006") {
            p_8100_subclauseii_final_pay();
        } else {
            p_8000_blend();
        }
    }
...
void p_0100_initial_routine() {
    VAR_1215 = std::string(2, '0');
    VAR_1215.replace(11, 4, std::string(4, ' '));
    VAR_1215.replace(15, 80, std::string(80, '0'));
    VAR_1215.replace(95, 8, std::string(8, ' '));
    VAR_1215.replace(103, 11, std::string(11, '0'));
    VAR_1215.replace(118, 27, std::string(27, '0'));
    VAR_1250 = std::string(5, ' ');
    h_oper_dsh_reduction_factor = std::string(185, '0');
    h_oper_dsh_reduction_factor.replace(185, 2, std::string(2, ' '));
    h_oper_dsh_reduction_factor.replace(187, 190, std::string(190, '0'));
    h_oper_dsh_reduction_factor.replace(377, 4, std::string(4, ' '));
    VAR_1250 = VAR_1257.substr(139, 5);
    p_1900_get_ipps_wage_index();
    if (to_int(VAR_1215) != 0) {
    }
    VAR_1215.replace(118, 6, "062306");
    VAR_1215.replace(124, 6, "037694");
    if (VAR_1257.at(138) == '1') {
        VAR_1215.replace(130, 7, "4104371");
    } else {
        VAR_1215.replace(130, 7, "4024051");
    }
    h_oper_dsh_reduction_factor.replace(64, 9, "001497200");
    VAR_1215.replace(137, 4, "1000");
    h_oper_dsh_reduction_factor.replace(340, 5, "43497");
    h_oper_dsh_reduction_factor.replace(345, 5, "20945");
    h_oper_dsh_reduction_factor.replace(350, 3, "075");
    h_oper_dsh_reduction_factor.replace(353, 3, "025");
    if (to_int(h_ipps_wage_index) > 1) {
        h_oper_dsh_reduction_factor.replace(297, 7, "0378475");
        h_oper_dsh_reduction_factor.replace(304, 7, "0165310");
    } else {
        h_oper_dsh_reduction_factor.replace(297, 7, "0337147");
        h_oper_dsh_reduction_factor.replace(304, 7, "0206638");
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1369, VAR_1358 + 21), 1LL) > 0 */) {
        h_oper_dsh_reduction_factor.replace(311, 7, "0160997");
        h_oper_dsh_reduction_factor.replace(318, 7, "0093745");
    } else {
        h_oper_dsh_reduction_factor.replace(311, 7, "0157940");
        h_oper_dsh_reduction_factor.replace(318, 7, "0096802");
    }
    h_oper_dsh_reduction_factor.replace(364, 4, "8214");
}
...
void p_1000_edit_the_bill_info() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1196, VAR_1189 + 21)) */ && to_int(VAR_1189) > 0) {
        h_oper_dsh_reduction_factor = VAR_1189.substr(21, 3);
    } else {
        VAR_1215 = "56";
    }
    if (to_int(VAR_1215) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1312, VAR_1257 + 87)) */) {
            VAR_1215 = "50";
        }
    }
    if (to_int(VAR_1215) == 0) {
    ...
    if (to_int(VAR_1215) == 0) {
        if (VAR_1189.substr(32, 8) < VAR_1257.substr(16, 8) || VAR_1189.substr(32, 8) < VAR_1352.substr(5, 8)) {
            VAR_1215 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_1215) == 0) {
        if (VAR_1257.substr(40, 8) > "00000000") {
            if (VAR_1189.substr(32, 8) >= VAR_1257.substr(40, 8)) {
                VAR_1215 = "51";
            }
        }
    }
    if (to_int(VAR_1215) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1205, VAR_1189 + 40)) */) {
            VAR_1215 = "58";
        }
    }
    if (to_int(VAR_1215) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1198, VAR_1189 + 27)) */ || to_int(VAR_1189) > 60) {
            VAR_1215 = "61";
        }
    }
    if (to_int(VAR_1215) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1197, VAR_1189 + 24)) */ || to_int(VAR_1189) == 0 && to_int(h_oper_dsh_reduction_factor) > 0) {
            VAR_1215 = "62";
        }
    }
    if (to_int(VAR_1215) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_1189 + 27, 2, cob_get_llint (COB_SET_DATA (f_1197, VAR_1189 + 24)), 0) > 0 */) {
            VAR_1215 = "62";
        }
    }
    if (to_int(VAR_1215) == 0) {
    ...
    if (to_int(VAR_1215) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1348, VAR_1257 + 207)) */) {
            h_oper_dsh_reduction_factor.replace(153, 5, VAR_1257.substr(207, 5));
        } else {
            h_oper_dsh_reduction_factor.replace(153, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_1215) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1313, VAR_1257 + 91)) */) {
            h_oper_dsh_reduction_factor.replace(148, 5, VAR_1257.substr(91, 5));
        } else {
            h_oper_dsh_reduction_factor.replace(148, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_1215) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1314, VAR_1257 + 96)) */) {
            h_oper_dsh_reduction_factor.replace(158, 5, VAR_1257.substr(96, 5));
        } else {
            h_oper_dsh_reduction_factor.replace(158, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_1215) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1317, VAR_1257 + 110)) */) {
            h_oper_dsh_reduction_factor.replace(167, 4, VAR_1257.substr(110, 4));
        } else {
            h_oper_dsh_reduction_factor.replace(167, 4, std::string(4, '0'));
        }
    }
    if (to_int(VAR_1215) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1318, VAR_1257 + 114)) */) {
            h_oper_dsh_reduction_factor.replace(171, 4, VAR_1257.substr(114, 4));
        } else {
            h_oper_dsh_reduction_factor.replace(171, 4, std::string(4, '0'));
        }
    }
}
...
void p_1200_days_used() {
    if (to_int(VAR_1189) > 0 && to_int(h_oper_dsh_reduction_factor) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_1189 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_1215.replace(106, 3, h_oper_dsh_reduction_factor.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_oper_dsh_reduction_factor) > 0 && to_int(VAR_1189) == 0) {
            if (h_oper_dsh_reduction_factor.substr(3, 3) > h_oper_dsh_reduction_factor.substr(0, 3)) {
                VAR_1215.replace(103, 3, h_oper_dsh_reduction_factor.substr(0, 3));
            } else {
                VAR_1215.replace(103, 3, h_oper_dsh_reduction_factor.substr(3, 3));
            }
        } else {
            if (to_int(h_oper_dsh_reduction_factor) > 0 && to_int(VAR_1189) > 0) {
                if (h_oper_dsh_reduction_factor.substr(3, 3) > h_oper_dsh_reduction_factor.substr(0, 3)) {
                    VAR_1215.replace(103, 3, h_oper_dsh_reduction_factor.substr(0, 3));
                    VAR_1215.replace(106, 3, std::string(3, '0'));
                } else {
                    if (false /* TODO: cob_cmp_numdisp (h_oper_dsh_reduction_factor + 6, 5, cob_get_llint (h_los), 0) > 0 */) {
                        VAR_1215.replace(103, 3, h_oper_dsh_reduction_factor.substr(3, 3));
                    } else {
                        if (false /* TODO: cob_cmp_numdisp (h_oper_dsh_reduction_factor + 6, 5, cob_get_llint (h_los), 0) <= 0 */) {
                            VAR_1215.replace(103, 3, h_oper_dsh_reduction_factor.substr(3, 3));
...
void p_1700_edit_drg_code() {
    VAR_1215.replace(95, 3, VAR_1189.substr(18, 3));
    if (to_int(VAR_1215) == 0) {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_25 + 15LL * ((cob_s64_t)(wwm_indx) - 1), VAR_1215 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_275;
...
void p_1800_edit_ipps_drg_code() {
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1195, VAR_1189 + 18)) */) {
        VAR_1215 = "54";
    }
    if (VAR_1189.substr(32, 8) >= wk_drgx_eff_date.substr(0, 8)) {
        drg_idx = to_string(1);
        // UNHANDLED: const int max = 753;
        while (true) {
            ...
            if (false /* TODO: memcmp (VAR_281 + 57LL * ((cob_s64_t)(drg_idx) - 1), VAR_1189 + 18, 3) == 0 */) {
                break;
            }
            // UNHANDLED: b_1038++;
        }
    ...
    h_oper_dsh_reduction_factor.replace(325, 6, hlddrg_data.substr(4, 6));
    wk_hlddrg_data2.replace(11, 3, hlddrg_data.substr(11, 3));
    h_oper_dsh_reduction_factor.replace(331, 3, hlddrg_data.substr(11, 3));
    wk_hlddrg_data2.at(19) = hlddrg_data.at(19);
    wk_hlddrg_data2.replace(21, 3, hlddrg_data.substr(21, 3));
    h_oper_dsh_reduction_factor.replace(337, 3, hlddrg_data.substr(21, 3));
    ...
    h_oper_dsh_reduction_factor.replace(334, 3, std::string(3, '0'));
}
...
void p_1900_get_ipps_wage_index() {
    ...
    while (true) {
        ...
        // ibw_indx = (head + tail) / 2;
        if (false /* TODO: (ret = memcmp (VAR_1055 + 12LL * ((cob_s64_t)(ibw_indx) - 1), VAR_1257 + 10, 6)) == 0 */) {
            // MOVE to computed field
            break;
        }
        // if (ret < 0) head = b_1080;
        // tail = b_1080;
    }
...
void p_2000_assemble_pps_variables() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_1357, VAR_1352 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1357, VAR_1352 + 25), 0LL) > 0 */) {
        // MOVE to computed field
    } else {
        VAR_1215 = "52";
    }
    ...
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_1315, VAR_1257 + 101)) */) {
        VAR_1215 = "65";
    }
    // MOVE to computed field
    if (to_int(VAR_1215) > 0 && to_int(VAR_1215) < 6) {
    } else {
        VAR_1215 = "72";
    }
    h_blend_fac = "0";
    h_blend_pps = "1";
    h_oper_dsh_reduction_factor.replace(14, 2, std::string(2, '0'));
    if (to_int(VAR_1215) == 1) {
        h_oper_dsh_reduction_factor.replace(16, 2, "08");
        h_oper_dsh_reduction_factor.replace(18, 2, "02");
        h_oper_dsh_reduction_factor.replace(14, 2, "04");
    } else {
        if (to_int(VAR_1215) == 2) {
            h_oper_dsh_reduction_factor.replace(16, 2, "06");
            h_oper_dsh_reduction_factor.replace(18, 2, "04");
            h_oper_dsh_reduction_factor.replace(14, 2, "08");
        } else {
            if (to_int(VAR_1215) == 3) {
                h_oper_dsh_reduction_factor.replace(16, 2, "04");
                h_oper_dsh_reduction_factor.replace(18, 2, "06");
                h_oper_dsh_reduction_factor.replace(14, 2, "12");
            } else {
                if (to_int(VAR_1215) == 4) {
                    h_oper_dsh_reduction_factor.replace(16, 2, "02");
                    h_oper_dsh_reduction_factor.replace(18, 2, "08");
                    h_oper_dsh_reduction_factor.replace(14, 2, "16");
                }
            }
        }
    }
...
void p_3000_calc_payment() {
    if (to_int(VAR_1257) == 2 || to_int(VAR_1257) == 12) {
        VAR_1215.replace(110, 4, VAR_1257.substr(87, 4));
    } else {
        VAR_1215.replace(110, 4, "1000");
    }
    h_labor_portion = to_string(to_num(0) * to_num(1));
    h_nonlabor_portion = to_string(to_num(0) * to_num(1));
    h_oper_dsh_reduction_factor.replace(368, 9, VAR_1215.substr(41, 9));
...
void p_3400_short_stay() {
    if (VAR_1257.substr(10, 6) == "332006") {
        ...
        h_oper_dsh_reduction_factor.replace(29, 9, VAR_1215.substr(68, 9));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
        if (false /* TODO: cob_is_numeric (h_ipps_wage_index) */ && to_int(h_ipps_wage_index) > 0) {
            if (VAR_1189.substr(32, 8) >= "20121229") {
                if (false /* cob_cmp > 0 */) {
    ...
    h_oper_dsh_reduction_factor.at(377) = 'N';
    h_oper_dsh_reduction_factor.at(378) = 'N';
    h_oper_dsh_reduction_factor.at(379) = 'N';
    h_oper_dsh_reduction_factor.at(380) = 'N';
    if (h_oper_dsh_reduction_factor.substr(29, 9) < h_oper_dsh_reduction_factor.substr(20, 9)) {
        if (h_oper_dsh_reduction_factor.substr(29, 9) < VAR_1215.substr(41, 9)) {
            VAR_1215.replace(41, 9, h_oper_dsh_reduction_factor.substr(29, 9));
            VAR_1215 = "20";
            h_oper_dsh_reduction_factor.at(377) = 'Y';
        } else {
        }
    } else {
        if (h_oper_dsh_reduction_factor.substr(20, 9) < VAR_1215.substr(41, 9)) {
            VAR_1215.replace(41, 9, h_oper_dsh_reduction_factor.substr(20, 9));
            VAR_1215 = "21";
            h_oper_dsh_reduction_factor.at(378) = 'Y';
        } else {
        }
    }
    if (VAR_1257.substr(10, 6) == "332006") {
        if (VAR_1189.substr(32, 8) >= "20121229" && false /* cob_cmp > 0 */ && h_oper_dsh_reduction_factor.substr(280, 9) < VAR_1215.substr(41, 9)) {
            VAR_1215.replace(41, 9, h_oper_dsh_reduction_factor.substr(280, 9));
            VAR_1215 = std::string(2, static_cast<char>(50));
            h_oper_dsh_reduction_factor.at(379) = 'Y';
            h_oper_dsh_reduction_factor.at(377) = 'N';
            h_oper_dsh_reduction_factor.at(378) = 'N';
            h_oper_dsh_reduction_factor.at(380) = 'N';
        } else {
            if (VAR_1189.substr(32, 8) >= "20121229" && false /* cob_cmp <= 0 */ && h_oper_dsh_reduction_factor.substr(262, 9) <= VAR_1215.substr(41, 9)) {
                VAR_1215.replace(41, 9, h_oper_dsh_reduction_factor.substr(262, 9));
                VAR_1215 = "26";
                h_oper_dsh_reduction_factor.at(380) = 'Y';
                h_oper_dsh_reduction_factor.at(379) = 'N';
                h_oper_dsh_reduction_factor.at(377) = 'N';
                h_oper_dsh_reduction_factor.at(378) = 'N';
            } else {
                if (VAR_1189.substr(32, 8) < "20121229" && h_oper_dsh_reduction_factor.substr(280, 9) < VAR_1215.substr(41, 9)) {
                    VAR_1215.replace(41, 9, h_oper_dsh_reduction_factor.substr(280, 9));
                    VAR_1215 = std::string(2, static_cast<char>(50));
                    h_oper_dsh_reduction_factor.at(379) = 'Y';
                    h_oper_dsh_reduction_factor.at(377) = 'N';
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(h_capi_ime_ratio) > to_int(c_23)) {
        h_oper_dsh_reduction_factor.replace(153, 5, "15000");
    }
    h_capi_ime_teach = to_string(to_num(0) - to_num(1));
    if (VAR_1358.at(5) == 'R') {
        h_oper_dsh_reduction_factor.at(186) = '0';
    } else {
        h_oper_dsh_reduction_factor.at(186) = '1';
    }
    h_oper_dsh_pct = to_string(to_num(0) + to_num(1));
    if (h_oper_dsh_reduction_factor.at(186) == '1' && to_int(h_oper_dsh_reduction_factor) < 100 && to_int(h_oper_dsh_pct) >= to_int(c_7)) {
        h_oper_dsh_reduction_factor.at(185) = static_cast<char>(51);
    } else {
        if (h_oper_dsh_reduction_factor.at(186) == '1' && to_int(h_oper_dsh_reduction_factor) >= 100 && to_int(h_oper_dsh_pct) >= to_int(c_7)) {
            h_oper_dsh_reduction_factor.at(185) = static_cast<char>(50);
        } else {
            if (h_oper_dsh_reduction_factor.at(186) == '0' && to_int(h_oper_dsh_reduction_factor) >= 500 && to_int(h_oper_dsh_pct) >= to_int(c_7)) {
                h_oper_dsh_reduction_factor.at(185) = static_cast<char>(50);
            } else {
                if (h_oper_dsh_reduction_factor.at(186) == '0' && to_int(h_oper_dsh_reduction_factor) < 500 && to_int(h_oper_dsh_pct) >= to_int(c_7)) {
                    h_oper_dsh_reduction_factor.at(185) = static_cast<char>(51);
                } else {
                    h_oper_dsh_reduction_factor.at(185) = static_cast<char>(52);
                }
            }
        }
    }
    if (h_oper_dsh_reduction_factor.at(185) == '2') {
        if (to_int(h_oper_dsh_pct) >= to_int(c_7) && to_int(h_oper_dsh_pct) <= to_int(c_10)) {
            ...
            if (to_int(h_oper_dsh_pct) > to_int(c_10)) {
                ...
                h_oper_dsh_reduction_factor.replace(175, 5, std::string(5, '0'));
            }
        }
    } else if (h_oper_dsh_reduction_factor.at(185) == '3') {
        if (to_int(h_oper_dsh_pct) >= to_int(c_7) && to_int(h_oper_dsh_pct) <= to_int(c_10)) {
            h_oper_dsh = to_string(to_num(0) + to_num(1));
    ...
    } else if (h_oper_dsh_reduction_factor.at(185) == '4') {
        h_oper_dsh_reduction_factor.replace(175, 5, std::string(5, '0'));
    }
    h_oper_dsh = to_string(to_num(0) * to_num(1));
    if (h_oper_dsh_reduction_factor.at(186) == '1' && to_int(h_oper_dsh_reduction_factor) >= 100) {
        h_capi_dsh = to_string(to_num(0) - to_num(1));
    } else {
        h_oper_dsh_reduction_factor.replace(180, 5, std::string(5, '0'));
    }
    if (to_int(VAR_1257) == 2 || to_int(VAR_1257) == 12) {
        h_oper_dsh_reduction_factor.replace(289, 4, VAR_1257.substr(87, 4));
    } else {
        h_oper_dsh_reduction_factor.replace(289, 4, "1000");
    }
    h_stand_amt_oper_pmt = to_string(to_num(0) * to_num(1));
    h_capi_cola = to_string(to_num(0) + to_num(1));
    if (VAR_1358.at(5) == 'L') {
        h_oper_dsh_reduction_factor.replace(241, 3, "100");
    } else {
        h_oper_dsh_reduction_factor.replace(241, 3, "100");
    }
    ...
    if (h_oper_dsh_reduction_factor.substr(262, 9) > h_oper_dsh_reduction_factor.substr(244, 9)) {
        h_oper_dsh_reduction_factor.replace(262, 9, h_oper_dsh_reduction_factor.substr(244, 9));
    }
    if (to_int(VAR_1257) == 40) {
...
void p_3675_ss_ipps_comp_pr_pmt() {
    ...
    if (h_oper_dsh_reduction_factor.substr(271, 9) > h_oper_dsh_reduction_factor.substr(253, 9)) {
        h_oper_dsh_reduction_factor.replace(271, 9, h_oper_dsh_reduction_factor.substr(253, 9));
    }
    h_ipps_per_diem = to_string(to_num(0) + to_num(1));
}
...
void p_4000_special_provider() {
    if (VAR_1189.substr(32, 8) >= "20030701" && VAR_1189.substr(32, 8) < "20040101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1189.substr(32, 8) >= "20040101" && VAR_1189.substr(32, 8) < "20050101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1189.substr(32, 8) >= "20050101" && VAR_1189.substr(32, 8) < "20060101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1189.substr(32, 8) >= "20060101" && VAR_1189.substr(32, 8) < "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_1189.substr(32, 8) >= "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
}
...
void p_7000_calc_outlier() {
    if (VAR_1215.substr(68, 9) > VAR_1215.substr(86, 9)) {
    }
    if (VAR_1189.at(49) == '1') {
        // MOVE "0" to computed field
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1223, VAR_1215 + 29), 0LL) > 0 */ && to_int(VAR_1215) == 21) {
        VAR_1215 = "24";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1223, VAR_1215 + 29), 0LL) > 0 */ && to_int(VAR_1215) == 22) {
        VAR_1215 = "25";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1223, VAR_1215 + 29), 0LL) > 0 */ && to_int(VAR_1215) == 26) {
        VAR_1215 = "27";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1223, VAR_1215 + 29), 0LL) > 0 */ && to_int(VAR_1215) == 0) {
        VAR_1215 = "01";
    }
    if (to_int(VAR_1215) == 0 || to_int(VAR_1215) == 20 || to_int(VAR_1215) == 21 || to_int(VAR_1215) == 22 || to_int(VAR_1215) == 26) {
        if (false /* cob_cmp > 0 */) {
            VAR_1215.replace(106, 3, std::string(3, '0'));
        } else {
        }
    }
    if (to_int(VAR_1215) == 1 || to_int(VAR_1215) == 24 || to_int(VAR_1215) == 25 || to_int(VAR_1215) == 27 || VAR_1215.at(161) == 'Y') {
        if (VAR_1189.substr(24, 3) < h_oper_dsh_reduction_factor.substr(0, 3) || VAR_1215.at(161) == 'Y' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1315, VAR_1257 + 101), 0LL) != 0 */) {
            if (VAR_1215.substr(162, 2) == "PC") {
                VAR_1215 = "67";
            }
        } else {
        }
...
void p_8000_blend() {
    ...
    if (to_int(VAR_1215) == 20 || to_int(VAR_1215) == 21 || to_int(VAR_1215) == 22 || to_int(VAR_1215) == 26 && to_int(h_oper_dsh_reduction_factor) > 0) {
    } else {
        if (to_int(VAR_1215) == 24 || to_int(VAR_1215) == 25 || to_int(VAR_1215) == 27 && to_int(h_oper_dsh_reduction_factor) > 0) {
        } else {
        }
    }
}
...
void p_8100_subclauseii_final_pay() {
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_1223, VAR_1215 + 29), 0LL) > 0 */) {
        VAR_1215 = "29";
    } else {
        VAR_1215 = "28";
    }
    // MOVE to computed field
    VAR_1215.replace(29, 9, std::string(9, '0'));
    VAR_1215.replace(41, 9, std::string(9, '0'));
    VAR_1215.replace(50, 9, std::string(9, '0'));
    VAR_1215.replace(68, 9, std::string(9, '0'));
    VAR_1215.replace(95, 3, std::string(3, ' '));
    VAR_1215.replace(118, 6, std::string(6, '0'));
    VAR_1215.replace(124, 6, std::string(6, '0'));
    VAR_1215.replace(130, 7, std::string(7, '0'));
    VAR_1215.replace(137, 4, std::string(4, '0'));
    VAR_1215.replace(141, 4, std::string(4, '0'));
}
...
void p_9000_move_results() {
    if (to_int(VAR_1215) < 50) {
        VAR_1215.replace(38, 3, h_oper_dsh_reduction_factor.substr(0, 3));
        VAR_1215.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_1215.replace(11, 4, std::string(4, ' '));
        VAR_1215.replace(15, 80, std::string(80, '0'));
        VAR_1215.replace(95, 8, std::string(8, ' '));
