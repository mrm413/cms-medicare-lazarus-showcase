...
std::string VAR_769; // Auto-declared by LAZARUS healer

std::string c_23; // Auto-declared by LAZARUS healer

std::string VAR_763; // Auto-declared by LAZARUS healer

std::string VAR_609; // Auto-declared by LAZARUS healer

std::string VAR_669; // Auto-declared by LAZARUS healer

std::string VAR_662; // Auto-declared by LAZARUS healer

std::string VAR_627; // Auto-declared by LAZARUS healer
...
void p_0100_initial_routine() {
    VAR_627 = std::string(2, '0');
    VAR_627.replace(11, 4, std::string(4, ' '));
    VAR_627.replace(15, 80, std::string(80, '0'));
    VAR_627.replace(95, 8, std::string(8, ' '));
    VAR_627.replace(103, 11, std::string(11, '0'));
    VAR_627.replace(118, 27, std::string(27, '0'));
    VAR_662 = std::string(5, ' ');
    ...
    VAR_662 = VAR_669.substr(139, 5);
    p_1900_apply_ssrfbn();
    if (to_int(VAR_627) != 0) {
    }
    VAR_627.replace(118, 6, "063096");
    VAR_627.replace(124, 6, "036904");
    if (VAR_609.substr(29, 8) >= "20121229") {
        VAR_627.replace(130, 7, "4039796");
    } else {
        VAR_627.replace(130, 7, "4091595");
    }
    h_ipps_wage_index.replace(64, 9, "001540800");
    VAR_627.replace(137, 4, "1000");
    h_ipps_wage_index.replace(339, 5, "42549");
    h_ipps_wage_index.replace(344, 5, "20725");
    h_ipps_wage_index.replace(349, 3, "075");
    h_ipps_wage_index.replace(352, 3, "025");
    if (to_int(h_ipps_wage_index) > 1) {
        h_ipps_wage_index.replace(297, 7, "0367995");
        h_ipps_wage_index.replace(304, 7, "0166881");
    } else {
        h_ipps_wage_index.replace(297, 7, "0331623");
        h_ipps_wage_index.replace(304, 7, "0203253");
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_780, VAR_769 + 21), 1LL) > 0 */) {
        h_ipps_wage_index.replace(311, 7, "0156417");
        h_ipps_wage_index.replace(318, 7, "0095462");
    } else {
        h_ipps_wage_index.replace(311, 7, "0156165");
        h_ipps_wage_index.replace(318, 7, "0095714");
    }
}
...
void p_1000_edit_the_bill_info() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_616, VAR_609 + 21)) */ && to_int(VAR_609) > 0) {
        h_ipps_wage_index = VAR_609.substr(21, 3);
    } else {
        VAR_627 = "56";
    }
    if (to_int(VAR_627) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_723, VAR_669 + 87)) */) {
            VAR_627 = "50";
        }
    }
    if (to_int(VAR_627) == 0) {
    ...
    if (to_int(VAR_627) == 0) {
        if (VAR_609.substr(29, 8) < VAR_669.substr(16, 8) || VAR_609.substr(29, 8) < VAR_763.substr(5, 8)) {
            VAR_627 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_627) == 0) {
        if (VAR_669.substr(40, 8) > "00000000") {
            if (VAR_609.substr(29, 8) >= VAR_669.substr(40, 8)) {
                VAR_627 = "51";
            }
        }
    }
    if (to_int(VAR_627) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_624, VAR_609 + 37)) */) {
            VAR_627 = "58";
        }
    }
    if (to_int(VAR_627) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_618, VAR_609 + 27)) */ || to_int(VAR_609) > 60) {
            VAR_627 = "61";
        }
    }
    if (to_int(VAR_627) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_617, VAR_609 + 24)) */ || to_int(VAR_609) == 0 && to_int(h_ipps_wage_index) > 0) {
            VAR_627 = "62";
        }
    }
    if (to_int(VAR_627) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_609 + 27, 2, cob_get_llint (COB_SET_DATA (f_617, VAR_609 + 24)), 0) > 0 */) {
            VAR_627 = "62";
        }
    }
    if (to_int(VAR_627) == 0) {
    ...
    if (to_int(VAR_627) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_759, VAR_669 + 207)) */) {
            h_ipps_wage_index.replace(153, 5, VAR_669.substr(207, 5));
        } else {
            h_ipps_wage_index.replace(153, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_627) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_724, VAR_669 + 91)) */) {
            h_ipps_wage_index.replace(148, 5, VAR_669.substr(91, 5));
        } else {
            h_ipps_wage_index.replace(148, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_627) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_725, VAR_669 + 96)) */) {
            h_ipps_wage_index.replace(158, 5, VAR_669.substr(96, 5));
        } else {
            h_ipps_wage_index.replace(158, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_627) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_728, VAR_669 + 110)) */) {
            h_ipps_wage_index.replace(167, 4, VAR_669.substr(110, 4));
        } else {
            h_ipps_wage_index.replace(167, 4, std::string(4, '0'));
        }
    }
    if (to_int(VAR_627) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_729, VAR_669 + 114)) */) {
            h_ipps_wage_index.replace(171, 4, VAR_669.substr(114, 4));
        } else {
...
void p_1200_days_used() {
    if (to_int(VAR_609) > 0 && to_int(h_ipps_wage_index) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_609 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_627.replace(106, 3, h_ipps_wage_index.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_ipps_wage_index) > 0 && to_int(VAR_609) == 0) {
            if (h_ipps_wage_index.substr(3, 3) > h_ipps_wage_index.substr(0, 3)) {
                VAR_627.replace(103, 3, h_ipps_wage_index.substr(0, 3));
            } else {
                VAR_627.replace(103, 3, h_ipps_wage_index.substr(3, 3));
            }
        } else {
            if (to_int(h_ipps_wage_index) > 0 && to_int(VAR_609) > 0) {
                if (h_ipps_wage_index.substr(3, 3) > h_ipps_wage_index.substr(0, 3)) {
                    VAR_627.replace(103, 3, h_ipps_wage_index.substr(0, 3));
                    VAR_627.replace(106, 3, std::string(3, '0'));
                } else {
...
void p_1700_edit_drg_code() {
    VAR_627.replace(95, 3, VAR_609.substr(18, 3));
    if (to_int(VAR_627) == 0) {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_25 + 15LL * ((cob_s64_t)(wwm_indx) - 1), VAR_627 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_275;
...
void p_1800_edit_ipps_drg_code() {
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_615, VAR_609 + 18)) */) {
        VAR_627 = "54";
    }
    if (false /* TODO: memcmp (VAR_609 + 29, VAR_280 + 14008LL * ((cob_s64_t)(dx5) - 1), 8) >= 0 */ && to_int(VAR_627) == 0) {
        // dx6 = cob_get_numdisp (b_609 + 18, 3);
...
void p_2000_assemble_pps_variables() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_768, VAR_763 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_768, VAR_763 + 25), 0LL) > 0 */) {
        // MOVE to computed field
    } else {
        VAR_627 = "52";
    }
    ...
    if (VAR_669.at(137) == '1') {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_745, VAR_669 + 154)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_745, VAR_669 + 154), 0LL) > 0 */) {
            VAR_627.replace(15, 6, VAR_669.substr(154, 6));
        } else {
            VAR_627 = "52";
        }
    }
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_726, VAR_669 + 101)) */) {
        VAR_627 = "65";
    }
    // MOVE to computed field
    if (to_int(VAR_627) > 0 && to_int(VAR_627) < 6) {
    } else {
        VAR_627 = "72";
    }
    h_blend_fac = "0";
...
void p_3000_calc_payment() {
    if (to_int(VAR_669) == 2 || to_int(VAR_669) == 12) {
        VAR_627.replace(110, 4, VAR_669.substr(87, 4));
    } else {
        VAR_627.replace(110, 4, "1000");
    }
    h_labor_portion = to_string(to_num(0) * to_num(1));
    h_nonlabor_portion = to_string(to_num(0) * to_num(1));
    h_ipps_wage_index.replace(363, 9, VAR_627.substr(41, 9));
...
void p_3400_short_stay() {
    if (VAR_669.substr(10, 6) == "332006") {
        p_4000_special_provider();
    } else {
        h_ipps_wage_index.replace(29, 9, VAR_627.substr(68, 9));
    ...
    if (h_ipps_wage_index.substr(29, 9) < h_ipps_wage_index.substr(20, 9)) {
        if (h_ipps_wage_index.substr(29, 9) < VAR_627.substr(41, 9)) {
            VAR_627.replace(41, 9, h_ipps_wage_index.substr(29, 9));
            VAR_627 = "20";
            h_ipps_wage_index.at(372) = 'Y';
        } else {
        }
    } else {
        if (h_ipps_wage_index.substr(20, 9) < VAR_627.substr(41, 9)) {
            VAR_627.replace(41, 9, h_ipps_wage_index.substr(20, 9));
            VAR_627 = "21";
    ...
    if (VAR_669.substr(10, 6) != "332006") {
        if (VAR_609.substr(29, 8) >= "20121229" && false /* cob_cmp > 0 */ && h_ipps_wage_index.substr(280, 9) < VAR_627.substr(41, 9)) {
            VAR_627.replace(41, 9, h_ipps_wage_index.substr(280, 9));
            VAR_627 = std::string(2, static_cast<char>(50));
            h_ipps_wage_index.at(374) = 'Y';
            h_ipps_wage_index.at(372) = 'N';
            h_ipps_wage_index.at(373) = 'N';
            h_ipps_wage_index.at(375) = 'N';
        } else {
            if (VAR_609.substr(29, 8) >= "20121229" && false /* cob_cmp <= 0 */ && h_ipps_wage_index.substr(262, 9) <= VAR_627.substr(41, 9)) {
                VAR_627.replace(41, 9, h_ipps_wage_index.substr(262, 9));
                VAR_627 = "26";
                h_ipps_wage_index.at(375) = 'Y';
                h_ipps_wage_index.at(374) = 'N';
                h_ipps_wage_index.at(372) = 'N';
                h_ipps_wage_index.at(373) = 'N';
            } else {
                if (VAR_609.substr(29, 8) < "20121229" && h_ipps_wage_index.substr(280, 9) < VAR_627.substr(41, 9)) {
                    VAR_627.replace(41, 9, h_ipps_wage_index.substr(280, 9));
                    VAR_627 = std::string(2, static_cast<char>(50));
                    h_ipps_wage_index.at(374) = 'Y';
                    h_ipps_wage_index.at(372) = 'N';
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(VAR_669) == 2 || to_int(VAR_669) == 12) {
        h_ipps_wage_index.replace(289, 4, VAR_669.substr(87, 4));
    } else {
...
void p_4000_special_provider() {
    if (VAR_609.substr(29, 8) >= "20030701" && VAR_609.substr(29, 8) < "20040101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_609.substr(29, 8) >= "20040101" && VAR_609.substr(29, 8) < "20050101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_609.substr(29, 8) >= "20050101" && VAR_609.substr(29, 8) < "20060101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_609.substr(29, 8) >= "20060101" && VAR_609.substr(29, 8) < "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_609.substr(29, 8) >= "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
}
...
void p_7000_calc_outlier() {
    if (VAR_627.substr(68, 9) > VAR_627.substr(86, 9)) {
    }
    if (VAR_609.at(46) == '1') {
        // MOVE "0" to computed field
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_635, VAR_627 + 29), 0LL) > 0 */ && to_int(VAR_627) == 21) {
        VAR_627 = "24";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_635, VAR_627 + 29), 0LL) > 0 */ && to_int(VAR_627) == 22) {
        VAR_627 = "25";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_635, VAR_627 + 29), 0LL) > 0 */ && to_int(VAR_627) == 26) {
        VAR_627 = "27";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_635, VAR_627 + 29), 0LL) > 0 */ && to_int(VAR_627) == 0) {
        VAR_627 = "01";
    }
    if (to_int(VAR_627) == 0 || to_int(VAR_627) == 20 || to_int(VAR_627) == 21 || to_int(VAR_627) == 22 || to_int(VAR_627) == 26) {
        if (false /* cob_cmp > 0 */) {
            VAR_627.replace(106, 3, std::string(3, '0'));
        } else {
        }
    }
    if (to_int(VAR_627) == 1 || to_int(VAR_627) == 24 || to_int(VAR_627) == 25 || to_int(VAR_627) == 27 || VAR_627.at(161) == 'Y') {
        if (VAR_609.substr(24, 3) < h_ipps_wage_index.substr(0, 3) || VAR_627.at(161) == 'Y' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_726, VAR_669 + 101), 0LL) != 0 */) {
            if (VAR_627.substr(162, 2) == "PC") {
                VAR_627 = "67";
            }
        } else {
        }
...
void p_8000_blend() {
    ...
    if (to_int(VAR_627) == 20 || to_int(VAR_627) == 21 || to_int(VAR_627) == 22 || to_int(VAR_627) == 26 && to_int(h_ipps_wage_index) > 0) {
    } else {
        if (to_int(VAR_627) == 24 || to_int(VAR_627) == 25 || to_int(VAR_627) == 27 && to_int(h_ipps_wage_index) > 0) {
        } else {
        }
    }
}
...
void p_9000_move_results() {
    if (to_int(VAR_627) < 50) {
        VAR_627.replace(38, 3, h_ipps_wage_index.substr(0, 3));
        VAR_627.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_627.replace(11, 4, std::string(4, ' '));
        VAR_627.replace(15, 80, std::string(80, '0'));
        VAR_627.replace(95, 8, std::string(8, ' '));
