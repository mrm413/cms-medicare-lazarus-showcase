...
std::string VAR_592; // Auto-declared by LAZARUS healer

std::string c_23; // Auto-declared by LAZARUS healer

std::string VAR_586; // Auto-declared by LAZARUS healer

std::string VAR_433; // Auto-declared by LAZARUS healer

std::string VAR_493; // Auto-declared by LAZARUS healer

std::string VAR_486; // Auto-declared by LAZARUS healer

std::string VAR_451; // Auto-declared by LAZARUS healer
...
void p_0100_initial_routine() {
    VAR_451 = std::string(2, '0');
    VAR_451.replace(11, 4, std::string(4, ' '));
    VAR_451.replace(15, 80, std::string(80, '0'));
    VAR_451.replace(95, 8, std::string(8, ' '));
    VAR_451.replace(103, 11, std::string(11, '0'));
    VAR_451.replace(118, 27, std::string(27, '0'));
    VAR_486 = std::string(5, ' ');
    ...
    VAR_486 = VAR_493.substr(139, 5);
    VAR_451.replace(118, 6, "075788");
    VAR_451.replace(124, 6, "024212");
    VAR_451.replace(130, 7, "3835645");
    h_pr_ipps_pmt_pct.replace(64, 9, "002073800");
    VAR_451.replace(137, 4, "1000");
    h_pr_ipps_pmt_pct.replace(339, 5, "42703");
    h_pr_ipps_pmt_pct.replace(344, 5, "20303");
    h_pr_ipps_pmt_pct.replace(349, 3, "075");
    h_pr_ipps_pmt_pct.replace(352, 3, "025");
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_602, VAR_592 + 15), 1LL) > 0 */) {
        h_pr_ipps_pmt_pct.replace(297, 7, "0339752");
        h_pr_ipps_pmt_pct.replace(304, 7, "0147697");
    } else {
        h_pr_ipps_pmt_pct.replace(297, 7, "0302218");
        h_pr_ipps_pmt_pct.replace(304, 7, "0185231");
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_603, VAR_592 + 21), 1LL) > 0 */) {
        h_pr_ipps_pmt_pct.replace(311, 7, "0143612");
        h_pr_ipps_pmt_pct.replace(318, 7, "0088020");
    } else {
        h_pr_ipps_pmt_pct.replace(311, 7, "0135968");
        h_pr_ipps_pmt_pct.replace(318, 7, "0095664");
    }
}
...
void p_1000_edit_the_bill_info() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_440, VAR_433 + 21)) */ && to_int(VAR_433) > 0) {
        h_pr_ipps_pmt_pct = VAR_433.substr(21, 3);
    } else {
        VAR_451 = "56";
    }
    if (to_int(VAR_451) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_547, VAR_493 + 87)) */) {
            VAR_451 = "50";
        }
    }
    if (to_int(VAR_451) == 0) {
    ...
    if (to_int(VAR_451) == 0) {
        if (VAR_433.substr(29, 8) < VAR_493.substr(16, 8) || VAR_433.substr(29, 8) < VAR_586.substr(5, 8)) {
            VAR_451 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_451) == 0) {
        if (VAR_493.substr(40, 8) > "00000000") {
            if (VAR_433.substr(29, 8) >= VAR_493.substr(40, 8)) {
                VAR_451 = "51";
            }
        }
    }
    if (to_int(VAR_451) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_448, VAR_433 + 37)) */) {
            VAR_451 = "58";
        }
    }
    if (to_int(VAR_451) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_442, VAR_433 + 27)) */ || to_int(VAR_433) > 60) {
            VAR_451 = "61";
        }
    }
    if (to_int(VAR_451) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_441, VAR_433 + 24)) */ || to_int(VAR_433) == 0 && to_int(h_pr_ipps_pmt_pct) > 0) {
            VAR_451 = "62";
        }
    }
    if (to_int(VAR_451) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_433 + 27, 2, cob_get_llint (COB_SET_DATA (f_441, VAR_433 + 24)), 0) > 0 */) {
            VAR_451 = "62";
        }
    }
    if (to_int(VAR_451) == 0) {
    ...
    if (to_int(VAR_451) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_583, VAR_493 + 207)) */) {
            h_pr_ipps_pmt_pct.replace(153, 5, VAR_493.substr(207, 5));
        } else {
            h_pr_ipps_pmt_pct.replace(153, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_451) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_548, VAR_493 + 91)) */) {
            h_pr_ipps_pmt_pct.replace(148, 5, VAR_493.substr(91, 5));
        } else {
            h_pr_ipps_pmt_pct.replace(148, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_451) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_549, VAR_493 + 96)) */) {
            h_pr_ipps_pmt_pct.replace(158, 5, VAR_493.substr(96, 5));
        } else {
            h_pr_ipps_pmt_pct.replace(158, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_451) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_552, VAR_493 + 110)) */) {
            h_pr_ipps_pmt_pct.replace(167, 4, VAR_493.substr(110, 4));
        } else {
            h_pr_ipps_pmt_pct.replace(167, 4, std::string(4, '0'));
        }
    }
    if (to_int(VAR_451) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_553, VAR_493 + 114)) */) {
            h_pr_ipps_pmt_pct.replace(171, 4, VAR_493.substr(114, 4));
        } else {
...
void p_1200_days_used() {
    if (to_int(VAR_433) > 0 && to_int(h_pr_ipps_pmt_pct) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_433 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_451.replace(106, 3, h_pr_ipps_pmt_pct.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_pr_ipps_pmt_pct) > 0 && to_int(VAR_433) == 0) {
            if (h_pr_ipps_pmt_pct.substr(3, 3) > h_pr_ipps_pmt_pct.substr(0, 3)) {
                VAR_451.replace(103, 3, h_pr_ipps_pmt_pct.substr(0, 3));
            } else {
                VAR_451.replace(103, 3, h_pr_ipps_pmt_pct.substr(3, 3));
            }
        } else {
            if (to_int(h_pr_ipps_pmt_pct) > 0 && to_int(VAR_433) > 0) {
                if (h_pr_ipps_pmt_pct.substr(3, 3) > h_pr_ipps_pmt_pct.substr(0, 3)) {
                    VAR_451.replace(103, 3, h_pr_ipps_pmt_pct.substr(0, 3));
                    VAR_451.replace(106, 3, std::string(3, '0'));
                } else {
...
void p_1700_edit_drg_code() {
    VAR_451.replace(95, 3, VAR_433.substr(18, 3));
    if (to_int(VAR_451) == 0) {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_25 + 15LL * ((cob_s64_t)(wwm_indx) - 1), VAR_451 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_205;
...
void p_1800_edit_ipps_drg_code() {
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_439, VAR_433 + 18)) */) {
        VAR_451 = "54";
    }
    if (false /* TODO: memcmp (VAR_433 + 29, VAR_210 + 8128LL * ((cob_s64_t)(dx5) - 1), 8) >= 0 */ && to_int(VAR_451) == 0) {
        // dx6 = cob_get_numdisp (b_433 + 18, 3);
...
void p_2000_assemble_pps_variables() {
    if (false /* cob_cmp >= 0 */) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_591, VAR_586 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_591, VAR_586 + 25), 0LL) > 0 */) {
            // MOVE to computed field
        } else {
            VAR_451 = "52";
        }
    } else if (false /* cob_cmp < 0 */ && false /* cob_cmp >= 0 */) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_590, VAR_586 + 19)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_590, VAR_586 + 19), 0LL) > 0 */) {
            // MOVE to computed field
        } else {
            VAR_451 = "52";
        }
    ...
    if (VAR_493.at(137) == '1') {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_569, VAR_493 + 154)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_569, VAR_493 + 154), 0LL) > 0 */) {
            VAR_451.replace(15, 6, VAR_493.substr(154, 6));
        } else {
            VAR_451 = "52";
        }
    }
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_550, VAR_493 + 101)) */) {
        VAR_451 = "65";
    }
    // MOVE to computed field
    if (to_int(VAR_451) > 0 && to_int(VAR_451) < 6) {
    } else {
        VAR_451 = "72";
    }
    h_blend_fac = "0";
...
void p_3000_calc_payment() {
    if (to_int(VAR_493) == 2 || to_int(VAR_493) == 12) {
        VAR_451.replace(110, 4, VAR_493.substr(87, 4));
    } else {
        VAR_451.replace(110, 4, "1000");
    }
    h_labor_portion = to_string(to_num(0) * to_num(1));
    h_nonlabor_portion = to_string(to_num(0) * to_num(1));
    h_pr_ipps_pmt_pct.replace(357, 9, VAR_451.substr(41, 9));
...
void p_3400_short_stay() {
    if (VAR_493.substr(10, 6) == "332006") {
        p_4000_special_provider();
    } else {
        h_pr_ipps_pmt_pct.replace(29, 9, VAR_451.substr(68, 9));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_602, VAR_592 + 15)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_602, VAR_592 + 15), 0LL) > 0 */) {
            if (false /* cob_cmp > 0 */) {
    ...
    if (h_pr_ipps_pmt_pct.substr(29, 9) < h_pr_ipps_pmt_pct.substr(20, 9)) {
        if (h_pr_ipps_pmt_pct.substr(29, 9) < VAR_451.substr(41, 9)) {
            VAR_451.replace(41, 9, h_pr_ipps_pmt_pct.substr(29, 9));
            VAR_451 = "20";
            h_pr_ipps_pmt_pct.at(366) = 'Y';
        } else {
        }
    } else {
        if (h_pr_ipps_pmt_pct.substr(20, 9) < VAR_451.substr(41, 9)) {
            VAR_451.replace(41, 9, h_pr_ipps_pmt_pct.substr(20, 9));
            VAR_451 = "21";
    ...
    if (VAR_493.substr(10, 6) != "332006") {
        if (false /* cob_cmp > 0 */) {
            if (h_pr_ipps_pmt_pct.substr(280, 9) < VAR_451.substr(41, 9)) {
                VAR_451.replace(41, 9, h_pr_ipps_pmt_pct.substr(280, 9));
                VAR_451 = std::string(2, static_cast<char>(50));
            ...
            if (h_pr_ipps_pmt_pct.substr(262, 9) < VAR_451.substr(41, 9)) {
                VAR_451.replace(41, 9, h_pr_ipps_pmt_pct.substr(262, 9));
                VAR_451 = "26";
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(VAR_493) == 2 || to_int(VAR_493) == 12) {
        h_pr_ipps_pmt_pct.replace(289, 4, VAR_493.substr(87, 4));
    } else {
    ...
    if (VAR_592.at(5) == 'L') {
        h_pr_ipps_pmt_pct.replace(241, 3, "103");
    } else {
...
void p_4000_special_provider() {
    if (VAR_433.substr(29, 8) >= "20030701" && VAR_433.substr(29, 8) < "20040101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_433.substr(29, 8) >= "20040101" && VAR_433.substr(29, 8) < "20050101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_433.substr(29, 8) >= "20050101" && VAR_433.substr(29, 8) < "20060101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_433.substr(29, 8) >= "20060101" && VAR_433.substr(29, 8) < "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_433.substr(29, 8) >= "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
}
...
void p_7000_calc_outlier() {
    if (VAR_451.substr(68, 9) > VAR_451.substr(86, 9)) {
    }
    if (VAR_433.at(46) == '1') {
        // MOVE "0" to computed field
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_459, VAR_451 + 29), 0LL) > 0 */ && to_int(VAR_451) == 21) {
        VAR_451 = "24";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_459, VAR_451 + 29), 0LL) > 0 */ && to_int(VAR_451) == 22) {
        VAR_451 = "25";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_459, VAR_451 + 29), 0LL) > 0 */ && to_int(VAR_451) == 26) {
        VAR_451 = "27";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_459, VAR_451 + 29), 0LL) > 0 */ && to_int(VAR_451) == 0) {
        VAR_451 = "01";
    }
    if (to_int(VAR_451) == 0 || to_int(VAR_451) == 20 || to_int(VAR_451) == 21 || to_int(VAR_451) == 22 || to_int(VAR_451) == 26) {
        if (false /* cob_cmp > 0 */) {
            VAR_451.replace(106, 3, std::string(3, '0'));
        } else {
        }
    }
    if (to_int(VAR_451) == 1 || to_int(VAR_451) == 24 || to_int(VAR_451) == 25 || to_int(VAR_451) == 27 || VAR_451.at(161) == 'Y') {
        if (VAR_433.substr(24, 3) < h_pr_ipps_pmt_pct.substr(0, 3) || VAR_451.at(161) == 'Y' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_550, VAR_493 + 101), 0LL) != 0 */) {
            if (VAR_451.substr(162, 2) == "PC") {
                VAR_451 = "67";
            }
        } else {
        }
...
void p_8000_blend() {
    ...
    if (to_int(VAR_451) == 20 || to_int(VAR_451) == 21 || to_int(VAR_451) == 22 || to_int(VAR_451) == 26 && to_int(h_pr_ipps_pmt_pct) > 0) {
    } else {
        if (to_int(VAR_451) == 24 || to_int(VAR_451) == 25 || to_int(VAR_451) == 27 && to_int(h_pr_ipps_pmt_pct) > 0) {
        } else {
        }
    }
}
...
void p_9000_move_results() {
    if (to_int(VAR_451) < 50) {
        VAR_451.replace(38, 3, h_pr_ipps_pmt_pct.substr(0, 3));
        VAR_451.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_451.replace(11, 4, std::string(4, ' '));
        VAR_451.replace(15, 80, std::string(80, '0'));
        VAR_451.replace(95, 8, std::string(8, ' '));
