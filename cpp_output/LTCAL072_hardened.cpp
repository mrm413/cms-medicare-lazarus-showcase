...
std::string VAR_537; // Auto-declared by LAZARUS healer

std::string c_21; // Auto-declared by LAZARUS healer

std::string VAR_531; // Auto-declared by LAZARUS healer

std::string VAR_379; // Auto-declared by LAZARUS healer

std::string VAR_438; // Auto-declared by LAZARUS healer

std::string VAR_431; // Auto-declared by LAZARUS healer

std::string VAR_397; // Auto-declared by LAZARUS healer
...
void p_0100_initial_routine() {
    VAR_397 = std::string(2, '0');
    VAR_397.replace(11, 4, std::string(4, ' '));
    VAR_397.replace(15, 80, std::string(80, '0'));
    VAR_397.replace(95, 8, std::string(8, ' '));
    VAR_397.replace(103, 11, std::string(11, '0'));
    VAR_397.replace(118, 23, std::string(23, '0'));
    VAR_431 = std::string(5, ' ');
    ...
    VAR_431 = VAR_438.substr(139, 5);
    VAR_397.replace(118, 6, "075665");
    VAR_397.replace(124, 6, "024335");
    VAR_397.replace(130, 7, "3808604");
    h_pr_ipps_pmt_pct.replace(64, 9, "001488700");
    VAR_397.replace(137, 4, "1000");
    h_pr_ipps_pmt_pct.replace(339, 5, "42065");
    h_pr_ipps_pmt_pct.replace(344, 5, "20193");
    h_pr_ipps_pmt_pct.replace(349, 3, "075");
    h_pr_ipps_pmt_pct.replace(352, 3, "025");
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_547, VAR_537 + 15), 1LL) > 0 */) {
        h_pr_ipps_pmt_pct.replace(297, 7, "0329784");
        h_pr_ipps_pmt_pct.replace(304, 7, "0143363");
    } else {
        h_pr_ipps_pmt_pct.replace(297, 7, "0293352");
        h_pr_ipps_pmt_pct.replace(304, 7, "0179795");
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_548, VAR_537 + 21), 1LL) > 0 */) {
        h_pr_ipps_pmt_pct.replace(311, 7, "0140246");
        h_pr_ipps_pmt_pct.replace(318, 7, "0085957");
    } else {
        h_pr_ipps_pmt_pct.replace(311, 7, "0132781");
        h_pr_ipps_pmt_pct.replace(318, 7, "0093422");
    }
}
...
void p_1000_edit_the_bill_info() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_386, VAR_379 + 21)) */ && to_int(VAR_379) > 0) {
        h_pr_ipps_pmt_pct = VAR_379.substr(21, 3);
    } else {
        VAR_397 = "56";
    }
    if (to_int(VAR_397) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_492, VAR_438 + 87)) */) {
            VAR_397 = "50";
        }
    }
    if (to_int(VAR_397) == 0) {
    ...
    if (to_int(VAR_397) == 0) {
        if (VAR_379.substr(29, 8) < VAR_438.substr(16, 8) || VAR_379.substr(29, 8) < VAR_531.substr(5, 8)) {
            VAR_397 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_397) == 0) {
        if (VAR_438.substr(40, 8) > "00000000") {
            if (VAR_379.substr(29, 8) >= VAR_438.substr(40, 8)) {
                VAR_397 = "51";
            }
        }
    }
    if (to_int(VAR_397) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_394, VAR_379 + 37)) */) {
            VAR_397 = "58";
        }
    }
    if (to_int(VAR_397) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_388, VAR_379 + 27)) */ || to_int(VAR_379) > 60) {
            VAR_397 = "61";
        }
    }
    if (to_int(VAR_397) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_387, VAR_379 + 24)) */ || to_int(VAR_379) == 0 && to_int(h_pr_ipps_pmt_pct) > 0) {
            VAR_397 = "62";
        }
    }
    if (to_int(VAR_397) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_379 + 27, 2, cob_get_llint (COB_SET_DATA (f_387, VAR_379 + 24)), 0) > 0 */) {
            VAR_397 = "62";
        }
    }
    if (to_int(VAR_397) == 0) {
    ...
    if (to_int(VAR_397) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_528, VAR_438 + 207)) */) {
            h_pr_ipps_pmt_pct.replace(153, 5, VAR_438.substr(207, 5));
        } else {
            h_pr_ipps_pmt_pct.replace(153, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_397) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_493, VAR_438 + 91)) */) {
            h_pr_ipps_pmt_pct.replace(148, 5, VAR_438.substr(91, 5));
        } else {
            h_pr_ipps_pmt_pct.replace(148, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_397) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_494, VAR_438 + 96)) */) {
            h_pr_ipps_pmt_pct.replace(158, 5, VAR_438.substr(96, 5));
        } else {
            h_pr_ipps_pmt_pct.replace(158, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_397) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_497, VAR_438 + 110)) */) {
            h_pr_ipps_pmt_pct.replace(167, 4, VAR_438.substr(110, 4));
        } else {
            h_pr_ipps_pmt_pct.replace(167, 4, std::string(4, '0'));
        }
    }
    if (to_int(VAR_397) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_498, VAR_438 + 114)) */) {
            h_pr_ipps_pmt_pct.replace(171, 4, VAR_438.substr(114, 4));
        } else {
...
void p_1200_days_used() {
    if (to_int(VAR_379) > 0 && to_int(h_pr_ipps_pmt_pct) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_379 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_397.replace(106, 3, h_pr_ipps_pmt_pct.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_pr_ipps_pmt_pct) > 0 && to_int(VAR_379) == 0) {
            if (h_pr_ipps_pmt_pct.substr(3, 3) > h_pr_ipps_pmt_pct.substr(0, 3)) {
                VAR_397.replace(103, 3, h_pr_ipps_pmt_pct.substr(0, 3));
            } else {
                VAR_397.replace(103, 3, h_pr_ipps_pmt_pct.substr(3, 3));
            }
        } else {
            if (to_int(h_pr_ipps_pmt_pct) > 0 && to_int(VAR_379) > 0) {
                if (h_pr_ipps_pmt_pct.substr(3, 3) > h_pr_ipps_pmt_pct.substr(0, 3)) {
                    VAR_397.replace(103, 3, h_pr_ipps_pmt_pct.substr(0, 3));
                    VAR_397.replace(106, 3, std::string(3, '0'));
                } else {
...
void p_1700_edit_drg_code() {
    VAR_397.replace(95, 3, VAR_379.substr(18, 3));
    if (to_int(VAR_397) == 0) {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_25 + 11LL * ((cob_s64_t)(wwm_indx) - 1), VAR_397 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_158;
...
void p_1800_edit_ipps_drg_code() {
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_385, VAR_379 + 18)) */) {
        VAR_397 = "54";
    }
    if (false /* TODO: memcmp (VAR_379 + 29, VAR_162 + 7848LL * ((cob_s64_t)(dx5) - 1), 8) >= 0 */ && to_int(VAR_397) == 0) {
        // dx6 = cob_get_numdisp (b_379 + 18, 3);
...
void p_2000_assemble_pps_variables() {
    if (false /* cob_cmp >= 0 */) {
        if (VAR_379.substr(29, 8) >= VAR_438.substr(24, 8)) {
            if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_536, VAR_531 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_536, VAR_531 + 25), 0LL) > 0 */) {
                // MOVE to computed field
            } else {
                VAR_397 = "52";
            }
        } else {
            if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_535, VAR_531 + 19)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_535, VAR_531 + 19), 0LL) > 0 */) {
                // MOVE to computed field
            } else {
                VAR_397 = "52";
            }
        ...
        if (VAR_379.substr(29, 8) >= VAR_438.substr(24, 8)) {
            ...
            if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_534, VAR_531 + 13)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_534, VAR_531 + 13), 0LL) > 0 */) {
                // MOVE to computed field
            } else {
                VAR_397 = "52";
            }
    ...
    if (VAR_438.at(137) == '1') {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_514, VAR_438 + 154)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_514, VAR_438 + 154), 0LL) > 0 */) {
            VAR_397.replace(15, 6, VAR_438.substr(154, 6));
        } else {
            VAR_397 = "52";
        }
    }
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_495, VAR_438 + 101)) */) {
        VAR_397 = "65";
    }
    // MOVE to computed field
    if (to_int(VAR_397) > 0 && to_int(VAR_397) < 6) {
    } else {
        VAR_397 = "72";
    }
    h_blend_fac = "0";
...
void p_3000_calc_payment() {
    if (to_int(VAR_438) == 2 || to_int(VAR_438) == 12) {
        VAR_397.replace(110, 4, VAR_438.substr(87, 4));
    } else {
        VAR_397.replace(110, 4, "1000");
    }
    h_labor_portion = to_string(to_num(0) * to_num(1));
    h_nonlabor_portion = to_string(to_num(0) * to_num(1));
    h_pr_ipps_pmt_pct.replace(357, 9, VAR_397.substr(41, 9));
...
void p_3400_short_stay() {
    if (VAR_438.substr(10, 6) == "332006") {
        p_4000_special_provider();
    } else {
        h_pr_ipps_pmt_pct.replace(29, 9, VAR_397.substr(68, 9));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_547, VAR_537 + 15)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_547, VAR_537 + 15), 0LL) > 0 */) {
    ...
    if (h_pr_ipps_pmt_pct.substr(29, 9) < h_pr_ipps_pmt_pct.substr(20, 9)) {
        if (h_pr_ipps_pmt_pct.substr(29, 9) < VAR_397.substr(41, 9)) {
            VAR_397.replace(41, 9, h_pr_ipps_pmt_pct.substr(29, 9));
            VAR_397 = "02";
            h_pr_ipps_pmt_pct.at(366) = 'Y';
        } else {
        }
    } else {
        if (h_pr_ipps_pmt_pct.substr(20, 9) < VAR_397.substr(41, 9)) {
            VAR_397.replace(41, 9, h_pr_ipps_pmt_pct.substr(20, 9));
            VAR_397 = "02";
    ...
    if (VAR_438.substr(10, 6) != "332006") {
        if (h_pr_ipps_pmt_pct.substr(280, 9) < VAR_397.substr(41, 9)) {
            VAR_397.replace(41, 9, h_pr_ipps_pmt_pct.substr(280, 9));
            VAR_397 = "02";
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(VAR_438) == 2 || to_int(VAR_438) == 12) {
        h_pr_ipps_pmt_pct.replace(289, 4, VAR_438.substr(87, 4));
    } else {
...
void p_4000_special_provider() {
    if (VAR_379.substr(29, 8) >= "20030701" && VAR_379.substr(29, 8) < "20040101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_379.substr(29, 8) >= "20040101" && VAR_379.substr(29, 8) < "20050101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_379.substr(29, 8) >= "20050101" && VAR_379.substr(29, 8) < "20060101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_379.substr(29, 8) >= "20060101" && VAR_379.substr(29, 8) < "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_379.substr(29, 8) >= "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
}
...
void p_7000_calc_outlier() {
    if (VAR_397.substr(68, 9) > VAR_397.substr(86, 9)) {
    }
    if (VAR_379.at(46) == '1') {
        // MOVE "0" to computed field
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_405, VAR_397 + 29), 0LL) > 0 */ && to_int(VAR_397) == 2) {
        VAR_397 = "03";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_405, VAR_397 + 29), 0LL) > 0 */ && to_int(VAR_397) == 0) {
        VAR_397 = "01";
    }
    if (to_int(VAR_397) == 0 || to_int(VAR_397) == 2) {
        if (false /* cob_cmp > 0 */) {
            VAR_397.replace(106, 3, std::string(3, '0'));
        } else {
        }
    }
    if (to_int(VAR_397) == 1 || to_int(VAR_397) == 3) {
        if (VAR_379.substr(24, 3) < h_pr_ipps_pmt_pct.substr(0, 3) || VAR_397.at(161) == 'Y') {
            if (VAR_397.substr(162, 2) == "PC") {
                VAR_397 = "67";
            }
        } else {
        }
...
void p_9000_move_results() {
    if (to_int(VAR_397) < 50) {
        VAR_397.replace(38, 3, h_pr_ipps_pmt_pct.substr(0, 3));
        VAR_397.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_397.replace(11, 4, std::string(4, ' '));
        VAR_397.replace(15, 80, std::string(80, '0'));
        VAR_397.replace(95, 8, std::string(8, ' '));
