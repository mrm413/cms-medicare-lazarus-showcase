...
std::string VAR_545; // Auto-declared by LAZARUS healer

std::string c_23; // Auto-declared by LAZARUS healer

std::string VAR_539; // Auto-declared by LAZARUS healer

std::string VAR_387; // Auto-declared by LAZARUS healer

std::string VAR_446; // Auto-declared by LAZARUS healer

std::string VAR_439; // Auto-declared by LAZARUS healer

std::string VAR_405; // Auto-declared by LAZARUS healer
...
FixedString<50> fed_fy_begin_05;
...
void p_0100_initial_routine() {
    VAR_405 = std::string(2, '0');
    VAR_405.replace(11, 4, std::string(4, ' '));
    VAR_405.replace(15, 80, std::string(80, '0'));
    VAR_405.replace(95, 8, std::string(8, ' '));
    VAR_405.replace(103, 11, std::string(11, '0'));
    VAR_405.replace(118, 23, std::string(23, '0'));
    VAR_439 = std::string(5, ' ');
    ...
    h_pr_ipps_pmt_pct.replace(366, 3, std::string(3, ' '));
    VAR_439 = VAR_446.substr(139, 5);
    VAR_405.replace(118, 6, "075665");
    VAR_405.replace(124, 6, "024335");
    VAR_405.replace(130, 7, "3808604");
    h_pr_ipps_pmt_pct.replace(64, 9, "001488700");
    VAR_405.replace(137, 4, "1000");
    ...
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_555, VAR_545 + 15), 1LL) > 0 */) {
    ...
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_556, VAR_545 + 21), 1LL) > 0 */) {
...
void p_1000_edit_the_bill_info() {
    if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_394, VAR_387 + 21)) */ && to_int(VAR_387) > 0) {
        h_pr_ipps_pmt_pct = VAR_387.substr(21, 3);
    } else {
        VAR_405 = "56";
    }
    if (to_int(VAR_405) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_500, VAR_446 + 87)) */) {
            VAR_405 = "50";
        }
    }
    if (to_int(VAR_405) == 0) {
    ...
    if (to_int(VAR_405) == 0) {
        if (VAR_387.substr(29, 8) < VAR_446.substr(16, 8) || VAR_387.substr(29, 8) < VAR_539.substr(5, 8)) {
            VAR_405 = std::string(2, static_cast<char>(53));
        }
    }
    if (to_int(VAR_405) == 0) {
        if (VAR_446.substr(40, 8) > "00000000") {
            if (VAR_387.substr(29, 8) >= VAR_446.substr(40, 8)) {
                VAR_405 = "51";
            }
        }
    }
    if (to_int(VAR_405) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_402, VAR_387 + 37)) */) {
            VAR_405 = "58";
        }
    }
    if (to_int(VAR_405) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_396, VAR_387 + 27)) */ || to_int(VAR_387) > 60) {
            VAR_405 = "61";
        }
    }
    if (to_int(VAR_405) == 0) {
        if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_395, VAR_387 + 24)) */ || to_int(VAR_387) == 0 && to_int(h_pr_ipps_pmt_pct) > 0) {
            VAR_405 = "62";
        }
    }
    if (to_int(VAR_405) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_387 + 27, 2, cob_get_llint (COB_SET_DATA (f_395, VAR_387 + 24)), 0) > 0 */) {
            VAR_405 = "62";
        }
    }
    if (to_int(VAR_405) == 0) {
    ...
    if (to_int(VAR_405) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_536, VAR_446 + 207)) */) {
            h_pr_ipps_pmt_pct.replace(153, 5, VAR_446.substr(207, 5));
        } else {
            h_pr_ipps_pmt_pct.replace(153, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_405) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_501, VAR_446 + 91)) */) {
            h_pr_ipps_pmt_pct.replace(148, 5, VAR_446.substr(91, 5));
        } else {
            h_pr_ipps_pmt_pct.replace(148, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_405) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_502, VAR_446 + 96)) */) {
            h_pr_ipps_pmt_pct.replace(158, 5, VAR_446.substr(96, 5));
        } else {
            h_pr_ipps_pmt_pct.replace(158, 5, std::string(5, '0'));
        }
    }
    if (to_int(VAR_405) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_505, VAR_446 + 110)) */) {
            h_pr_ipps_pmt_pct.replace(167, 4, VAR_446.substr(110, 4));
        } else {
            h_pr_ipps_pmt_pct.replace(167, 4, std::string(4, '0'));
        }
    }
    if (to_int(VAR_405) == 0) {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_506, VAR_446 + 114)) */) {
            h_pr_ipps_pmt_pct.replace(171, 4, VAR_446.substr(114, 4));
        } else {
...
void p_1200_days_used() {
    if (to_int(VAR_387) > 0 && to_int(h_pr_ipps_pmt_pct) == 0) {
        if (false /* TODO: cob_cmp_numdisp (VAR_387 + 27, 2, cob_get_llint (h_los), 0) > 0 */) {
            VAR_405.replace(106, 3, h_pr_ipps_pmt_pct.substr(0, 3));
        } else {
            // MOVE to computed field
        }
    } else {
        if (to_int(h_pr_ipps_pmt_pct) > 0 && to_int(VAR_387) == 0) {
            if (h_pr_ipps_pmt_pct.substr(3, 3) > h_pr_ipps_pmt_pct.substr(0, 3)) {
                VAR_405.replace(103, 3, h_pr_ipps_pmt_pct.substr(0, 3));
            } else {
                VAR_405.replace(103, 3, h_pr_ipps_pmt_pct.substr(3, 3));
            }
        } else {
            if (to_int(h_pr_ipps_pmt_pct) > 0 && to_int(VAR_387) > 0) {
                if (h_pr_ipps_pmt_pct.substr(3, 3) > h_pr_ipps_pmt_pct.substr(0, 3)) {
                    VAR_405.replace(103, 3, h_pr_ipps_pmt_pct.substr(0, 3));
                    VAR_405.replace(106, 3, std::string(3, '0'));
                } else {
...
void p_1700_edit_drg_code() {
    VAR_405.replace(95, 3, VAR_387.substr(18, 3));
    if (to_int(VAR_405) == 0) {
        while (true) {
            ...
            if (false /* TODO: (ret = memcmp (VAR_25 + 11LL * ((cob_s64_t)(wwm_indx) - 1), VAR_405 + 95, 3)) == 0 */) {
                p_1750_find_value();
                break;
            }
            // if (ret < 0) head = b_161;
...
void p_1800_edit_ipps_drg_code() {
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_393, VAR_387 + 18)) */) {
        VAR_405 = "54";
    }
    if (false /* TODO: memcmp (VAR_387 + 29, VAR_165 + 8128LL * ((cob_s64_t)(dx5) - 1), 8) >= 0 */ && to_int(VAR_405) == 0) {
        // dx6 = cob_get_numdisp (b_387 + 18, 3);
...
void p_2000_assemble_pps_variables() {
    if (false /* cob_cmp >= 0 */) {
        if (VAR_387.substr(29, 8) >= VAR_446.substr(24, 8)) {
            if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_544, VAR_539 + 25)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_544, VAR_539 + 25), 0LL) > 0 */) {
                // MOVE to computed field
            } else {
                VAR_405 = "52";
            }
        } else {
            if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_543, VAR_539 + 19)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_543, VAR_539 + 19), 0LL) > 0 */) {
                // MOVE to computed field
            } else {
                VAR_405 = "52";
            }
        ...
        if (VAR_387.substr(29, 8) >= VAR_446.substr(24, 8)) {
            ...
            if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_542, VAR_539 + 13)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_542, VAR_539 + 13), 0LL) > 0 */) {
                // MOVE to computed field
            } else {
                VAR_405 = "52";
            }
    ...
    if (VAR_446.at(137) == '1') {
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_522, VAR_446 + 154)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_522, VAR_446 + 154), 0LL) > 0 */) {
            VAR_405.replace(15, 6, VAR_446.substr(154, 6));
        } else {
            VAR_405 = "52";
        }
    }
    if (false /* TODO: !cob_is_numeric (COB_SET_DATA (f_503, VAR_446 + 101)) */) {
        VAR_405 = "65";
    }
    // MOVE to computed field
    if (to_int(VAR_405) > 0 && to_int(VAR_405) < 6) {
    } else {
        VAR_405 = "72";
    }
    h_blend_fac = "0";
...
void p_3000_calc_payment() {
    if (to_int(VAR_446) == 2 || to_int(VAR_446) == 12) {
        VAR_405.replace(110, 4, VAR_446.substr(87, 4));
    } else {
        VAR_405.replace(110, 4, "1000");
    }
    h_labor_portion = to_string(to_num(0) * to_num(1));
    h_nonlabor_portion = to_string(to_num(0) * to_num(1));
    h_pr_ipps_pmt_pct.replace(357, 9, VAR_405.substr(41, 9));
...
void p_3400_short_stay() {
    if (VAR_446.substr(10, 6) == "332006") {
        p_4000_special_provider();
    } else {
        h_pr_ipps_pmt_pct.replace(29, 9, VAR_405.substr(68, 9));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
        if (false /* TODO: cob_is_numeric (COB_SET_DATA (f_555, VAR_545 + 15)) */ && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_555, VAR_545 + 15), 0LL) > 0 */) {
    ...
    if (h_pr_ipps_pmt_pct.substr(29, 9) < h_pr_ipps_pmt_pct.substr(20, 9)) {
        if (h_pr_ipps_pmt_pct.substr(29, 9) < VAR_405.substr(41, 9)) {
            VAR_405.replace(41, 9, h_pr_ipps_pmt_pct.substr(29, 9));
            VAR_405 = "20";
            h_pr_ipps_pmt_pct.at(366) = 'Y';
        } else {
        }
    } else {
        if (h_pr_ipps_pmt_pct.substr(20, 9) < VAR_405.substr(41, 9)) {
            VAR_405.replace(41, 9, h_pr_ipps_pmt_pct.substr(20, 9));
            VAR_405 = "21";
    ...
    if (VAR_446.substr(10, 6) != "332006") {
        if (h_pr_ipps_pmt_pct.substr(280, 9) < VAR_405.substr(41, 9)) {
            VAR_405.replace(41, 9, h_pr_ipps_pmt_pct.substr(280, 9));
            VAR_405 = std::string(2, static_cast<char>(50));
...
void p_3650_ss_ipps_comp_pmt() {
    ...
    if (to_int(VAR_446) == 2 || to_int(VAR_446) == 12) {
        h_pr_ipps_pmt_pct.replace(289, 4, VAR_446.substr(87, 4));
    } else {
...
void p_4000_special_provider() {
    if (VAR_387.substr(29, 8) >= "20030701" && VAR_387.substr(29, 8) < "20040101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_387.substr(29, 8) >= "20040101" && VAR_387.substr(29, 8) < "20050101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_387.substr(29, 8) >= "20050101" && VAR_387.substr(29, 8) < "20060101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_387.substr(29, 8) >= "20060101" && VAR_387.substr(29, 8) < "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
    if (VAR_387.substr(29, 8) >= "20070101") {
        h_ss_cost = to_string(to_num(0) * to_num(1));
        h_ss_pay_amt = to_string(to_num(0) * to_num(1));
    }
}
...
void p_7000_calc_outlier() {
    if (VAR_405.substr(68, 9) > VAR_405.substr(86, 9)) {
    }
    if (VAR_387.at(46) == '1') {
        // MOVE "0" to computed field
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_413, VAR_405 + 29), 0LL) > 0 */ && to_int(VAR_405) == 21) {
        VAR_405 = "24";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_413, VAR_405 + 29), 0LL) > 0 */ && to_int(VAR_405) == 22) {
        VAR_405 = "25";
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_413, VAR_405 + 29), 0LL) > 0 */ && to_int(VAR_405) == 0) {
        VAR_405 = "01";
    }
    if (to_int(VAR_405) == 0 || to_int(VAR_405) == 20 || to_int(VAR_405) == 21 || to_int(VAR_405) == 22) {
        if (false /* cob_cmp > 0 */) {
            VAR_405.replace(106, 3, std::string(3, '0'));
        } else {
        }
    }
    if (to_int(VAR_405) == 1 || to_int(VAR_405) == 24 || to_int(VAR_405) == 25 || VAR_405.at(161) == 'Y') {
        if (VAR_387.substr(24, 3) < h_pr_ipps_pmt_pct.substr(0, 3) || VAR_405.at(161) == 'Y' && false /* TODO: cob_cmp_llint (COB_SET_DATA (f_503, VAR_446 + 101), 0LL) != 0 */) {
            if (VAR_405.substr(162, 2) == "PC") {
                VAR_405 = "67";
            }
        } else {
        }
...
void p_8000_blend() {
    ...
    if (to_int(VAR_405) == 20 || to_int(VAR_405) == 21 || to_int(VAR_405) == 22 && to_int(h_pr_ipps_pmt_pct) > 0) {
    } else {
        if (to_int(VAR_405) == 24 || to_int(VAR_405) == 25 && to_int(h_pr_ipps_pmt_pct) > 0) {
        } else {
        }
    }
}
...
void p_9000_move_results() {
    if (to_int(VAR_405) < 50) {
        VAR_405.replace(38, 3, h_pr_ipps_pmt_pct.substr(0, 3));
        VAR_405.replace(98, 5, cal_version.substr(0, 5));
    } else {
        VAR_405.replace(11, 4, std::string(4, ' '));
        VAR_405.replace(15, 80, std::string(80, '0'));
        VAR_405.replace(95, 8, std::string(8, ' '));
