...
void p_9000_move_results() {
    if (to_int(VAR_167) < 50) {
        ...
        VAR_167.replace(69, 4, h_drug_addon.substr(78, 4));
        VAR_167.replace(73, 5, h_drug_addon.substr(82, 5));
        VAR_167.replace(78, 5, h_drug_addon.substr(87, 5));
        if (VAR_57.at(122) == 'T') {
            VAR_57.replace(229, 5, h_drug_addon.substr(106, 5));
            // MOVE to computed field
            // MOVE to computed field
            VAR_57.replace(298, 3, cbsa_blend_pct.substr(0, 3));
            VAR_57.replace(295, 3, msa_blend_pct.substr(0, 3));
            VAR_57.replace(246, 6, h_drug_addon.substr(51, 6));
            VAR_57.replace(260, 3, h_drug_addon.substr(75, 3));
            // MOVE to computed field
