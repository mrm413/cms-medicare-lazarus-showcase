...
void p_0100_initial_routine() {
    ...
    VAR_663.replace(118, 6, "075662");
    VAR_663.replace(124, 6, "024338");
    VAR_663.replace(130, 7, "3911436");
    h_ipps_wage_index.replace(64, 9, "002296000");
    VAR_663.replace(137, 4, "1000");
    h_ipps_wage_index.replace(339, 5, "42417");
    h_ipps_wage_index.replace(344, 5, "19877");
    h_ipps_wage_index.replace(349, 3, "075");
    h_ipps_wage_index.replace(352, 3, "025");
    if (to_int(h_ipps_wage_index) > 1) {
        h_ipps_wage_index.replace(297, 7, "0357450");
        h_ipps_wage_index.replace(304, 7, "0155391");
    } else {
        h_ipps_wage_index.replace(297, 7, "0317961");
        h_ipps_wage_index.replace(304, 7, "0194880");
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_815, VAR_804 + 21), 1LL) > 0 */) {
        h_ipps_wage_index.replace(311, 7, "0150782");
        h_ipps_wage_index.replace(318, 7, "0092415");
    } else {
        h_ipps_wage_index.replace(311, 7, "0142757");
        h_ipps_wage_index.replace(318, 7, "0100440");
    }
}
