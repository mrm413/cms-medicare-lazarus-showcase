...
void p_1000_validate_bill_elements() {
    ...
    if (to_int(VAR_294) == 0) {
        if (false /* TODO: memcmp (VAR_184 + 227, COB_SPACES_ALPHABETIC, 2) == 0 */ || VAR_184.substr(227, 2) == "10" || VAR_184.substr(227, 2) == "20" || VAR_184.substr(227, 2) == "40" || VAR_184.substr(227, 2) == "50" || VAR_184.substr(227, 2) == "60") {
        } else {
            VAR_294 = "81";
        }
    }
...
void p_1200_initialization() {
    ...
    h_bun_rural_multiplier = std::string(189, '0');
    h_bun_rural_multiplier.replace(189, 15, std::string(15, ' '));
    h_bun_rural_multiplier.replace(204, 46, std::string(46, '0'));
    h_bun_rural_multiplier.at(250) = ' ';
    h_bun_rural_multiplier.replace(251, 4, std::string(4, '0'));
    h_out_rural_multiplier = std::string(125, '0');
    paid_return_code_trackers = std::string(8, ' ');
    h_bun_rural_multiplier.at(250) = ' ';
    if (VAR_184.at(106) == ' ') {
        h_bun_rural_multiplier.replace(208, 4, "1000");
    } else {
        if (VAR_184.at(106) == '1') {
            h_bun_rural_multiplier.replace(208, 4, "0995");
        } else {
            if (VAR_184.at(106) == '2') {
                h_bun_rural_multiplier.replace(208, 4, "0990");
            } else {
                if (VAR_184.at(106) == '3') {
                    h_bun_rural_multiplier.replace(208, 4, "0985");
                } else {
                    h_bun_rural_multiplier.replace(208, 4, "0980");
                }
            }
        }
    }
    if (false /* TODO: memcmp (VAR_184 + 227, COB_SPACES_ALPHABETIC, 2) == 0 */) {
        ...
        h_bun_rural_multiplier.at(250) = 'Y';
        h_bun_rural_multiplier.replace(190, 2, VAR_184.substr(213, 2));
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        h_bun_rural_multiplier.replace(202, 2, VAR_184.substr(227, 2));
...
void p_2000_calculate_bundled_factors() {
    if (to_int(h_bmi) < 13) {
        if (VAR_184.substr(2, 4) == "0821" || VAR_184.substr(2, 4) == "0881") {
            h_bun_rural_multiplier.replace(20, 4, sb_age_lt_13_pd_mode.substr(20, 4));
        } else {
            h_bun_rural_multiplier.replace(20, 4, sb_age_lt_13_pd_mode.substr(16, 4));
        }
    } else {
        if (to_int(h_bmi) < 18) {
            if (VAR_184.substr(2, 4) == "0821" || VAR_184.substr(2, 4) == "0881") {
                h_bun_rural_multiplier.replace(20, 4, sb_age_lt_13_pd_mode.substr(28, 4));
            } else {
                h_bun_rural_multiplier.replace(20, 4, sb_age_lt_13_pd_mode.substr(24, 4));
            }
        } else {
            if (to_int(h_bmi) < 45) {
                h_bun_rural_multiplier.replace(20, 4, cm_onset_le_120.substr(56, 4));
            } else {
                if (to_int(h_bmi) < 60) {
                    h_bun_rural_multiplier.replace(20, 4, cm_onset_le_120.substr(60, 4));
                } else {
                    if (to_int(h_bmi) < 70) {
                        h_bun_rural_multiplier.replace(20, 4, cm_onset_le_120.substr(64, 4));
                    } else {
                        if (to_int(h_bmi) < 80) {
                            h_bun_rural_multiplier.replace(20, 4, cm_onset_le_120.substr(68, 4));
                        } else {
                            h_bun_rural_multiplier.replace(20, 4, cm_onset_le_120.substr(72, 4));
                        }
                    }
                }
            }
    ...
    if (false /* TODO: memcmp (VAR_184 + 156, COB_ZEROES_ALPHABETIC, 8) > 0 */) {
        ...
        if (to_int(h_bmi) > 17) {
            if (to_int(h_bun_rural_multiplier) > 120) {
    ...
    if (false /* TODO: memcmp (VAR_184 + 227, COB_SPACES_ALPHABETIC, 2) == 0 */) {
        if (to_int(h_bmi) < 18) {
            h_bun_rural_multiplier.replace(53, 4, "1000");
            ...
            if (to_int(h_bun_onset_factor) == to_int(cm_onset_le_120)) {
                ...
                h_bun_rural_multiplier.replace(53, 4, h_bun_rural_multiplier.substr(185, 4));
            }
        }
    } else {
        if (VAR_184.substr(227, 2) == "10") {
            ...
            if (VAR_184.substr(227, 2) == "20") {
                h_bun_rural_multiplier.replace(53, 4, cm_onset_le_120.substr(92, 4));
                VAR_294.replace(112, 2, "20");
            } else {
                if (VAR_184.substr(227, 2) == "40") {
                    h_bun_rural_multiplier.replace(53, 4, cm_onset_le_120.substr(88, 4));
    ...
    if (VAR_184.at(104) == 'Y') {
        if (to_int(h_bmi) > 17) {
            h_bun_rural_multiplier.replace(204, 4, cm_onset_le_120.substr(104, 4));
            paid_return_code_trackers.at(4) = 'Y';
        } else {
            h_bun_rural_multiplier.replace(204, 4, "1000");
        }
    } else {
        h_bun_rural_multiplier.replace(204, 4, "1000");
    }
    if (false /* cob_cmp < 0 */ && to_int(h_bmi) > 17) {
        h_bun_rural_multiplier.replace(251, 4, cm_onset_le_120.substr(108, 4));
    } else {
        h_bun_rural_multiplier.replace(251, 4, "1000");
    }
    h_bun_adjusted_base_wage_amt = to_string(to_num(0) * to_num(1));
    if (VAR_184.substr(0, 2) == "73") {
        if (to_int(h_bun_onset_factor) == to_int(cm_onset_le_120)) {
            h_bun_rural_multiplier.replace(68, 11, std::string(11, '0'));
        } else {
        ...
        if (VAR_184.substr(0, 2) == "74" && VAR_184.substr(2, 4) == "0841" || VAR_184.substr(2, 4) == "0851") {
            ...
            h_bun_rural_multiplier.replace(68, 11, std::string(11, '0'));
            h_bun_rural_multiplier.replace(79, 11, std::string(11, '0'));
        }
    }
    if (VAR_184.substr(0, 2) == "74" && VAR_184.substr(2, 4) == "0841" || VAR_184.substr(2, 4) == "0851") {
...
void p_2100_calc_comorbid_adjust() {
    h_bun_rural_multiplier.at(189) = 'N';
    h_bun_rural_multiplier.replace(185, 4, "1000");
    VAR_294.replace(112, 2, "10");
    h_bun_rural_multiplier.replace(212, 4, "0001");
    while (true) {
        if (to_int(h_bun_rural_multiplier) > 6 || h_bun_rural_multiplier.at(189) == 'Y') break;
        if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (h_bun_rural_multiplier + 212, 4)) - 1), (cob_u8_ptr)"MA", 2) == 0 */) {
            h_bun_rural_multiplier.replace(185, 4, cm_onset_le_120.substr(92, 4));
            paid_return_code_trackers.at(1) = 'Y';
            VAR_294.replace(112, 2, "20");
        } else {
            if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (h_bun_rural_multiplier + 212, 4)) - 1), (cob_u8_ptr)"MC", 2) == 0 */) {
                if (cm_onset_le_120.substr(88, 4) > h_bun_rural_multiplier.substr(185, 4)) {
                    h_bun_rural_multiplier.replace(185, 4, cm_onset_le_120.substr(88, 4));
                    paid_return_code_trackers.at(1) = 'Y';
                    VAR_294.replace(112, 2, "40");
                }
            } else {
                if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (h_bun_rural_multiplier + 212, 4)) - 1), (cob_u8_ptr)"MD", 2) == 0 */) {
                    if (cm_onset_le_120.substr(100, 4) > h_bun_rural_multiplier.substr(185, 4)) {
                        h_bun_rural_multiplier.replace(185, 4, cm_onset_le_120.substr(100, 4));
                        paid_return_code_trackers.at(2) = 'Y';
                        VAR_294.replace(112, 2, "50");
                    }
                } else {
                    if (false /* TODO: memcmp (VAR_184 + 213 + 2LL * ((cob_s64_t)(cob_get_numdisp (h_bun_rural_multiplier + 212, 4)) - 1), (cob_u8_ptr)"ME", 2) == 0 */) {
                        if (cm_onset_le_120.substr(96, 4) > h_bun_rural_multiplier.substr(185, 4)) {
                            h_bun_rural_multiplier.replace(185, 4, cm_onset_le_120.substr(96, 4));
                            paid_return_code_trackers.at(2) = 'Y';
...
void p_2500_calc_outlier_factors() {
    ...
    VAR_294.replace(277, 11, h_out_rural_multiplier.substr(99, 11));
    if (VAR_184.substr(0, 2) == "74" && VAR_184.substr(2, 4) == "0841" || VAR_184.substr(2, 4) == "0851") {
        h_out_payment = to_string(to_num(0) * to_num(1));
    }
}
...
void p_3100_low_vol_out_pps_payment() {
    ...
    if (to_int(h_bmi) < 18) {
        ...
        h_out_rural_multiplier.replace(46, 6, loss_sharing_pct_gt_17.substr(12, 6));
        if (h_out_rural_multiplier.substr(66, 11) > h_bun_rural_multiplier.substr(163, 11)) {
            h_lv_out_payment = to_string(to_num(0) * to_num(1));
            h_out_loss_sharing_pct = loss_sharing_pct_lt_18;
        } else {
            h_bun_rural_multiplier.replace(174, 11, std::string(11, '0'));
            h_out_rural_multiplier.replace(52, 3, std::string(3, '0'));
        }
    } else {
        h_lv_out_predicted_map = to_string(to_num(0) + to_num(1));
    ...
    VAR_294.replace(277, 11, h_bun_rural_multiplier.substr(174, 11));
    if (VAR_184.substr(0, 2) == "74" && VAR_184.substr(2, 4) == "0841" || VAR_184.substr(2, 4) == "0851") {
        h_lv_out_payment = to_string(to_num(0) * to_num(1));
    }
}
...
void p_9100_move_results() {
    if (false /* TODO: (*(h_bun_rural_multiplier + 250) - ' ') == 0 */) {
    } else {
        VAR_184.replace(213, 2, h_bun_rural_multiplier.substr(190, 2));
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        // MOVE (complex memory operation)
        VAR_184.replace(227, 2, h_bun_rural_multiplier.substr(202, 2));
    }
    ...
    VAR_294.replace(88, 4, h_bun_rural_multiplier.substr(20, 4));
    VAR_294.replace(92, 5, h_bun_rural_multiplier.substr(31, 5));
    VAR_294.replace(97, 5, h_bun_rural_multiplier.substr(43, 5));
    ...
    // MOVE to computed field
    VAR_294.replace(156, 9, h_bun_rural_multiplier.substr(101, 9));
    VAR_294.replace(17, 9, h_bun_rural_multiplier.substr(101, 9));
    // MOVE to computed field
    if (VAR_184.at(106) == ' ') {
    } else {
    }
    if (VAR_184.at(449) == 'T') {
        ...
        VAR_184.replace(316, 7, h_bun_rural_multiplier.substr(24, 7));
        VAR_184.replace(323, 7, h_bun_rural_multiplier.substr(36, 7));
        VAR_184.replace(330, 5, h_bun_rural_multiplier.substr(48, 5));
        VAR_184.replace(335, 4, h_bun_rural_multiplier.substr(53, 4));
        VAR_184.replace(347, 4, h_bun_rural_multiplier.substr(204, 4));
        VAR_184.replace(369, 4, h_out_rural_multiplier.substr(0, 4));
        VAR_184.replace(373, 7, h_out_rural_multiplier.substr(4, 7));
        VAR_294.replace(212, 4, cm_onset_le_120.substr(20, 4));
        VAR_184.replace(380, 5, h_out_rural_multiplier.substr(11, 5));
        VAR_184.replace(385, 7, h_out_rural_multiplier.substr(16, 7));
        VAR_184.replace(392, 5, h_out_rural_multiplier.substr(23, 5));
        VAR_184.replace(397, 5, h_out_rural_multiplier.substr(28, 5));
        VAR_184.replace(402, 4, h_out_rural_multiplier.substr(33, 4));
        // MOVE to computed field
        // MOVE to computed field
        // MOVE to computed field
        VAR_184.replace(406, 4, h_out_rural_multiplier.substr(37, 4));
        VAR_184.replace(410, 5, h_out_rural_multiplier.substr(41, 5));
        // MOVE to computed field
        VAR_184.replace(426, 6, h_out_rural_multiplier.substr(46, 6));
        VAR_184.replace(415, 3, h_out_rural_multiplier.substr(52, 3));
        VAR_184.replace(432, 11, h_out_rural_multiplier.substr(88, 11));
        ...
        VAR_294.replace(223, 4, cm_onset_le_120.substr(76, 4));
        VAR_294.replace(227, 4, cm_onset_le_120.substr(80, 4));
        VAR_294.replace(231, 6, bundled_base_pmt_rate.substr(0, 6));
        // MOVE to computed field
        VAR_294.replace(237, 11, h_bun_rural_multiplier.substr(57, 11));
        VAR_294.replace(262, 11, h_bun_rural_multiplier.substr(68, 11));
