...
void p_0100_initial_routine() {
    ...
    VAR_663.replace(130, 7, "3979495");
    h_ipps_wage_index.replace(64, 9, "001861500");
    VAR_663.replace(137, 4, "1000");
    h_ipps_wage_index.replace(339, 5, "42956");
    h_ipps_wage_index.replace(344, 5, "20357");
    h_ipps_wage_index.replace(349, 3, "075");
    h_ipps_wage_index.replace(352, 3, "025");
    if (to_int(h_ipps_wage_index) > 1) {
        h_ipps_wage_index.replace(297, 7, "0358724");
        h_ipps_wage_index.replace(304, 7, "0162678");
    } else {
        h_ipps_wage_index.replace(297, 7, "0323269");
        h_ipps_wage_index.replace(304, 7, "0198133");
    }
    if (false /* TODO: cob_cmp_llint (COB_SET_DATA (f_815, VAR_804 + 21), 1LL) > 0 */) {
        h_ipps_wage_index.replace(311, 7, "0154361");
        h_ipps_wage_index.replace(318, 7, "0094207");
    } else {
        h_ipps_wage_index.replace(311, 7, "0154112");
        h_ipps_wage_index.replace(318, 7, "0094456");
    }
}
