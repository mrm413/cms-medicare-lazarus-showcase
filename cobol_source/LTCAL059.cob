...
000200 PROGRAM-ID.        LTCAL059.
000400*REMARKS.           CMS.
000500*       EFFECTIVE OCTOBER 1, 2004.
...
001900     'LTCAL059      - W O R K I N G   S T O R A G E'.
002000 01  CAL-VERSION                    PIC X(05)  VALUE 'V05.9'.
...
002100
002200***************************************************************
002300*    LAYUP TABLE AREA FOR FY2005 LTC-DRG                      *
002400*    EFFECTIVE DATE OF OCTOBER 1, 2004                        *
002500***************************************************************
002600 COPY LTDRG057.
024400
...
036100*             98 = PROVIDER EFFECTIVE DATE BEFORE 10/01/2002  *
036200***************************************************************
...
040200
040300******************************************************************
040400*            THESE ARE THE VERSIONS OF THE LTDRV057
...
063000     MOVE 36833.69 TO PPS-STD-FED-RATE.
063000     MOVE 17864 TO H-FIXED-LOSS-AMT.
063000     MOVE 0.995 TO PPS-BDGT-NEUT-RATE.
062100
062000 0100-EXIT.
062100      EXIT.
063100
...
077800
      ...
      ***************************************************************
      * REVISED WAGE INDEX CALCULATION - EFFECTIVE RATE YEAR 2004   *
      ***************************************************************
      ...
      ***************************************************************
      * PROVIDER FY BEGIN DATE WITHIN THE CURRENT 3/5 FEDERAL FY    *
      ***************************************************************

            WHEN P-NEW-FY-BEGIN-DATE >= FED-FY-BEGIN-05

      **** ---------------------------------------------------------*
      **** CLAIMS DISCHARGED AFTER THE PROVIDER FY BEGIN DATE: 3/5  *
      **** ---------------------------------------------------------*
      ...
      **** ---------------------------------------------------------*
      **** CLAIMS DISCHARGED BEFORE THE PROVIDER FY BEGIN DATE: 2/5 *
      **** ---------------------------------------------------------*
                 ELSE
      ...
      ***************************************************************
      * PROVIDER FY BEGIN DATE WITHIN THE PREVIOUS 2/5 FEDERAL FY   *
      ***************************************************************

            WHEN P-NEW-FY-BEGIN-DATE <  FED-FY-BEGIN-05 AND
                 P-NEW-FY-BEGIN-DATE >= FED-FY-BEGIN-04

      **** ---------------------------------------------------------*
      **** CLAIMS DISCHARGED AFTER THE PROVIDER FY BEGIN DATE: 2/5  *
      **** ---------------------------------------------------------*
                 IF B-DISCHARGE-DATE >= P-NEW-FY-BEGIN-DATE
                    IF W-WAGE-INDEX2 NUMERIC AND W-WAGE-INDEX2 > 0
                       MOVE W-WAGE-INDEX2 TO PPS-WAGE-INDEX
      ...
      **** ---------------------------------------------------------*
      **** CLAIMS DISCHARGED BEFORE THE PROVIDER FY BEGIN DATE: 1/5 *
      **** ---------------------------------------------------------*
                 ELSE
      ...
      ***************************************************************
      * PROVIDER FY BEGIN DATE WITHIN THE PREVIOUS 1/5 FEDERAL FY   *
      ***************************************************************

            WHEN P-NEW-FY-BEGIN-DATE <  FED-FY-BEGIN-04 AND
                 P-NEW-FY-BEGIN-DATE >= FED-FY-BEGIN-03
