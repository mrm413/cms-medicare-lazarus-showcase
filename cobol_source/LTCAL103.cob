...
000200 PROGRAM-ID.     LTCAL103.                                        00020000
000400*REMARKS.        CMS.                                             00040000
000500*                EFFECTIVE OCTOBER 1, 2009.                       00050000
...
001900     'LTCAL103      - W O R K I N G   S T O R A G E'.             00190000
002000 01  CAL-VERSION                    PIC X(05)  VALUE 'V10.3'.     00200000
...
002800                                                                  00280000
002900***************************************************************   00290000
003000*    LAYUP TABLE AREA FOR FY2010 LTC-DRG                      *   00300000
003100*    EFFECTIVE DATE OF OCTOBER 1, 2009                        *   00310000
003200***************************************************************   00320000
003300 COPY LTDRG100.                                                   00330000
003400                                                                  00340000
003500                                                                  00350000
003600***************************************************************   00360000
003700*    LAYUP TABLE AREA FOR FY2010 IPPS-DRG                     *   00370000
003800*    EFFECTIVE DATE OF OCTOBER 1, 2009                        *   00380000
003900***************************************************************   00390000
004000 COPY IPDRG104.                                                   00400000
004100                                                                  00410000
004200                                                                  00420000
004300***************************************************************   00430000
004400*    LAYUP TABLE AREA FOR FY2010 IPPS STATE SPECIFIC RFBNS    *   00440000
004500*    EFFECTIVE DATE OF OCTOBER 1, 2009                        *   00450000
004600***************************************************************   00460000
004700 COPY IRFBN102.                                                   00470000
004800                                                                  00480000
004900                                                                  00490000
005000***************************************************************   00500000
...
055800*** ---------------------------------------------------- ***      05580000
055900     MOVE .75779   TO PPS-NAT-LABOR-PCT.                          05590000
056000     MOVE .24221   TO PPS-NAT-NONLABOR-PCT.                       05600000
056100     MOVE 39896.65 TO PPS-STD-FED-RATE.                           05610000
056200     MOVE 18425.00 TO H-FIXED-LOSS-AMT.                           05620000
056300     MOVE 1.000    TO PPS-BDGT-NEUT-RATE.                         05630000
056400                                                                  05640000
056500*** ---------------------------------------------------- ***      05650000
056600*** RATES FOR IPPS COMPARABLE PAYMENT: CHANGE IN OCTOBER ***      05660000
056700*** ---------------------------------------------------- ***      05670000
056800     MOVE 429.26 TO H-IPPS-CAPI-STD-FED-RATE.                     05680000
056900     MOVE 203.56 TO H-IPPS-CAPI-STD-PR-RATE.                      05690000
...
057400        MOVE 3593.52 TO H-IPPS-NAT-LABOR-SHR                      05740000
057500        MOVE 1629.62 TO H-IPPS-NAT-NONLABOR-SHR                   05750000
057600     ELSE                                                         05760000
057700        MOVE 3238.35 TO H-IPPS-NAT-LABOR-SHR                      05770000
057800        MOVE 1984.79 TO H-IPPS-NAT-NONLABOR-SHR                   05780000
057900     END-IF.                                                      05790000
058000                                                                  05800000
058100     IF W-IPPS-PR-WAGE-INDEX > 1                                  05810000
058200        MOVE 1542.72 TO H-IPPS-PR-LABOR-SHR                       05820000
058300        MOVE  941.52 TO H-IPPS-PR-NONLABOR-SHR                    05830000
058400     ELSE                                                         05840000
058500        MOVE 1540.23 TO H-IPPS-PR-LABOR-SHR                       05850000
058600        MOVE  944.01 TO H-IPPS-PR-NONLABOR-SHR                    05860000
...
167300*** *************************************************** ***       16710000
167400                                                                  16720000
167500*    IF (B-PROVIDER-NO = '191031' OR                              16730002
167510*                        '191032' OR                              16731002
167600*                        '011033' OR                              16732002
167700*                        '221034' OR                              16733002
167800*                        '251035' OR                              16734002
167900*                        '021036' OR                              16735002
167910*                        '401037'  )                              16736002
168200*                                                                 16737002
168300*     DISPLAY '---------------------------------------------'     16738002
168400*     DISPLAY 'VALUES FOR PROVIDER '      B-PROVIDER-NO           16739002
168500*     DISPLAY 'PPS-RTC '                  PPS-RTC                 16740002
168600*     DISPLAY 'PPS-FINAL-PAY-AMT '        PPS-FINAL-PAY-AMT       16750002
168700*     DISPLAY 'B-DISCHARGE-DATE '         B-DISCHARGE-DATE        16760002
168800*     DISPLAY 'B-COV-CHARGES '            B-COV-CHARGES           16770002
168900*     DISPLAY 'PPS-OUTLIER-THRESHOLD '    PPS-OUTLIER-THRESHOLD   16780002
169000*     DISPLAY 'PPS-FED-PAY-AMT '          PPS-FED-PAY-AMT         16790002
169100*     DISPLAY 'PPS-CBSA '                 PPS-CBSA                16800002
169200*     DISPLAY 'PPS-WAGE-INDEX '           PPS-WAGE-INDEX          16810002
169300*     DISPLAY 'W-IPPS-WAGE-INDEX '        W-IPPS-WAGE-INDEX       16820002
169400*     DISPLAY 'H-IPPS-WAGE-INDEX '        H-IPPS-WAGE-INDEX       16830002
169500*     DISPLAY 'MES-SSRFBN-RATE '          MES-SSRFBN-RATE         16840002
169600*     DISPLAY 'MES-SSRFBN-STATE '         MES-SSRFBN-STATE        16850002
169700*     DISPLAY 'W-IPPS-PR-WAGE-INDEX '     W-IPPS-PR-WAGE-INDEX    16860002
169800*     DISPLAY 'PPS-OUTLIER-PAY-AMT '      PPS-OUTLIER-PAY-AMT     16870002
169900*     DISPLAY 'B-DRG-CODE '               B-DRG-CODE              16880002
170000*     DISPLAY 'PPS-AVG-LOS '              PPS-AVG-LOS             16890002
170100*     DISPLAY 'H-SSOT '                   H-SSOT                  16900002
170200*     DISPLAY 'PPS-RELATIVE-WGT '         PPS-RELATIVE-WGT        16910002
170300**    DISPLAY 'PPS-IPTHRESH '             PPS-IPTHRESH            16920000
170400*     DISPLAY 'PPS-DRG-ADJ-PAY-AMT '      PPS-DRG-ADJ-PAY-AMT     16930002
170500*     DISPLAY 'H-LOS '                    H-LOS                   16940002
170600*     DISPLAY 'H-REG-DAYS '               H-REG-DAYS              16950002
170700*     DISPLAY 'H-TOTAL-DAYS '             H-TOTAL-DAYS            16960002
170800*     DISPLAY 'H-SSOT '                   H-SSOT                  16970002
170900*     DISPLAY 'H-BLEND-RTC '              H-BLEND-RTC             16980002
171000*     DISPLAY 'H-BLEND-FAC '              H-BLEND-FAC             16990002
171100*     DISPLAY 'H-BLEND-PPS '              H-BLEND-PPS             17000002
171200*     DISPLAY 'H-SS-PAY-AMT '             H-SS-PAY-AMT            17010002
171300*     DISPLAY 'H-SS-COST '                H-SS-COST               17020002
171400*     DISPLAY 'H-LABOR-PORTION '          H-LABOR-PORTION         17030002
171500*     DISPLAY 'H-NONLABOR-PORTION '       H-NONLABOR-PORTION      17040002
171600*     DISPLAY 'H-FIXED-LOSS-AMT '         H-FIXED-LOSS-AMT        17050002
171700*     DISPLAY 'H-NEW-FAC-SPEC-RATE '      H-NEW-FAC-SPEC-RATE     17060002
171800*     DISPLAY 'H-LOS-RATIO '              H-LOS-RATIO             17070002
171900*     DISPLAY 'H-INTERN-RATIO '           H-INTERN-RATIO          17080002
172000*     DISPLAY 'H-OPER-IME-TEACH '         H-OPER-IME-TEACH        17090002
172100*     DISPLAY 'H-CAPI-IME-TEACH '         H-CAPI-IME-TEACH        17100002
172200*     DISPLAY 'H-LTCH-BLEND-PCT '         H-LTCH-BLEND-PCT        17110002
172300*     DISPLAY 'H-IPPS-BLEND-PCT '         H-IPPS-BLEND-PCT        17120002
172400*     DISPLAY 'H-LTCH-BLEND-AMT '         H-LTCH-BLEND-AMT        17130002
172500*     DISPLAY 'H-IPPS-BLEND-AMT '         H-IPPS-BLEND-AMT        17140002
172600*     DISPLAY 'H-INTERN-RATIO '           H-INTERN-RATIO          17150002
172700*     DISPLAY 'H-CAPI-IME-RATIO '         H-CAPI-IME-RATIO        17160002
172800*     DISPLAY 'H-BED-SIZE '               H-BED-SIZE              17170002
172900*     DISPLAY 'H-OPER-DSH-PCT '           H-OPER-DSH-PCT          17180002
173000*     DISPLAY 'H-SSI-RATIO '              H-SSI-RATIO             17190002
173100*     DISPLAY 'H-MEDICAID-RATIO '         H-MEDICAID-RATIO        17200002
173200*     DISPLAY 'H-OPER-DSH '               H-OPER-DSH              17210002
173300*     DISPLAY 'H-CAPI-DSH '               H-CAPI-DSH              17220002
173400*     DISPLAY 'H-GEO-CLASS '              H-GEO-CLASS             17230002
173500*     DISPLAY 'H-URBAN-IND '              H-URBAN-IND             17240002
173600*     DISPLAY 'H-STAND-AMT-OPER-PMT '     H-STAND-AMT-OPER-PMT    17250002
173700*     DISPLAY 'H-PR-STAND-AMT-OPER-PMT '  H-PR-STAND-AMT-OPER-PMT 17260002
173800*     DISPLAY 'H-CAPI-PMT '               H-CAPI-PMT              17270002
173900*     DISPLAY 'H-PR-CAPI-PMT '            H-PR-CAPI-PMT           17280002
174000*     DISPLAY 'H-CAPI-GAF '               H-CAPI-GAF              17290002
174100*     DISPLAY 'H-PR-CAPI-GAF '            H-PR-CAPI-GAF           17300002
174200*     DISPLAY 'H-LRGURB-ADD-ON '          H-LRGURB-ADD-ON         17310002
174300*     DISPLAY 'H-IPPS-PAY-AMT '           H-IPPS-PAY-AMT          17320002
174400*     DISPLAY 'H-IPPS-PR-PAY-AMT '        H-IPPS-PR-PAY-AMT       17330002
174500*     DISPLAY 'H-IPPS-PER-DIEM '          H-IPPS-PER-DIEM         17340002
174600*     DISPLAY 'H-IPPS-PR-PER-DIEM '       H-IPPS-PR-PER-DIEM      17350002
174700*     DISPLAY 'H-SS-BLENDED-PMT '         H-SS-BLENDED-PMT        17360002
174800*     DISPLAY 'H-OPER-COLA '              H-OPER-COLA             17370002
174900*     DISPLAY 'H-CAPI-COLA '              H-CAPI-COLA             17380002
175000*     DISPLAY 'H-IPPS-NAT-LABOR-SHR '     H-IPPS-NAT-LABOR-SHR    17390002
175100*     DISPLAY 'H-IPPS-NAT-NONLABOR-SHR '  H-IPPS-NAT-NONLABOR-SHR 17400002
175200*     DISPLAY 'H-IPPS-PR-LABOR-SHR '      H-IPPS-PR-LABOR-SHR     17410002
175300*     DISPLAY 'H-IPPS-PR-NONLABOR-SHR '   H-IPPS-PR-NONLABOR-SHR  17420002
175400*     DISPLAY 'H-IPPS-DRG-WGT '           H-IPPS-DRG-WGT          17430002
175500*     DISPLAY 'H-IPPS-DRG-ALOS '          H-IPPS-DRG-ALOS         17440002
175600*     DISPLAY 'H-IPPS-DAYS-CUTOFF '       H-IPPS-DAYS-CUTOFF      17450002
175700*     DISPLAY 'H-IPPS-ARITH-ALOS '        H-IPPS-ARITH-ALOS       17460002
175800*     DISPLAY 'H-IPPS-CAPI-STD-FED-RATE ' H-IPPS-CAPI-STD-FED-RATE17470002
175900*     DISPLAY 'H-IPPS-CAPI-STD-PR-RATE '  H-IPPS-CAPI-STD-PR-RATE 17480002
176000*     DISPLAY 'H-NAT-IPPS-PMT-PCT '       H-NAT-IPPS-PMT-PCT      17490002
176100*     DISPLAY 'H-PR-IPPS-PMT-PCT '        H-PR-IPPS-PMT-PCT       17500002
176200*     DISPLAY 'H-PPS-DRG-UNADJ-PAY-AMT '  H-PPS-DRG-UNADJ-PAY-AMT 17510002
176300*     DISPLAY 'H-SS-COST-IND '            H-SS-COST-IND           17520002
176400*     DISPLAY 'H-SS-PERDIEM-IND '         H-SS-PERDIEM-IND        17530002
176500*     DISPLAY 'H-SS-BLEND-IND '           H-SS-BLEND-IND          17540002
176600*     DISPLAY 'H-SS-IPPSCOMP-IND '        H-SS-IPPSCOMP-IND       17550002
176700*                                                                 17560002
176800*    END-IF.                                                      17570002
176900                                                                  17580000
177000 9000-EXIT.                                                       17590000
177100      EXIT.                                                       17600000
177200                                                                  17610000
177300******        L A S T   S O U R C E   S T A T E M E N T   *****   17620000
