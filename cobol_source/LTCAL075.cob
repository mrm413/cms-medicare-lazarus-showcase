...
000200 PROGRAM-ID.     LTCAL075.
000400*REMARKS.        CMS.
000500*                EFFECTIVE OCTOBER 1, 2006.
...
001900     'LTCAL075      - W O R K I N G   S T O R A G E'.
002000 01  CAL-VERSION                    PIC X(05)  VALUE 'V07.5'.
...
091600
           ...
           IF (PPS-RTC = 00 OR 20 OR 21 OR 22)
              IF PPS-REG-DAYS-USED > H-SSOT
                 MOVE 0 TO PPS-LTR-DAYS-USED
              ELSE
                 NEXT SENTENCE.

           IF (PPS-RTC = 01 OR 24 OR 25) OR
              (PPS-COT-IND = 'Y')
...
081100***************************************************************
      ...
      *----------------------------------------------------------*
           IF (PPS-RTC = 20 OR 21 OR 22) AND (H-BLEND-RTC > 0)
      ...
      *----------------------------------------------------------*
           ELSE
              IF (PPS-RTC = 24 OR 25) AND (H-BLEND-RTC > 0)
