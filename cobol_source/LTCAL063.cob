...
000200 PROGRAM-ID.  LTCAL063.
000400*REMARKS.     CMS.
000500*             EFFECTIVE JULY 1, 2005.
...
001900     'LTCAL063      - W O R K I N G   S T O R A G E'.
002000 01  CAL-VERSION                    PIC X(05)  VALUE 'V06.3'.
...
053800******************************************************************
053900 01  WAGE-NEW-INDEX-RECORD-CBSA.
...
054250     05  W-WAGE-INDEX3                 PIC S9(02)V9(04).
054300
054350
054400
...
054900                           WAGE-NEW-INDEX-RECORD-CBSA.
055000
055100***************************************************************
055200*    PROCESSING:                                              *
...
063000     MOVE 38086.04 TO PPS-STD-FED-RATE.
063000     MOVE 10501 TO H-FIXED-LOSS-AMT.
063000     MOVE 1.000 TO PPS-BDGT-NEUT-RATE.
062100
062000 0100-EXIT.
062100      EXIT.
063100
...
077800
      ...
      ***************************************************************
      * PROVIDER FY BEGIN DATE WITHIN THE CURRENT 4/5 FEDERAL FY    *
      ***************************************************************
      ...
      ***************************************************************
            ...
            WHEN P-NEW-FY-BEGIN-DATE < FED-FY-BEGIN-04
                 MOVE 52 TO PPS-RTC
                 GO TO 2000-EXIT
