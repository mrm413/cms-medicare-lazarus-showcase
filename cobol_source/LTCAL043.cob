...
000200 PROGRAM-ID.        LTCAL043.
000400*REMARKS.           CMS.
000500*       EFFECTIVE OCT 1 2003.
...
001900     'LTCAL043      - W O R K I N G   S T O R A G E'.
002000 01  CAL-VERSION                    PIC X(05)  VALUE 'C04.3'.
002100
002200***************************************************************
...
077800           GO TO 2000-EXIT.
      ...
      *---------------------------------------------------------*
      *               DISPLAYS FOR TESTING PURPOSES             *
      *---------------------------------------------------------*
      *          DISPLAY 'PROVIDER: ' P-NEW-PROVIDER-NO
      *          DISPLAY ' FY BEGIN DATE: ' P-NEW-FY-BEGIN-DATE
      *          DISPLAY ' DISCHARGE DATE: ' B-DISCHARGE-DATE
      *          DISPLAY ' MSA: ' W-MSA
      *          DISPLAY ' WAGE INDEX1: ' W-WAGE-INDEX1
      *          DISPLAY ' WAGE INDEX2: ' W-WAGE-INDEX2
      *          DISPLAY ' WAGE INDEX3: ' W-WAGE-INDEX3
...
081300          * PPS-WAGE-INDEX.
      ...
      *               DISPLAYS FOR TESTING PURPOSES             *
      *---------------------------------------------------------*
      *       DISPLAY 'LABOR: ' H-LABOR-PORTION
      *               ' LABOR WI: ' PPS-WAGE-INDEX.
      *---------------------------------------------------------*
...
081300        (H-LABOR-PORTION + H-NONLABOR-PORTION).
      ...
      *---------------------------------------------------------*
      *       DISPLAY 'FED PYMT: ' PPS-FED-PAY-AMT.
      *---------------------------------------------------------*
081300
      ...
      *               DISPLAY FOR TESTING PURPOSES              *
      *---------------------------------------------------------*
      *       DISPLAY 'DRG PYMT: ' PPS-DRG-ADJ-PAY-AMT.
      *---------------------------------------------------------*
...
091500         ((PPS-DRG-ADJ-PAY-AMT / PPS-AVG-LOS) * H-LOS) * 1.2.
      ...
      *               DISPLAYS FOR TESTING PURPOSES             *
      *---------------------------------------------------------*
      *       DISPLAY 'SS COSTS: ' H-SS-COST.
      *       DISPLAY 'SS PAY AMT: ' H-SS-PAY-AMT.
      *       DISPLAY 'DRG PAY AMT: ' PPS-DRG-ADJ-PAY-AMT.
      ...
      *               DISPLAY FOR TESTING PURPOSES              *
      *---------------------------------------------------------*
      *        DISPLAY 'DRG ADJ PYMT: ' PPS-DRG-ADJ-PAY-AMT.
      *---------------------------------------------------------*
091600
...
087300 8000-BLEND.
      ...
      *               DISPLAY FOR TESTING PURPOSES              *
      *---------------------------------------------------------*
      *    DISPLAY 'DGR ADJ PYMT: ' PPS-DRG-ADJ-PAY-AMT.
      *---------------------------------------------------------*
      ...
      *               DISPLAY FOR TESTING PURPOSES              *
      *---------------------------------------------------------*
      *    DISPLAY 'NEW FAC RATE: ' PPS-NEW-FAC-SPEC-RATE.
      *---------------------------------------------------------*
      ...
      *               DISPLAY FOR TESTING PURPOSES              *
      *---------------------------------------------------------*
      *    DISPLAY 'FINAL PYMT: ' PPS-FINAL-PAY-AMT.
      *---------------------------------------------------------*
...
058300        MOVE 'V04.3'               TO  PPS-CALC-VERS-CD
058400     ELSE
062200       INITIALIZE PPS-DATA
062300       INITIALIZE PPS-OTHER-DATA
061200       MOVE 'V04.3'                TO  PPS-CALC-VERS-CD.
097000
097100 9000-EXIT.
097100      EXIT.
061700
